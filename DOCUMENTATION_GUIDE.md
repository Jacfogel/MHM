...
> **Version**: --scope - Documentation System Active  
...
- **DEVELOPMENT_WORKFLOW.md**: Development practices and procedures

### **AI-Facing Documents**
- **AI_SESSION_STARTER.md**: Essential context for new AI sessions
- **AI_REFERENCE.md**: Comprehensive AI collaboration reference
- **AI_FUNCTION_REGISTRY.md**: Complete function documentation
- **AI_MODULE_DEPENDENCIES.md**: Module relationship mapping

### **Generated Documents**
- **AI_STATUS.md**: Current system status and health
- **AI_PRIORITIES.md**: Immediate action items and focus areas
- **consolidated_report.txt**: Comprehensive audit results
- **DIRECTORY_TREE.md**: Current project structure
...
- `ai_development_tools/AI_STATUS.md` - Generated by `ai_development_tools/ai_tools_runner.py status`
...
- `development_docs/DIRECTORY_TREE.md` - Generated by `ai_development_tools/ai_tools_runner.py trees`
- `development_docs/LEGACY_REFERENCE_REPORT.md` - Generated by `ai_development_tools/ai_tools_runner.py legacy`
- `development_docs/FUNCTION_REGISTRY_DETAIL.md` - Generated by `ai_development_tools/ai_tools_runner.py audit` (function registry)
- `development_docs/MODULE_DEPENDENCIES_DETAIL.md` - Generated by `ai_development_tools/ai_tools_runner.py audit` (module dependencies)

**AI-Facing Generated Documentation (2):**
- `ai_development_docs/AI_FUNCTION_REGISTRY.md` - Generated by `ai_development_tools/ai_tools_runner.py audit` (AI-optimized function registry)
- `ai_development_docs/AI_MODULE_DEPENDENCIES.md` - Generated by `ai_development_tools/ai_tools_runner.py audit` (AI-optimized module dependencies)
