...
Usage:
    python ai_development_tools/audit_package_exports.py
    python ai_development_tools/audit_package_exports.py --package core
    python ai_development_tools/audit_package_exports.py --package communication
"""
