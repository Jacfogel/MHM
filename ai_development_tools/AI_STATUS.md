...
## Snapshot
- **Total Functions**: 1392 (Moderate: 143, High: 131, Critical: 105)
- **Documentation Coverage**: 93.68% ({'count': 0, 'files': {}, 'missing_files': []} items missing from registry)
...
- **@handle_errors Usage**: 1207 functions already use the decorator
...
## Test Coverage
- **Overall Coverage**: 58.2% (13485 of 23158 statements)
- **Report Timestamp**: 2025-11-02T02:31:04.933164
- **Lowest Modules**: communication (48.3%, missing 3399 lines), ui (50.1%, missing 2877 lines), user (62.5%, missing 115 lines)
...
## System Signals
- **System Health**: OK
- **Recent Changes**: .cursor\commands\ai-functionality-tests.md, ARCHITECTURE.md, TODO.md, ... +12
