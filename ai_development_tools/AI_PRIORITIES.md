...
2. **Harden critical error handling**  -  104 functions still lack structured error recovery.
...
3. **Raise coverage for low-performing modules**  -  3 key modules remain below the 80% target.
   - Target modules: ui (53.0%, 2729 lines missing), communication (63.5%, 2445 lines missing), ai (66.5%, 572 lines missing)
...
- Overall test coverage is 64.2% (15105 / 23541 statements).
- Keep an eye on untested files: ui/dialogs/process_watcher_dialog.py (12.6%), ui/dialogs/user_analytics_dialog.py (15.1%).
