...
> **Last Generated**: 2025-11-02 02:37:29
...
3. **Raise coverage for low-performing modules**  -  3 key modules remain below the 80% target.
   - Target modules: communication (48.3%, 3399 lines missing), ui (50.1%, 2877 lines missing), user (62.5%, 115 lines missing)
...
## Watch List
- Documentation coverage sits at 93.68% (target 90%).
- Overall test coverage is 58.2% (13485 / 23158 statements).
