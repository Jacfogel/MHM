...
4. **Raise coverage for low-performing modules**  -  3 key modules remain below the 80% target.
   - Target modules: communication (68.9%, 2382 lines missing), ai (71.9%, 480 lines missing), core (73.8%, 2280 lines missing)
...
- Overall test coverage is 72.5% (17936 / 24751 statements).
- Keep an eye on untested files: communication/message_processing/command_parser.py (55.3%), ai/chatbot.py (56.7%).
