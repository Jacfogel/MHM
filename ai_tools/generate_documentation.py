...
def generate_all_documentation():
    ...
    if success1 and success2:
        ...
        print("   - FUNCTION_REGISTRY.md")
        print("   - MODULE_DEPENDENCIES.md")
        print("\n[NEXT] Next Steps:")
        ...
        if not success1:
            print("   - FUNCTION_REGISTRY.md generation failed")
        if not success2:
            print("   - MODULE_DEPENDENCIES.md generation failed")
...
def show_usage():
    ...
    print("  python generate_function_registry.py      # Generate FUNCTION_REGISTRY.md only")
    print("  python generate_module_dependencies.py    # Generate MODULE_DEPENDENCIES.md only")
    print("\nWhat it does:")
