...
class DocumentationSyncChecker:
    ...
    def generate_directory_tree(self, output_file: str = "DIRECTORY_TREE.md") -> str:
        """Generate a directory tree for documentation."""
        tree_content = ["# Project Directory Tree\n"]
        tree_content.append("> **Generated**: This file is auto-generated. Do not edit manually.\n")
        ...
        def add_directory(path: Path, prefix: str = "", max_depth: int = 3, current_depth: int = 0):
            ...
            if path.is_file():
                tree_content.append(f"{prefix}├── {path.name}")
            elif path.is_dir():
                tree_content.append(f"{prefix}├── {path.name}/")
        ...
        tree_content.append("\n---\n")
        tree_content.append("*Generated by documentation_sync_checker.py*")
...
def main():
    ...
    parser.add_argument('--output', default='DIRECTORY_TREE.md', help='Output file for directory tree')
