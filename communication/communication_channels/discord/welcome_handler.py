...
def get_welcome_message_view(discord_user_id: str) -> "discord.ui.View":
    ...
    class WelcomeView(discord.ui.View):
        ...
        @discord.ui.button(
            ...
            custom_id=f"welcome_create_{discord_user_id}",
        )
        @handle_errors("handling create account button click", default_return=None)
        async def create_account_button(
            ...
            await start_account_creation_flow(
                interaction, self.discord_user_id, discord_username
            )

        @discord.ui.button(
            label="Link to Existing Account",
            style=discord.ButtonStyle.secondary,
            custom_id=f"welcome_link_{discord_user_id}",
        )
        @handle_errors("handling link account button click", default_return=None)
        async def link_account_button(
            self, interaction: discord.Interaction, button: discord.ui.Button
        ):
