...
def get_checkin_view(user_id: str) -> Optional["discord.ui.View"]:
    ...
    class CheckinView(discord.ui.View):
        ...
        def __init__(self, user_id: str):
            """
            Initialize the check-in view with action buttons.
        ...
        @discord.ui.button(
            ...
            custom_id=f"checkin_cancel_{user_id}",
        )
        @handle_errors("canceling check-in", context={"component": "discord"})
        async def cancel_checkin_button(
        ...
        @discord.ui.button(
            label="More",
            style=discord.ButtonStyle.secondary,
            custom_id=f"checkin_more_{user_id}",
        )
