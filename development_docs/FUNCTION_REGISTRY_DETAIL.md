...
> **Last Generated**: 2025-12-02 03:33:29
...
**Functions:**
- ✅ `__init__(self, username, discord_user_id, timeout)` - Special Python method
- ✅ `__init__(self, parent_view)` - Special Python method
- ✅ `__init__(self, parent_view)` - Special Python method
- ✅ `__init__(self, parent_view)` - Special Python method
- ✅ `__init__(self, parent_view)` - Special Python method
- ✅ `__init__(self, parent_view)` - Special Python method
...
- ✅ `CheckinFeatureSelect` - Select menu for check-in feature.
  - ✅ `CheckinFeatureSelect.__init__(self, parent_view)` - Special Python method
- ❌ `ConfirmLinkModal` - No description
- ✅ `CreateAccountButton` - Button to finalize account creation.
  - ✅ `CreateAccountButton.__init__(self, parent_view)` - Special Python method
- ❌ `CreateAccountModal` - No description
- ✅ `FeatureSelectionView` - View for selecting account features during creation.
  - ✅ `FeatureSelectionView.__init__(self, username, discord_user_id, timeout)` - Special Python method
- ❌ `LinkAccountModal` - No description
- ✅ `MessageFeatureSelect` - Select menu for automated messages feature.
  - ✅ `MessageFeatureSelect.__init__(self, parent_view)` - Special Python method
- ✅ `TaskFeatureSelect` - Select menu for task management feature.
  - ✅ `TaskFeatureSelect.__init__(self, parent_view)` - Special Python method
- ✅ `TimezoneSelect` - Select menu for timezone selection.
  - ✅ `TimezoneSelect.__init__(self, parent_view)` - Special Python method
...
**Functions:**
- ✅ `__init__(self, user_id)` - Special Python method
...
- ❌ `CheckinView` - No description
  - ✅ `CheckinView.__init__(self, user_id)` - Special Python method
...
**Functions:**
- ✅ `__init__(self, user_id, task_id, task_title)` - Special Python method
...
- ❌ `TaskReminderView` - No description
  - ✅ `TaskReminderView.__init__(self, user_id, task_id, task_title)` - Special Python method
...
**Functions:**
- ✅ `__init__(self, discord_user_id)` - Special Python method
...
- ❌ `WelcomeView` - No description
  - ✅ `WelcomeView.__init__(self, discord_user_id)` - Special Python method
...
**Functions:**
- ✅ `__init__(self)` - Special Python method
...
- ✅ `EnhancedCommandParser` - Enhanced command parser that combines rule-based and AI parsing
  - ✅ `EnhancedCommandParser.__init__(self)` - Special Python method
...
- ✅ `_expire_inactive_checkins(self, user_id)` - Remove stale check-in flows that have been idle beyond the allowed window.
...
- ❌ `ConversationManager` - No description
  ...
  - ✅ `ConversationManager._expire_inactive_checkins(self, user_id)` - Remove stale check-in flows that have been idle beyond the allowed window.
...
- ✅ `add_suggestion(text)` - Add a suggestion if it is unique and space remains.
...
- ✅ `FileAuditor` - Auditor for tracking file creation and modification patterns.
  - ✅ `FileAuditor.__init__(self)` - Special Python method
...
#### `core/logger.py`
**Functions:**
- ✅ `__init__(self, component_name, log_file_path, level)` - Special Python method
- ✅ `__init__(self, filename, backup_dir, maxBytes, backupCount, encoding, delay, when, interval)` - Special Python method
- ✅ `__init__(self)` - Special Python method
- ✅ `__init__(self, excluded_prefixes)` - Special Python method
- ✅ `__init__(self, name)` - Special Python method
- ✅ `__init__(self, name)` - Special Python method
...
Supports both time-based and size-based rotation.
  - ✅ `BackupDirectoryRotatingFileHandler.__init__(self, filename, backup_dir, maxBytes, backupCount, encoding, delay, when, interval)` - Special Python method
...
Each component gets its own log file with appropriate rotation and formatting.
  - ✅ `ComponentLogger.__init__(self, component_name, log_file_path, level)` - Special Python method
...
- ❌ `DummyComponentLogger` - No description
  - ✅ `DummyComponentLogger.__init__(self, name)` - Special Python method
...
Example use: prevent Discord-related logs from going to app.log.
  - ✅ `ExcludeLoggerNamesFilter.__init__(self, excluded_prefixes)` - Special Python method
...
- Logs a summary every hour with total count
  - ✅ `HeartbeatWarningFilter.__init__(self)` - Special Python method
...
- ❌ `_DummyLogger` - No description
  - ✅ `_DummyLogger.__init__(self, name)` - Special Python method
...
- ✅ `_normalize_discord_username(cls, v)` - Normalize Discord username while tolerating empty or legacy values.
...
- ❌ `AccountModel` - No description
  - ✅ `AccountModel._normalize_discord_username(cls, v)` - Normalize Discord username while tolerating empty or legacy values.
...
- ✅ `run_static_logging_check()` - Run the static logging enforcement script before executing tests.
