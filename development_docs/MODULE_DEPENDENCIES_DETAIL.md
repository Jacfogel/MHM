...
> **Last Generated**: 2026-09-15 01:02:13
...
- **Files Scanned**: 278
- **Total Imports Found**: 2433
- **Dependencies Documented**: 278 (100% coverage)
- **Standard Library Imports**: 717 (29.5%)
- **Third-Party Imports**: 221 (9.1%)
- **Local Imports**: 1495 (61.4%)
...
- **Standard Library**: 717 imports (29.5%)
- **Third-Party**: 221 imports (9.1%)
- **Local**: 1495 imports (61.4%)
...
**Dependency Changes**:
- Added: ai.fallback.categories, ai.fallback.data_access, ai.fallback.profile_helpers, core.error_handling
- Removed: ai/fallback/__init__.py
...
- **Dependencies**:
  - **Local**:
    ...
    - `messages.message_data_manager (is_ai_generated_message_category, store_sent_message)`
  - **Standard Library**:
    - `asyncio`
    - `contextlib`
    - `threading`
...
- Removed: collections.abc, communication/command_handlers/natural_language_handler.py, communication/message_processing/command_parser.py, tasks/task_service.py, ui/dialogs/natural_language_settings_dialog.py, ui/widgets/natural_language_settings_widget.py
...
- Removed: communication/message_processing/flows/task_flow.py, core/web_account_service.py
...
- Removed: storage/user_data_v2_envelopes.py, tasks/task_data_manager.py
