...
> **Last Generated**: 2025-11-26 02:58:19
...
- **Files Scanned**: 324
- **Total Imports Found**: 3748
- **Dependencies Documented**: 324 (100% coverage)
- **Standard Library Imports**: 1263 (33.7%)
- **Third-Party Imports**: 559 (14.9%)
- **Local Imports**: 1926 (51.4%)
...
- **Standard Library**: 1263 imports (33.7%)
- **Third-Party**: 559 imports (14.9%)
- **Local**: 1926 imports (51.4%)
...
**Dependency Changes**:
- Added: core.config, core.error_handling, core.file_locking, core.file_operations, core.logger, core.message_management, core.response_tracking, core.user_data_handlers, core.user_management
...
**Dependency Changes**:
- Removed: importlib.util, tests/development_tools/test_documentation_sync_checker.py, tests/development_tools/test_error_scenarios.py, tests/development_tools/test_generate_function_registry.py, tests/development_tools/test_generate_module_dependencies.py, tests/development_tools/test_legacy_reference_cleanup.py, tests/development_tools/test_regenerate_coverage_metrics.py

<!-- MANUAL_ENHANCEMENT_START -->
<!-- Add any additional context, key functions, or special considerations here -->
<!-- MANUAL_ENHANCEMENT_END -->

#### `tests/development_tools/test_ai_tools_runner.py`
- **Purpose**: Test file for ai tools runner
- **Dependencies**: 
  - **Standard Library**:
    - `pathlib (Path)`
    - `subprocess`
...
- **Dependencies**: 
  - **Local**:
    - `development_tools.services.constants (ASCII_COMPLIANCE_FILES)` (NEW)
...
**Dependency Changes**:
- Added: development_tools.services.constants, tests.development_tools.conftest
...
- **Dependencies**: 
  - **Local**:
    - `development_tools.services.operations (AIToolsService)` (NEW)
    - `development_tools.services.standard_exclusions (should_exclude_file)` (NEW)
...
**Dependency Changes**:
- Added: development_tools.services.operations, development_tools.services.standard_exclusions, tests.development_tools.conftest
...
- **Dependencies**: 
  - **Local**:
    ...
    - `development_tools.services (standard_exclusions)` (NEW)
    - `tests.development_tools.conftest (load_development_tools_module)` (NEW)
  - **Standard Library**:
    - `pathlib (Path)`
    - `sys`
...
**Dependency Changes**:
- Added: development_tools.config, development_tools.services, tests.development_tools.conftest
...
- **Dependencies**: 
  - **Local**:
    - `core.config (BASE_DATA_DIR, get_user_data_dir, get_user_file_path)` (NEW)
...
**Dependency Changes**:
- Added: communication.communication_channels.discord.checkin_view, core.user_management, tests.test_utilities
- Removed: unittest.mock
