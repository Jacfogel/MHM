...
- **Files Scanned**: 366
- **Total Imports Found**: 3990
- **Dependencies Documented**: 366 (100% coverage)
- **Standard Library Imports**: 1384 (34.7%)
- **Third-Party Imports**: 600 (15.0%)
...
- **Standard Library**: 1384 imports (34.7%)
- **Third-Party**: 600 imports (15.0%)
- **Local**: 2006 imports (50.3%)
...
- **Used by**: 
  ...
  - `tests/behavior/test_ai_chatbot_behavior.py`
  - `tests/behavior/test_natural_language_command_detection.py`
  - `tests/conftest.py`
...
**Dependency Changes**:
- Added: core.config, core.error_handling, core.logger
- Removed: ai/chatbot.py, tests/unit/test_lm_studio_manager.py
...
**Dependency Changes**:
- Added: core.config, core.error_handling, core.logger
- Removed: ai/chatbot.py, tests/behavior/test_ai_chatbot_behavior.py, tests/unit/test_prompt_manager.py
...
- **Dependencies**: 
  - **Local**:
    ...
    - `communication.core.channel_orchestrator (get_communication_manager)` (NEW)
    - `core.error_handling (handle_errors)` (NEW)
    - `core.logger (get_component_logger)` (NEW)
    - `core.user_data_handlers (get_all_user_ids, get_user_data, update_user_account)` (NEW)
...
**Dependency Changes**:
- Added: communication.command_handlers.account_handler, communication.command_handlers.base_handler, communication.command_handlers.shared_types, communication.core.channel_orchestrator, core.error_handling, core.logger, core.user_data_handlers, core.user_data_manager, core.user_management
- Removed: communication/command_handlers/account_handler.py, communication/command_handlers/interaction_handlers.py, communication/communication_channels/discord/account_flow_handler.py, tests/behavior/test_account_handler_behavior.py
...
**Dependency Changes**:
- Added: core.error_handling, core.logger
- Removed: communication/command_handlers/account_handler.py, communication/command_handlers/analytics_handler.py, communication/command_handlers/checkin_handler.py, communication/command_handlers/profile_handler.py, communication/command_handlers/schedule_handler.py, tests/behavior/test_base_handler_behavior.py, tests/test_error_handling_improvements.py
...
- **Used by**: 
  ...
  - `tests/behavior/test_task_suggestion_relevance.py`
  - `tests/unit/test_interaction_handlers_helpers.py`

**Dependency Changes**:
- Added: communication.command_handlers.account_handler, core.checkin_analytics, core.error_handling, core.logger, core.response_tracking, core.schedule_management, core.user_data_handlers, core.user_management, tasks.task_management
- Removed: communication/message_processing/command_parser.py, communication/message_processing/conversation_flow_manager.py, communication/message_processing/interaction_manager.py, tests/behavior/test_command_discovery_help.py, tests/behavior/test_discord_automation_complete.py, tests/behavior/test_interaction_handlers_behavior.py, tests/behavior/test_interaction_handlers_coverage_expansion.py, tests/behavior/test_task_suggestion_relevance.py, tests/unit/test_interaction_handlers_helpers.py
...
**Dependency Changes**:
- Removed: communication/command_handlers/account_handler.py, communication/command_handlers/analytics_handler.py, communication/command_handlers/base_handler.py, communication/command_handlers/checkin_handler.py, communication/command_handlers/interaction_handlers.py, communication/command_handlers/profile_handler.py, communication/command_handlers/schedule_handler.py, communication/communication_channels/discord/account_flow_handler.py, communication/message_processing/command_parser.py, communication/message_processing/interaction_manager.py, tests/behavior/test_account_handler_behavior.py, tests/behavior/test_analytics_handler_behavior.py, tests/behavior/test_base_handler_behavior.py, tests/behavior/test_checkin_handler_behavior.py, tests/behavior/test_command_discovery_help.py, tests/behavior/test_command_parser_coverage_expansion_phase3_simple.py, tests/behavior/test_communication_interaction_manager_behavior.py, tests/behavior/test_discord_automation_complete.py, tests/behavior/test_discord_task_reminder_followup.py, tests/behavior/test_interaction_handlers_behavior.py, tests/behavior/test_interaction_handlers_coverage_expansion.py, tests/behavior/test_profile_display_formatting.py, tests/behavior/test_profile_handler_behavior.py, tests/behavior/test_schedule_handler_behavior.py, tests/behavior/test_task_error_handling.py, tests/behavior/test_task_handler_behavior.py, tests/behavior/test_task_reminder_followup_behavior.py, tests/integration/test_task_reminder_integration.py
...
**Dependency Changes**:
- Added: communication.message_processing.conversation_flow_manager, core.checkin_analytics, core.error_handling, core.logger, tasks.task_management
- Removed: communication/message_processing/conversation_flow_manager.py, tests/behavior/test_discord_automation_complete.py, tests/behavior/test_task_error_handling.py, tests/behavior/test_task_handler_behavior.py, tests/behavior/test_task_reminder_followup_behavior.py, tests/integration/test_task_reminder_integration.py
...
**Dependency Changes**:
- Added: core.error_handling, core.logger
- Removed: communication/communication_channels/discord/bot.py, communication/communication_channels/email/bot.py, communication/core/channel_monitor.py, communication/core/channel_orchestrator.py, communication/core/factory.py, tests/behavior/test_communication_behavior.py, tests/behavior/test_communication_factory_coverage_expansion.py, tests/behavior/test_communication_manager_behavior.py, tests/behavior/test_communication_manager_coverage_expansion.py, tests/behavior/test_discord_bot_behavior.py, tests/behavior/test_email_bot_behavior.py
...
**Dependency Changes**:
- Added: core.error_handling, core.logger
- Removed: tests/unit/test_command_registry.py
...
**Dependency Changes**:
- Added: core.error_handling, core.logger
- Removed: tests/unit/test_message_formatter.py
...
**Dependency Changes**:
- Added: core.error_handling, core.logger
- Removed: communication/communication_channels/discord/event_handler.py, tests/unit/test_rich_formatter.py
...
- **Dependencies**: 
  - **Local**:
    ...
    - `core.error_handling (handle_errors)` (NEW)
    - `core.logger (get_component_logger)` (NEW)
    - `core.user_management (TIMEZONE_OPTIONS)` (NEW)
  - **Third-party**:
    - `discord`
- **Used by**: 
  - `communication/communication_channels/discord/bot.py`
...
**Dependency Changes**:
- Added: communication.command_handlers.account_handler, communication.command_handlers.shared_types, core.error_handling, core.logger, core.user_management
...
**Dependency Changes**:
- Added: core.error_handling, core.logger
- Removed: tests/unit/test_discord_api_client.py
...
**Dependency Changes**:
- Added: communication.communication_channels.discord.account_flow_handler, communication.communication_channels.discord.webhook_server, communication.communication_channels.discord.welcome_handler, core.config, core.error_handling, core.logger, core.user_data_handlers, core.user_management
...
**Dependency Changes**:
- Added: communication.message_processing.interaction_manager, core.error_handling, core.logger, core.user_management
- Removed: communication/core/channel_orchestrator.py, tests/unit/test_checkin_view.py
...
- Removed: tests/unit/test_discord_event_handler.py
...
- **Used by**: 
  ...
  - `tests/behavior/test_webhook_handler_behavior.py`

**Dependency Changes**:
- Added: communication.communication_channels.discord.welcome_handler, communication.core.welcome_manager, core.error_handling, core.logger, core.user_data_handlers, core.user_management
- Removed: communication/communication_channels/discord/webhook_server.py, concurrent.futures, tests/behavior/test_webhook_handler_behavior.py
...
- Removed: communication/communication_channels/discord/bot.py, http.server, nacl.exceptions, nacl.signing, tests/behavior/test_webhook_server_behavior.py
...
- Removed: communication/communication_channels/discord/bot.py, communication/communication_channels/discord/webhook_handler.py, tests/behavior/test_welcome_handler_behavior.py
...
**Dependency Changes**:
- Added: core.config, core.error_handling, core.logger
- Removed: email.header, email.mime.text, tests/behavior/test_email_bot_behavior.py, tests/unit/test_email_bot_body_extraction.py
...
**Dependency Changes**:
- Added: core.error_handling, core.logger
- Removed: communication/core/channel_orchestrator.py, tests/behavior/test_discord_checkin_retry_behavior.py, tests/communication/test_retry_manager.py
...
**Dependency Changes**:
- Added: core.config, core.error_handling, core.logger
- Removed: communication/communication_channels/discord/webhook_handler.py, communication/communication_channels/discord/welcome_handler.py, tests/behavior/test_webhook_handler_behavior.py, tests/behavior/test_welcome_handler_behavior.py, tests/behavior/test_welcome_manager_behavior.py
...
**Dependency Changes**:
- Added: core.config, core.error_handling, core.logger
- Removed: communication/message_processing/interaction_manager.py, tests/behavior/test_command_parser_coverage_expansion_phase3_simple.py, tests/behavior/test_communication_command_parser_behavior.py, tests/behavior/test_enhanced_command_parser_behavior.py, tests/behavior/test_task_suggestion_relevance.py, tests/unit/test_command_parser_helpers.py
...
- **Dependencies**: 
  - **Local**:
    ...
    - `core.user_data_handlers (get_user_data)` (NEW)
    - `tasks.task_management (get_task_by_id, schedule_task_reminders, update_task)` (NEW)
  - **Standard Library**:
    - `datetime (datetime, timedelta)`
    - `json`
    - `os`
...
**Dependency Changes**:
- Added: core.checkin_dynamic_manager, core.config, core.error_handling, core.logger, core.response_tracking, core.user_data_handlers, tasks.task_management
- Removed: communication/command_handlers/checkin_handler.py, communication/command_handlers/interaction_handlers.py, communication/command_handlers/task_handler.py, communication/core/channel_orchestrator.py, communication/message_processing/interaction_manager.py, core/service.py, tests/behavior/test_ai_chatbot_behavior.py, tests/behavior/test_checkin_expiry_semantics.py, tests/behavior/test_conversation_behavior.py, tests/behavior/test_conversation_flow_manager_behavior.py, tests/behavior/test_discord_bot_behavior.py, tests/behavior/test_discord_task_reminder_followup.py, tests/behavior/test_dynamic_checkin_behavior.py, tests/behavior/test_task_reminder_followup_behavior.py, tests/conftest.py
...
- Removed: core/scheduler.py, core/service.py, tests/behavior/test_auto_cleanup_behavior.py, tests/unit/test_auto_cleanup_paths.py, ui/ui_app_qt.py
...
**Dependency Changes**:
- Added: core.error_handling, core.logger
- Removed: ai/cache_manager.py, ai/chatbot.py, ai/lm_studio_manager.py, ai/prompt_manager.py, communication/communication_channels/discord/bot.py, communication/communication_channels/discord/webhook_server.py, communication/communication_channels/email/bot.py, communication/core/channel_orchestrator.py, communication/core/factory.py, communication/core/welcome_manager.py, communication/message_processing/command_parser.py, communication/message_processing/conversation_flow_manager.py, communication/message_processing/interaction_manager.py, core/auto_cleanup.py, core/backup_manager.py, core/file_operations.py, core/logger.py, core/message_management.py, core/scheduler.py, core/service.py, core/service_utilities.py, core/user_data_handlers.py, core/user_data_manager.py, core/user_data_validation.py, core/user_management.py, tasks/task_management.py, tests/ai/ai_test_base.py, tests/ai/test_ai_advanced.py, tests/ai/test_ai_core.py, tests/ai/test_ai_functionality_manual.py, tests/ai/test_ai_integration.py, tests/ai/test_ai_performance.py, tests/ai/test_ai_quality.py, tests/behavior/test_ai_chatbot_behavior.py, tests/behavior/test_backup_manager_behavior.py, tests/behavior/test_comprehensive_quantitative_analytics.py, tests/behavior/test_config_coverage_expansion_phase3_simple.py, tests/behavior/test_discord_bot_behavior.py, tests/behavior/test_message_behavior.py, tests/behavior/test_quantitative_analytics_expansion.py, tests/behavior/test_task_error_handling.py, tests/behavior/test_user_data_flow_architecture.py, tests/behavior/test_utilities_demo.py, tests/conftest.py, tests/debug_file_paths.py, tests/integration/test_account_lifecycle.py, tests/integration/test_task_cleanup_real.py, tests/integration/test_user_creation.py, tests/test_utilities.py, tests/ui/test_dialogs.py, tests/unit/test_auto_cleanup_paths.py, tests/unit/test_checkin_view.py, tests/unit/test_cleanup.py, tests/unit/test_config.py, tests/unit/test_file_operations.py, tests/unit/test_prompt_manager.py, tests/unit/test_user_management.py, ui/dialogs/account_creator_dialog.py, ui/dialogs/schedule_editor_dialog.py, ui/ui_app_qt.py
...
- **Used by**: 
  ...
  - `tests/unit/test_error_categorization.py`
...
**Dependency Changes**:
- Added: core.error_handling, core.logger
- Removed: core/user_data_manager.py, core/user_management.py, tests/behavior/test_account_management_real_behavior.py, tests/test_utilities.py, tests/unit/test_file_locking.py
...
- **Dependencies**: 
  ...
  - **Standard Library**:
    ...
    - `typing (Dict, Optional)`
- **Used by**: 
  - `tests/behavior/test_message_analytics_behavior.py`

**Dependency Changes**:
- Added: core.error_handling, core.logger, core.message_management
- Removed: tests/behavior/test_message_analytics_behavior.py
...
- Removed: communication/command_handlers/interaction_handlers.py, communication/command_handlers/schedule_handler.py, communication/core/channel_orchestrator.py, core/scheduler.py, core/ui_management.py, tests/behavior/test_schedule_management_behavior.py, tests/ui/test_dialog_coverage_expansion.py, tests/unit/test_schedule_management.py, tests/unit/test_user_preferences.py, ui/dialogs/category_management_dialog.py, ui/dialogs/checkin_management_dialog.py, ui/dialogs/schedule_editor_dialog.py, ui/dialogs/task_management_dialog.py, ui/widgets/period_row_widget.py, user/user_preferences.py
...
**Dependency Changes**:
- Added: core.error_handling, core.logger
- Removed: core/service.py, tests/behavior/test_user_context_behavior.py, tests/core/test_schedule_utilities.py, user/context_manager.py, user/user_context.py
...
- **Used by**: 
  ...
  - `core/user_data_validation.py`
  - `core/user_management.py`
  - `tests/unit/test_schema_validation_helpers.py`
...
- Removed: communication/core/channel_orchestrator.py, core/message_management.py, core/user_data_handlers.py, core/user_data_manager.py, core/user_data_validation.py, core/user_management.py, tests/unit/test_schema_validation_helpers.py, tests/unit/test_schemas_validation.py
...
- **Dependencies**: 
  - **Local**:
    ...
    - `core.message_management (get_recent_messages)` (NEW)
    - `core.schedule_utilities (get_current_day_names, get_current_time_periods_with_validation)` (NEW)
    - `core.scheduler (SchedulerManager)` (NEW)
    - `core.user_data_handlers (get_all_user_ids, get_user_data)` (NEW)
  - **Standard Library**:
    - `atexit`
...
**Dependency Changes**:
- Added: communication.core.channel_orchestrator, communication.message_processing.conversation_flow_manager, core.auto_cleanup, core.config, core.error_handling, core.file_auditor, core.file_operations, core.logger, core.message_management, core.schedule_utilities, core.scheduler, core.user_data_handlers
- Removed: tasks/task_management.py, tests/behavior/test_core_service_coverage_expansion.py, tests/behavior/test_service_behavior.py, tests/conftest.py, tests/integration/test_orphaned_reminder_cleanup.py, ui/dialogs/account_creator_dialog.py
...
- Removed: tests/unit/test_ui_management.py, ui/dialogs/schedule_editor_dialog.py, ui/widgets/checkin_settings_widget.py, ui/widgets/task_settings_widget.py
...
**Dependency Changes**:
- Added: core, core.config, core.error_handling, core.file_operations, core.logger, core.message_management, core.schemas, core.user_data_manager, core.user_data_validation, core.user_management
- Removed: ai/chatbot.py, ai/context_builder.py, communication/command_handlers/account_handler.py, communication/command_handlers/analytics_handler.py, communication/command_handlers/interaction_handlers.py, communication/command_handlers/profile_handler.py, communication/communication_channels/discord/bot.py, communication/communication_channels/discord/webhook_handler.py, communication/core/channel_orchestrator.py, communication/message_processing/conversation_flow_manager.py, core/auto_cleanup.py, core/backup_manager.py, core/checkin_analytics.py, core/response_tracking.py, core/schedule_management.py, core/scheduler.py, core/service.py, core/user_data_manager.py, core/user_data_validation.py, core/user_management.py, tasks/task_management.py, tests/ai/ai_test_base.py, tests/ai/test_ai_core.py, tests/ai/test_ai_functionality_manual.py, tests/ai/test_ai_quality.py, tests/behavior/test_account_handler_behavior.py, tests/behavior/test_account_management_real_behavior.py, tests/behavior/test_ai_chatbot_behavior.py, tests/behavior/test_comprehensive_quantitative_analytics.py, tests/behavior/test_conversation_behavior.py, tests/behavior/test_discord_bot_behavior.py, tests/behavior/test_discord_checkin_retry_behavior.py, tests/behavior/test_interaction_handlers_behavior.py, tests/behavior/test_interaction_handlers_coverage_expansion.py, tests/behavior/test_quantitative_analytics_expansion.py, tests/behavior/test_scheduler_behavior.py, tests/behavior/test_scheduler_coverage_expansion.py, tests/behavior/test_task_management_coverage_expansion.py, tests/behavior/test_user_data_flow_architecture.py, tests/behavior/test_utilities_demo.py, tests/conftest.py, tests/debug_file_paths.py, tests/integration/test_account_lifecycle.py, tests/integration/test_account_management.py, tests/integration/test_user_creation.py, tests/test_error_handling_improvements.py, tests/test_utilities.py, tests/ui/test_account_creation_ui.py, tests/ui/test_category_management_dialog.py, tests/ui/test_channel_management_dialog_coverage_expansion.py, tests/ui/test_dialog_behavior.py, tests/ui/test_dialog_coverage_expansion.py, tests/ui/test_dialogs.py, tests/ui/test_task_management_dialog.py, tests/ui/test_widget_behavior.py, tests/unit/test_user_data_handlers.py, tests/unit/test_user_data_manager.py, tests/unit/test_user_management.py, tests/unit/test_user_preferences.py, ui/dialogs/account_creator_dialog.py, ui/dialogs/category_management_dialog.py, ui/dialogs/channel_management_dialog.py, ui/dialogs/checkin_management_dialog.py, ui/dialogs/task_management_dialog.py, ui/dialogs/user_analytics_dialog.py, ui/dialogs/user_profile_dialog.py, ui/ui_app_qt.py, ui/widgets/checkin_settings_widget.py, ui/widgets/tag_widget.py, ui/widgets/task_settings_widget.py, user/context_manager.py, user/user_context.py, user/user_preferences.py
...
**Dependency Changes**:
- Added: core.config, core.error_handling, core.file_locking, core.file_operations, core.logger, core.message_management, core.response_tracking, core.schemas, core.user_data_handlers, core.user_management
- Removed: communication/command_handlers/account_handler.py, core/file_operations.py, core/message_management.py, core/user_data_handlers.py, core/user_management.py, tests/behavior/test_account_handler_behavior.py, tests/behavior/test_account_management_real_behavior.py, tests/behavior/test_backup_manager_behavior.py, tests/behavior/test_discord_bot_behavior.py, tests/behavior/test_interaction_handlers_behavior.py, tests/behavior/test_user_management_coverage_expansion.py, tests/conftest.py, tests/integration/test_account_lifecycle.py, tests/integration/test_account_management.py, tests/integration/test_user_creation.py, tests/test_error_handling_improvements.py, tests/test_utilities.py, tests/ui/test_account_creation_ui.py, tests/ui/test_dialogs.py, tests/ui/test_widget_behavior.py, tests/unit/test_user_data_manager.py, tests/unit/test_user_management.py, ui/dialogs/account_creator_dialog.py, ui/ui_app_qt.py
...
**Dependency Changes**:
- Added: core.config, core.error_handling, core.file_locking, core.file_operations, core.logger, core.schemas, core.user_data_handlers, core.user_data_manager
- Removed: communication/command_handlers/account_handler.py, communication/command_handlers/interaction_handlers.py, communication/command_handlers/schedule_handler.py, communication/communication_channels/discord/account_flow_handler.py, communication/communication_channels/discord/bot.py, communication/communication_channels/discord/checkin_view.py, communication/communication_channels/discord/event_handler.py, communication/communication_channels/discord/task_reminder_view.py, communication/communication_channels/discord/webhook_handler.py, communication/core/channel_orchestrator.py, communication/message_processing/interaction_manager.py, core/user_data_handlers.py, core/user_data_manager.py, tests/ai/ai_test_base.py, tests/ai/test_ai_advanced.py, tests/ai/test_ai_core.py, tests/ai/test_ai_functionality_manual.py, tests/ai/test_ai_integration.py, tests/ai/test_ai_performance.py, tests/ai/test_ai_quality.py, tests/behavior/test_account_handler_behavior.py, tests/behavior/test_account_management_real_behavior.py, tests/behavior/test_ai_chatbot_behavior.py, tests/behavior/test_backup_manager_behavior.py, tests/behavior/test_comprehensive_quantitative_analytics.py, tests/behavior/test_conversation_behavior.py, tests/behavior/test_discord_bot_behavior.py, tests/behavior/test_interaction_handlers_behavior.py, tests/behavior/test_interaction_handlers_coverage_expansion.py, tests/behavior/test_quantitative_analytics_expansion.py, tests/behavior/test_scheduler_behavior.py, tests/behavior/test_scheduler_coverage_expansion.py, tests/behavior/test_service_behavior.py, tests/behavior/test_task_suggestion_relevance.py, tests/behavior/test_user_context_behavior.py, tests/behavior/test_user_management_coverage_expansion.py, tests/behavior/test_utilities_demo.py, tests/behavior/test_webhook_handler_behavior.py, tests/conftest.py, tests/integration/test_account_lifecycle.py, tests/integration/test_account_management.py, tests/integration/test_user_creation.py, tests/test_utilities.py, tests/ui/test_account_creation_ui.py, tests/ui/test_dialogs.py, tests/ui/test_message_editor_dialog.py, tests/ui/test_user_analytics_dialog.py, tests/ui/test_widget_behavior.py, tests/unit/test_checkin_management_dialog.py, tests/unit/test_checkin_view.py, tests/unit/test_user_context.py, tests/unit/test_user_data_manager.py, tests/unit/test_user_management.py, ui/dialogs/account_creator_dialog.py, ui/dialogs/user_profile_dialog.py, ui/widgets/channel_selection_widget.py, ui/widgets/dynamic_list_container.py
...
- Removed: ai/chatbot.py, communication/command_handlers/analytics_handler.py, communication/command_handlers/interaction_handlers.py, communication/command_handlers/profile_handler.py, communication/command_handlers/task_handler.py, communication/core/channel_orchestrator.py, communication/message_processing/conversation_flow_manager.py, communication/message_processing/interaction_manager.py, core/scheduler.py, tests/ai/ai_test_base.py, tests/behavior/test_account_management_real_behavior.py, tests/behavior/test_discord_bot_behavior.py, tests/behavior/test_discord_task_reminder_followup.py, tests/behavior/test_interaction_handlers_behavior.py, tests/behavior/test_interaction_handlers_coverage_expansion.py, tests/behavior/test_task_behavior.py, tests/behavior/test_task_cleanup_bug.py, tests/behavior/test_task_crud_disambiguation.py, tests/behavior/test_task_error_handling.py, tests/behavior/test_task_management_coverage_expansion.py, tests/behavior/test_task_reminder_followup_behavior.py, tests/behavior/test_task_suggestion_relevance.py, tests/integration/test_orphaned_reminder_cleanup.py, tests/integration/test_task_cleanup_real.py, tests/integration/test_task_cleanup_real_bug_verification.py, tests/integration/test_task_cleanup_silent_failure.py, tests/integration/test_task_reminder_integration.py, tests/test_error_handling_improvements.py, tests/unit/test_recurring_tasks.py, ui/dialogs/account_creator_dialog.py, ui/dialogs/task_crud_dialog.py, ui/dialogs/task_edit_dialog.py, ui/dialogs/task_management_dialog.py, ui/ui_app_qt.py, ui/widgets/tag_widget.py, ui/widgets/task_settings_widget.py
...
#### `tests/behavior/test_account_handler_behavior.py`
- **Purpose**: Behavior tests for account handler behavior
- **Dependencies**: 
  - **Local**:
    - `communication.command_handlers.account_handler (AccountManagementHandler, _generate_confirmation_code, _pending_link_operations, _send_confirmation_code)` (NEW)
    - `communication.command_handlers.shared_types (ParsedCommand)` (NEW)
...
**Dependency Changes**:
- Added: communication.command_handlers.account_handler, communication.command_handlers.shared_types, core.user_data_handlers, core.user_data_manager, core.user_management, tests.test_utilities
- Removed: unittest.mock
...
- **Dependencies**: 
  - **Local**:
    - `core.file_locking (safe_json_write)` (NEW)
    ...
    - `tests.test_utilities (TestDataFactory, TestDataManager, TestUserFactory)` (NEW)
  - **Standard Library**:
    - `json`
    - `logging`
    - `os`
...
**Dependency Changes**:
- Added: core.file_locking, core.file_operations, core.message_management, core.user_data_handlers, core.user_data_manager, core.user_management, tasks.task_management, tests.conftest, tests.test_utilities
...
- **Dependencies**: 
  - **Local**:
    ...
    - `core.config (BASE_DATA_DIR, core.config, get_user_data_dir)` (NEW)
    - `core.user_data_manager (rebuild_user_index)` (NEW)
    - `core.user_management (get_user_id_by_identifier)` (NEW)
    - `tests.test_utilities (TestDataFactory, TestUserFactory)` (NEW)
  - **Standard Library**:
...
**Dependency Changes**:
- Added: core.backup_manager, core.config, core.user_data_manager, core.user_management, tests.test_utilities
- Removed: unittest.mock
...
- **Dependencies**: 
  - **Local**:
    - `communication.message_processing.conversation_flow_manager (CHECKIN_INACTIVITY_MINUTES, FLOW_CHECKIN, conversation_manager)` (NEW)
...
- **Dependencies**: 
  - **Local**:
    - `communication.core.channel_orchestrator (CommunicationManager)` (NEW)
    - `communication.message_processing.conversation_flow_manager (CHECKIN_MOOD, ConversationManager, FLOW_CHECKIN, FLOW_NONE, conversation_manager)` (NEW)
    - `tests.test_utilities (TestUserFactory)` (NEW)
  - **Standard Library**:
    - `datetime`
    - `json`
...
**Dependency Changes**:
- Added: communication.core.channel_orchestrator, communication.message_processing.conversation_flow_manager, tests.test_utilities
- Removed: unittest.mock
...
**Dependency Changes**:
- Added: core.config, core.user_data_handlers, core.user_data_manager, core.user_management, tasks.task_management, tests.test_utilities
- Removed: _pytest.unraisableexception, unittest.mock
...
#### `tests/behavior/test_discord_checkin_retry_behavior.py`
- **Purpose**: Behavior tests for discord checkin retry behavior
- **Dependencies**: 
  - **Local**:
    - `communication.core.channel_orchestrator (CommunicationManager)` (NEW)
    - `communication.core.retry_manager (QueuedMessage)` (NEW)
    - `core.user_data_handlers (get_user_data, save_user_data)` (NEW)
    - `tests.test_utilities (TestDataManager, TestUserFactory)` (NEW)
  - **Standard Library**:
    - `datetime (datetime, timedelta)`
    - `time`
    - `unittest.mock (MagicMock, Mock, patch)`
...
**Dependency Changes**:
- Added: communication.core.channel_orchestrator, communication.core.retry_manager, core.user_data_handlers, tests.test_utilities
- Removed: unittest.mock
...
#### `tests/behavior/test_discord_task_reminder_followup.py`
- **Purpose**: Behavior tests for discord task reminder followup
- **Dependencies**: 
  - **Local**:
    - `communication.message_processing.conversation_flow_manager (FLOW_TASK_REMINDER, conversation_manager)` (NEW)
    - `communication.message_processing.interaction_manager (InteractionManager)` (NEW)
    - `tasks.task_management (load_active_tasks)` (NEW)
    - `tests.test_utilities (TestUserFactory)` (NEW)
  - **Standard Library**:
    - `datetime`
...
**Dependency Changes**:
- Added: communication.message_processing.conversation_flow_manager, communication.message_processing.interaction_manager, tasks.task_management, tests.test_utilities
- Removed: unittest.mock
...
**Dependency Changes**:
- Added: core.user_data_handlers, core.user_data_manager, core.user_management, tasks.task_management, tests.test_utilities
...
**Dependency Changes**:
- Added: core, core.user_data_handlers, core.user_management, tasks.task_management, tests.test_utilities
- Removed: unittest.mock
...
- **Dependencies**: 
  - **Local**:
    - `core.logger (BackupDirectoryRotatingFileHandler, cleanup_old_logs, core.logger, disable_module_logging, force_restart_logging, get_log_file_info, get_log_level_from_env, get_logger, get_verbose_mode, set_console_log_level, set_verbose_mode, setup_logging, suppress_noisy_logging, toggle_verbose_logging)` (NEW)
  - **Standard Library**:
    - `logging`
    - `os`
    - `pathlib (Path)`
...
#### `tests/behavior/test_message_analytics_behavior.py`
- **Purpose**: Behavior tests for message analytics behavior
- **Dependencies**: 
  - **Local**:
    - `core.message_analytics (MessageAnalytics)` (NEW)
  - **Standard Library**:
    - `datetime (datetime, timedelta)`
    - `unittest.mock (patch)`
  - **Third-party**:
...
#### `tests/behavior/test_natural_language_command_detection.py`
- **Purpose**: Behavior tests for natural language command detection
- **Dependencies**: 
  - **Local**:
    - `ai.chatbot (get_ai_chatbot)` (NEW)
  - **Third-party**:
...
#### `tests/behavior/test_task_cleanup_bug.py`
- **Purpose**: Behavior tests for task cleanup bug
- **Dependencies**: 
  - **Local**:
    - `tasks.task_management (cleanup_task_reminders, create_task)` (NEW)
    - `tests.test_utilities (TestUserFactory)` (NEW)
  - **Standard Library**:
    - `datetime (datetime, timedelta)`
    - `unittest.mock (MagicMock, patch)`
...
**Dependency Changes**:
- Added: tasks.task_management, tests.test_utilities
- Removed: unittest.mock
...
#### `tests/behavior/test_task_error_handling.py`
- **Purpose**: Behavior tests for task error handling
- **Dependencies**: 
  - **Local**:
    - `communication.command_handlers.shared_types (ParsedCommand)` (NEW)
    - `communication.command_handlers.task_handler (TaskManagementHandler)` (NEW)
    - `core.config (get_user_data_dir)` (NEW)
    - `tasks.task_management (complete_task, create_task, delete_task, get_task_by_id, load_active_tasks, schedule_task_reminders, update_task)` (NEW)
    - `tests.test_utilities (TestUserFactory)` (NEW)
  - **Standard Library**:
    - `datetime (datetime, timedelta)`
    - `json`
...
**Dependency Changes**:
- Added: communication.command_handlers.shared_types, communication.command_handlers.task_handler, core.config, tasks.task_management, tests.test_utilities
- Removed: unittest.mock
...
#### `tests/behavior/test_task_reminder_followup_behavior.py`
- **Purpose**: Behavior tests for task reminder followup behavior
- **Dependencies**: 
  - **Local**:
    - `communication.command_handlers.task_handler (TaskManagementHandler)` (NEW)
    - `communication.message_processing.conversation_flow_manager (FLOW_TASK_REMINDER, conversation_manager)` (NEW)
    - `tasks.task_management (create_task, get_task_by_id)` (NEW)
    - `tests.test_utilities (TestUserFactory)` (NEW)
  - **Standard Library**:
    - `datetime (datetime, timedelta)`
    - `unittest.mock (MagicMock, patch)`
...
**Dependency Changes**:
- Added: communication.command_handlers.task_handler, communication.message_processing.conversation_flow_manager, tasks.task_management, tests.test_utilities
- Removed: unittest.mock
...
#### `tests/behavior/test_task_suggestion_relevance.py`
- **Purpose**: Behavior tests for task suggestion relevance
- **Dependencies**: 
  - **Local**:
    - `communication.command_handlers.interaction_handlers (TaskManagementHandler)` (NEW)
    - `communication.message_processing.command_parser (EnhancedCommandParser, ParsedCommand)` (NEW)
    - `communication.message_processing.interaction_manager (InteractionManager, handle_user_message)` (NEW)
    - `core.user_management (get_user_id_by_identifier)` (NEW)
    - `tasks.task_management (load_active_tasks, save_active_tasks)` (NEW)
    - `tests.test_utilities (TestUserFactory)` (NEW)
  - **Third-party**:
...
**Dependency Changes**:
- Added: communication.command_handlers.interaction_handlers, communication.message_processing.command_parser, communication.message_processing.interaction_manager, core.user_management, tasks.task_management, tests.test_utilities
...
#### `tests/behavior/test_user_data_flow_architecture.py`
- **Purpose**: Behavior tests for user data flow architecture
- **Dependencies**: 
  - **Local**:
    - `core.config (get_user_data_dir)` (NEW)
    - `core.user_data_handlers (get_user_data, save_user_data, update_user_preferences)` (NEW)
...
#### `tests/behavior/test_webhook_handler_behavior.py`
- **Purpose**: Behavior tests for webhook handler behavior
- **Dependencies**: 
  - **Local**:
    - `communication.communication_channels.discord.webhook_handler (EVENT_APPLICATION_AUTHORIZED, EVENT_APPLICATION_DEAUTHORIZED, handle_application_authorized, handle_webhook_event, parse_webhook_event, verify_webhook_signature)` (NEW)
    - `communication.core.welcome_manager (clear_welcomed_status, has_been_welcomed, mark_as_welcomed)` (NEW)
    - `core.user_management (get_user_id_by_identifier)` (NEW)
    - `tests.test_utilities (TestUserFactory)` (NEW)
  - **Standard Library**:
...
**Dependency Changes**:
- Added: communication.communication_channels.discord.webhook_handler, communication.core.welcome_manager, core.user_management, tests.test_utilities
- Removed: unittest.mock
...
#### `tests/behavior/test_webhook_server_behavior.py`
- **Purpose**: Behavior tests for webhook server behavior
- **Dependencies**: 
  - **Local**:
    - `communication.communication_channels.discord.webhook_server (DiscordWebhookHandler, WebhookServer)` (NEW)
  - **Standard Library**:
    - `io (BytesIO)`
    - `json`
    - `socket`
...
**Dependency Changes**:
- Added: communication.communication_channels.discord.webhook_server
- Removed: http.server, unittest.mock
...
#### `tests/behavior/test_welcome_handler_behavior.py`
- **Purpose**: Behavior tests for welcome handler behavior
- **Dependencies**: 
  - **Local**:
    - `communication.communication_channels.discord.welcome_handler (clear_welcomed_status, get_welcome_message, get_welcome_message_view, has_been_welcomed, mark_as_welcomed)` (NEW)
    - `communication.core.welcome_manager (has_been_welcomed)` (NEW)
  - **Standard Library**:
    - `unittest.mock (MagicMock, patch)`
  - **Third-party**:
    - `pytest`
...
**Dependency Changes**:
- Added: communication.communication_channels.discord.welcome_handler, communication.core.welcome_manager
- Removed: unittest.mock
...
#### `tests/behavior/test_welcome_manager_behavior.py`
- **Purpose**: Behavior tests for welcome manager behavior
- **Dependencies**: 
  - **Local**:
    - `communication.core.welcome_manager (clear_welcomed_status, get_welcome_message, has_been_welcomed, mark_as_welcomed)` (NEW)
  - **Standard Library**:
...
**Dependency Changes**:
- Added: communication.core.welcome_manager
- Removed: unittest.mock
...
- **Dependencies**: 
  - **Local**:
    ...
    - `core.logger (PytestContextLogFormatter, _component_loggers)` (NEW)
    - `core.scheduler (SchedulerManager)` (NEW)
    ...
    - `core.user_data_manager (UserDataManager, core.user_data_manager, update_user_index)` (NEW)
    - `core.user_management (clear_user_caches, core.user_management, get_user_id_by_identifier)` (NEW)
    - `tests.test_utilities (TestUserFactory)` (NEW)
  - **Standard Library**:
    - `datetime (datetime, timedelta)`
    - `glob`
...
#### `tests/development_tools/__init__.py`
- **Purpose**: Test file for   init  
- **Dependencies**: None (no imports)
- **Used by**: None (not imported by other modules)
...
- **Dependencies**: 
  - **Local**:
    - `tests.development_tools.test_verification_summary (print_verification_summary)` (NEW)
  - **Standard Library**:
    - `importlib.util`
    - `pathlib (Path)`
    - `shutil`
...
#### `tests/development_tools/test_analysis_validation_framework.py`
- **Purpose**: Test file for analysis validation framework
- **Dependencies**: 
  - **Local**:
    - `development_tools (config)` (NEW)
    - `development_tools.shared.service (AIToolsService)` (NEW)
    - `development_tools.shared.service.data_loading (DataLoadingMixin)` (NEW)
    - `development_tools.shared.service.report_generation (ReportGenerationMixin)` (NEW)
    - `development_tools.shared.standard_exclusions (should_exclude_file)` (NEW)
...
**Dependency Changes**:
- Added: development_tools, development_tools.shared.service, development_tools.shared.service.data_loading, development_tools.shared.service.report_generation, development_tools.shared.standard_exclusions, tests.development_tools.conftest
...
#### `tests/development_tools/test_analyze_ascii_compliance.py`
- **Purpose**: Test file for analyze ascii compliance
- **Dependencies**: 
  - **Local**:
    - `tests.development_tools.conftest (demo_project_root, load_development_tools_module, test_config_path)` (NEW)
  - **Standard Library**:
...
#### `tests/development_tools/test_analyze_error_handling.py`
- **Purpose**: Test file for analyze error handling
- **Dependencies**: 
  - **Local**:
    - `tests.development_tools.conftest (demo_project_root, load_development_tools_module, test_config_path)` (NEW)
  - **Standard Library**:
...
#### `tests/development_tools/test_analyze_function_registry.py`
- **Purpose**: Test file for analyze function registry
- **Dependencies**: 
  - **Local**:
    - `tests.development_tools.conftest (demo_project_root, load_development_tools_module, test_config_path)` (NEW)
  - **Standard Library**:
...
#### `tests/development_tools/test_analyze_functions.py`
- **Purpose**: Test file for analyze functions
- **Dependencies**: 
  - **Local**:
    - `tests.development_tools.conftest (demo_project_root, load_development_tools_module, test_config_path)` (NEW)
  - **Standard Library**:
...
#### `tests/development_tools/test_analyze_heading_numbering.py`
- **Purpose**: Test file for analyze heading numbering
- **Dependencies**: 
  - **Local**:
    - `tests.development_tools.conftest (demo_project_root, load_development_tools_module, test_config_path)` (NEW)
  - **Standard Library**:
...
#### `tests/development_tools/test_analyze_module_dependencies.py`
- **Purpose**: Test file for analyze module dependencies
- **Dependencies**: 
  - **Local**:
    - `tests.development_tools.conftest (demo_project_root, load_development_tools_module)` (NEW)
  - **Standard Library**:
...
#### `tests/development_tools/test_analyze_unconverted_links.py`
- **Purpose**: Test file for analyze unconverted links
- **Dependencies**: 
  - **Local**:
    - `tests.development_tools.conftest (demo_project_root, load_development_tools_module, test_config_path)` (NEW)
  - **Standard Library**:
...
#### `tests/development_tools/test_analyze_unused_imports.py`
- **Purpose**: Test file for analyze unused imports
- **Dependencies**: 
  - **Local**:
...
#### `tests/development_tools/test_audit_tier_comprehensive.py`
- **Purpose**: Test file for audit tier comprehensive
- **Dependencies**: 
  - **Local**:
    - `tests.development_tools.conftest (load_development_tools_module, temp_project_copy)` (NEW)
  - **Standard Library**:
...
#### `tests/development_tools/test_audit_tier_e2e_verification.py`
- **Purpose**: Test file for audit tier e2e verification
- **Dependencies**: 
  - **Local**:
...
**Dependency Changes**:
- Added: core.error_handling, core.logger, tests.development_tools.conftest
...
#### `tests/development_tools/test_constants.py`
- **Purpose**: Test file for constants
- **Dependencies**: 
  - **Standard Library**:
    - `importlib.util`
    - `pathlib (Path)`
...
#### `tests/development_tools/test_decision_support.py`
- **Purpose**: Test file for decision support
- **Dependencies**: 
  - **Local**:
    - `tests.development_tools.conftest (load_development_tools_module)` (NEW)
  - **Standard Library**:
...
#### `tests/development_tools/test_documentation_sync_checker.py`
- **Purpose**: Test file for documentation sync checker
- **Dependencies**: 
  - **Local**:
    - `tests.development_tools.conftest (load_development_tools_module)` (NEW)
  - **Standard Library**:
...
#### `tests/development_tools/test_error_scenarios.py`
- **Purpose**: Test file for error scenarios
- **Dependencies**: 
  - **Local**:
    - `tests.development_tools.conftest (load_development_tools_module)` (NEW)
  - **Standard Library**:
...
#### `tests/development_tools/test_exclusion_utilities.py`
- **Purpose**: Test file for exclusion utilities
- **Dependencies**: 
  - **Local**:
    - `tests.development_tools.conftest (load_development_tools_module)` (NEW)
  - **Standard Library**:
...
#### `tests/development_tools/test_false_negative_detection.py`
- **Purpose**: Test file for false negative detection
- **Dependencies**: 
  - **Local**:
    - `tests.development_tools.conftest (demo_project_root, load_development_tools_module, test_config_path)` (NEW)
  - **Standard Library**:
...
#### `tests/development_tools/test_fix_documentation_headings.py`
- **Purpose**: Test file for fix documentation headings
- **Dependencies**: 
  - **Local**:
    - `tests.development_tools.conftest (load_development_tools_module, temp_project_copy)` (NEW)
  - **Standard Library**:
...
#### `tests/development_tools/test_fix_documentation_links.py`
- **Purpose**: Test file for fix documentation links
- **Dependencies**: 
  - **Local**:
    - `tests.development_tools.conftest (load_development_tools_module, temp_project_copy)` (NEW)
  - **Standard Library**:
...
#### `tests/development_tools/test_fix_project_cleanup.py`
- **Purpose**: Test file for fix project cleanup
- **Dependencies**: 
  - **Local**:
    - `tests.development_tools.conftest (load_development_tools_module, temp_project_copy)` (NEW)
  - **Standard Library**:
...
#### `tests/development_tools/test_generate_consolidated_report.py`
- **Purpose**: Test file for generate consolidated report
- **Dependencies**: 
  - **Local**:
    - `tests.development_tools.conftest (load_development_tools_module, temp_project_copy)` (NEW)
  - **Standard Library**:
...
#### `tests/development_tools/test_generate_directory_tree.py`
- **Purpose**: Test file for generate directory tree
- **Dependencies**: 
  - **Local**:
    - `tests.development_tools.conftest (demo_project_root, load_development_tools_module, test_config_path)` (NEW)
  - **Standard Library**:
...
#### `tests/development_tools/test_generate_error_handling_recommendations.py`
- **Purpose**: Test file for generate error handling recommendations
- **Dependencies**: 
  - **Local**:
    - `tests.development_tools.conftest (load_development_tools_module)` (NEW)
  - **Standard Library**:
...
#### `tests/development_tools/test_generate_error_handling_report.py`
- **Purpose**: Test file for generate error handling report
- **Dependencies**: 
  - **Local**:
    - `tests.development_tools.conftest (load_development_tools_module)` (NEW)
  - **Standard Library**:
...
#### `tests/development_tools/test_generate_function_docstrings.py`
- **Purpose**: Test file for generate function docstrings
- **Dependencies**: 
  - **Local**:
    - `tests.development_tools.conftest (demo_project_root, load_development_tools_module, test_config_path)` (NEW)
  - **Standard Library**:
...
#### `tests/development_tools/test_generate_function_registry.py`
- **Purpose**: Test file for generate function registry
- **Dependencies**: 
  - **Local**:
    - `development_tools.config` (NEW)
    - `development_tools.shared (standard_exclusions)` (NEW)
    - `tests.development_tools.conftest (load_development_tools_module)` (NEW)
  - **Standard Library**:
    - `pathlib (Path)`
    - `sys`
...
**Dependency Changes**:
- Added: development_tools.config, development_tools.shared, tests.development_tools.conftest
...
#### `tests/development_tools/test_generate_module_dependencies.py`
- **Purpose**: Test file for generate module dependencies
- **Dependencies**: 
  - **Local**:
    - `development_tools.config` (NEW)
    - `development_tools.shared (standard_exclusions)` (NEW)
...
#### `tests/development_tools/test_generate_unused_imports_report.py`
- **Purpose**: Test file for generate unused imports report
- **Dependencies**: 
  - **Local**:
    - `tests.development_tools.conftest (load_development_tools_module, temp_project_copy)` (NEW)
  - **Standard Library**:
...
#### `tests/development_tools/test_integration_workflows.py`
- **Purpose**: Integration tests for integration workflows
- **Dependencies**: 
  - **Local**:
    - `tests.development_tools.conftest (load_development_tools_module)` (NEW)
  - **Standard Library**:
...
#### `tests/development_tools/test_legacy_reference_cleanup.py`
- **Purpose**: Test file for legacy reference cleanup
- **Dependencies**: 
  - **Local**:
    - `tests.development_tools.conftest (load_development_tools_module)` (NEW)
  - **Standard Library**:
...
- **Purpose**: Test file for run development tools
- **Dependencies**: 
  - **Standard Library**:
    - `pathlib (Path)`
    - `subprocess`
...
#### `tests/development_tools/test_standard_exclusions.py`
- **Purpose**: Test file for standard exclusions
- **Dependencies**: 
  - **Standard Library**:
    - `importlib.util`
    - `pathlib (Path)`
...
#### `tests/development_tools/test_supporting_tools.py`
- **Purpose**: Test file for supporting tools
- **Dependencies**: 
  - **Local**:
    - `tests.development_tools.conftest (load_development_tools_module)` (NEW)
  - **Standard Library**:
...
#### `tests/development_tools/test_verification_summary.py`
- **Purpose**: Test file for verification summary
- **Dependencies**: None (no imports)
- **Used by**: 
  - `tests/development_tools/conftest.py`
...
#### `tests/fixtures/development_tools_demo/demo_module.py`
- **Purpose**: Test file for demo module
- **Dependencies**: 
  - **Standard Library**:
    - `os`
    - `typing (Dict, List)`
...
#### `tests/fixtures/development_tools_demo/demo_module2.py`
- **Purpose**: Test file for demo module2
- **Dependencies**: 
  - **Standard Library**:
    - `json`
    - `pathlib (Path)`
    - `sys`
  - **Third-party**:
    - `demo_module (DemoClass, simple_function)`
- **Used by**: None (not imported by other modules)
...
#### `tests/fixtures/development_tools_demo/demo_tests.py`
- **Purpose**: Test file for demo tests
- **Dependencies**: 
  - **Standard Library**:
    - `pathlib (Path)`
    - `sys`
...
#### `tests/fixtures/development_tools_demo/false_negative_test_code.py`
- **Purpose**: Test file for false negative code
- **Dependencies**: 
  - **Third-party**:
    - `requests`
- **Used by**: None (not imported by other modules)
...
- **Purpose**: Test file for legacy code
- **Dependencies**: None (no imports)
- **Used by**: None (not imported by other modules)
...
- **Dependencies**: 
  - **Local**:
    ...
    - `core.user_data_manager (rebuild_user_index, update_user_index)` (NEW)
...
#### `tests/integration/test_orphaned_reminder_cleanup.py`
- **Purpose**: Integration tests for orphaned reminder cleanup
- **Dependencies**: 
  - **Local**:
    - `communication.core.channel_orchestrator (CommunicationManager)` (NEW)
    - `core.scheduler (SchedulerManager)` (NEW)
    - `core.service (get_scheduler_manager)` (NEW)
    - `tasks.task_management (complete_task, create_task, delete_task, get_task_by_id, load_active_tasks)` (NEW)
    - `tests.test_utilities (TestUserFactory)` (NEW)
  - **Standard Library**:
    - `datetime (datetime, timedelta)`
    - `unittest.mock (MagicMock, patch)`
...
**Dependency Changes**:
- Added: communication.core.channel_orchestrator, core.scheduler, core.service, tasks.task_management, tests.test_utilities
- Removed: unittest.mock
...
#### `tests/integration/test_task_cleanup_real.py`
- **Purpose**: Integration tests for task cleanup real
- **Dependencies**: 
  - **Local**:
    - `communication.core.channel_orchestrator (CommunicationManager)` (NEW)
    - `core.config (get_user_data_dir)` (NEW)
    - `core.scheduler (SchedulerManager)` (NEW)
    - `tasks.task_management (complete_task, create_task, delete_task, get_task_by_id, load_active_tasks, load_completed_tasks, update_task)` (NEW)
    - `tests.test_utilities (TestUserFactory)` (NEW)
  - **Standard Library**:
    - `datetime`
    - `json`
...
**Dependency Changes**:
- Added: communication.core.channel_orchestrator, core.config, core.scheduler, tasks.task_management, tests.test_utilities
- Removed: unittest.mock
...
#### `tests/integration/test_task_cleanup_real_bug_verification.py`
- **Purpose**: Integration tests for task cleanup real bug verification
- **Dependencies**: 
  - **Local**:
    - `tasks.task_management (cleanup_task_reminders, complete_task, create_task, schedule_task_reminders)` (NEW)
    - `tests.test_utilities (TestUserFactory)` (NEW)
  - **Standard Library**:
    - `datetime (datetime, timedelta)`
    - `unittest.mock (MagicMock, patch)`
...
#### `tests/integration/test_task_cleanup_silent_failure.py`
- **Purpose**: Integration tests for task cleanup silent failure
- **Dependencies**: 
  - **Local**:
    - `tasks.task_management (cleanup_task_reminders, complete_task, create_task)` (NEW)
    - `tests.test_utilities (TestUserFactory)` (NEW)
  - **Standard Library**:
    - `datetime`
    - `logging`
...
#### `tests/integration/test_task_reminder_integration.py`
- **Purpose**: Integration tests for task reminder integration
- **Dependencies**: 
  - **Local**:
    - `communication.core.channel_orchestrator (CommunicationManager)` (NEW)
    - `core.scheduler (SchedulerManager)` (NEW)
    - `tasks.task_management (complete_task, create_task, delete_task, load_active_tasks, update_task)` (NEW)
    - `tests.test_utilities (TestUserFactory)` (NEW)
  - **Standard Library**:
    - `datetime (datetime, timedelta)`
    - `time`
...
**Dependency Changes**:
- Added: communication.core.channel_orchestrator, core.scheduler, tasks.task_management, tests.test_utilities
- Removed: unittest.mock
...
- **Dependencies**: 
  - **Local**:
    - `core.config (BASE_DATA_DIR, core.config, get_user_data_dir, get_user_file_path)` (NEW)
...
**Dependency Changes**:
- Added: core.config, core.user_data_handlers, core.user_data_manager, core.user_data_validation, core.user_management, tests.test_utilities
- Removed: unittest.mock
...
- **Dependencies**: 
  - **Local**:
    ...
    - `core.error_handling (DataError, FileOperationError, handle_errors)` (NEW)
...
- **Dependencies**: 
  - **Local**:
    - `core.config (core.config, get_user_data_dir, get_user_file_path)` (NEW)
    - `core.file_locking (safe_json_read, safe_json_write)` (NEW)
    - `core.file_operations (ensure_user_directory, load_json_data)` (NEW)
    - `core.user_data_handlers (get_user_data, save_user_data)` (NEW)
    - `core.user_data_manager (update_user_index)` (NEW)
    - `core.user_management (create_new_user, get_user_id_by_identifier)` (NEW)
...
**Dependency Changes**:
- Added: core.config, core.file_locking, core.file_operations, core.user_data_handlers, core.user_data_manager, core.user_management, tests.conftest
- Removed: tests/ai/ai_test_base.py, tests/ai/run_ai_functionality_tests.py, tests/ai/test_ai_advanced.py, tests/ai/test_ai_core.py, tests/ai/test_ai_functionality_manual.py, tests/ai/test_ai_integration.py, tests/ai/test_ai_performance.py, tests/ai/test_ai_quality.py, tests/ai/test_context_includes_recent_messages.py, tests/behavior/test_account_handler_behavior.py, tests/behavior/test_account_management_real_behavior.py, tests/behavior/test_ai_chatbot_behavior.py, tests/behavior/test_ai_context_builder_behavior.py, tests/behavior/test_ai_context_builder_coverage_expansion.py, tests/behavior/test_ai_conversation_history_behavior.py, tests/behavior/test_analytics_handler_behavior.py, tests/behavior/test_backup_manager_behavior.py, tests/behavior/test_checkin_expiry_semantics.py, tests/behavior/test_checkin_handler_behavior.py, tests/behavior/test_command_discovery_help.py, tests/behavior/test_communication_interaction_manager_behavior.py, tests/behavior/test_communication_manager_behavior.py, tests/behavior/test_communication_manager_coverage_expansion.py, tests/behavior/test_comprehensive_quantitative_analytics.py, tests/behavior/test_conversation_behavior.py, tests/behavior/test_conversation_flow_manager_behavior.py, tests/behavior/test_discord_advanced_automation.py, tests/behavior/test_discord_automation_complete.py, tests/behavior/test_discord_bot_behavior.py, tests/behavior/test_discord_checkin_retry_behavior.py, tests/behavior/test_discord_task_reminder_followup.py, tests/behavior/test_headless_service_behavior.py, tests/behavior/test_interaction_handlers_behavior.py, tests/behavior/test_interaction_handlers_coverage_expansion.py, tests/behavior/test_profile_display_formatting.py, tests/behavior/test_profile_handler_behavior.py, tests/behavior/test_quantitative_analytics_expansion.py, tests/behavior/test_schedule_handler_behavior.py, tests/behavior/test_schedule_suggestions.py, tests/behavior/test_scheduler_coverage_expansion.py, tests/behavior/test_task_cleanup_bug.py, tests/behavior/test_task_crud_disambiguation.py, tests/behavior/test_task_error_handling.py, tests/behavior/test_task_handler_behavior.py, tests/behavior/test_task_reminder_followup_behavior.py, tests/behavior/test_task_suggestion_relevance.py, tests/behavior/test_ui_automation_complete.py, tests/behavior/test_user_context_behavior.py, tests/behavior/test_user_data_flow_architecture.py, tests/behavior/test_utilities_demo.py, tests/behavior/test_webhook_handler_behavior.py, tests/conftest.py, tests/integration/test_account_lifecycle.py, tests/integration/test_account_management.py, tests/integration/test_orphaned_reminder_cleanup.py, tests/integration/test_task_cleanup_real.py, tests/integration/test_task_cleanup_real_bug_verification.py, tests/integration/test_task_cleanup_silent_failure.py, tests/integration/test_task_reminder_integration.py, tests/integration/test_user_creation.py, tests/ui/test_account_creation_ui.py, tests/ui/test_category_management_dialog.py, tests/ui/test_dialog_coverage_expansion.py, tests/ui/test_dialogs.py, tests/ui/test_message_editor_dialog.py, tests/ui/test_task_management_dialog.py, tests/ui/test_task_settings_widget.py, tests/ui/test_ui_app_qt_main.py, tests/ui/test_user_analytics_dialog.py, tests/ui/test_user_profile_dialog_coverage_expansion.py, tests/ui/test_widget_behavior.py, tests/unit/test_checkin_management_dialog.py, tests/unit/test_checkin_view.py, tests/unit/test_file_operations.py, tests/unit/test_logger_unit.py, tests/unit/test_user_context.py, tests/unit/test_user_data_handlers.py, tests/unit/test_user_data_manager.py, tests/unit/test_user_management.py, unittest.mock
...
**Dependency Changes**:
- Added: communication.core.channel_orchestrator, core.config, core.user_data_handlers, core.user_data_manager, core.user_management, tests.conftest, tests.test_utilities, ui.dialogs.account_creator_dialog, ui.dialogs.user_profile_dialog
...
- **Dependencies**: 
  ...
  - **Third-party**:
    - `PySide6.QtCore (Qt)`
    - `PySide6.QtTest (QTest)`
    - `PySide6.QtWidgets (QApplication, QLineEdit)`
    - `pytest`
- **Used by**: None (not imported by other modules)
...
**Dependency Changes**:
- Added: core.file_operations, core.user_data_handlers, core.user_data_manager, core.user_management, tests.conftest, tests.test_utilities, ui.widgets.category_selection_widget, ui.widgets.channel_selection_widget, ui.widgets.checkin_settings_widget, ui.widgets.dynamic_list_container, ui.widgets.dynamic_list_field, ui.widgets.period_row_widget, ui.widgets.tag_widget, ui.widgets.task_settings_widget, ui.widgets.user_profile_settings_widget
- Removed: PySide6.QtCore, PySide6.QtTest, PySide6.QtWidgets, unittest.mock
...
#### `tests/unit/test_ai_chatbot_helpers.py`
- **Purpose**: Unit tests for ai chatbot helpers
- **Dependencies**: 
  - **Local**:
    - `ai.chatbot (get_ai_chatbot)` (NEW)
  - **Standard Library**:
...
#### `tests/unit/test_channel_orchestrator.py`
- **Purpose**: Unit tests for channel orchestrator
- **Dependencies**: 
  - **Local**:
    - `communication.core.channel_orchestrator (CommunicationManager)` (NEW)
  - **Standard Library**:
...
**Dependency Changes**:
- Added: communication.core.channel_orchestrator
- Removed: unittest.mock
...
#### `tests/unit/test_checkin_view.py`
- **Purpose**: Unit tests for checkin view
- **Dependencies**: 
  - **Local**:
    - `communication.communication_channels.discord.checkin_view (get_checkin_view)` (NEW)
    - `core.config` (NEW)
...
**Dependency Changes**:
- Added: communication.communication_channels.discord.checkin_view, core.config, core.user_management, tests.test_utilities
- Removed: unittest.mock
...
#### `tests/unit/test_command_parser_helpers.py`
- **Purpose**: Unit tests for command parser helpers
- **Dependencies**: 
  - **Local**:
    - `communication.message_processing.command_parser (EnhancedCommandParser)` (NEW)
  - **Standard Library**:
    - `re`
    - `unittest.mock (MagicMock, Mock, patch)`
  - **Third-party**:
...
**Dependency Changes**:
- Added: communication.message_processing.command_parser
- Removed: unittest.mock
...
- **Dependencies**: 
  - **Local**:
    - `core.config (BASE_DATA_DIR, ConfigValidationError, DEFAULT_MESSAGES_DIR_PATH, USER_INFO_DIR_PATH, validate_ai_configuration, validate_all_configuration, validate_and_raise_if_invalid, validate_communication_channels, validate_core_paths, validate_environment_variables, validate_file_organization_settings, validate_logging_configuration, validate_scheduler_configuration)` (NEW)
  - **Standard Library**:
    - `os`
    - `unittest.mock (patch)`
  - **Third-party**:
...
#### `tests/unit/test_email_bot_body_extraction.py`
- **Purpose**: Unit tests for email bot body extraction
- **Dependencies**: 
  - **Local**:
    - `communication.communication_channels.email.bot (EmailBot)` (NEW)
  - **Standard Library**:
...
**Dependency Changes**:
- Added: communication.communication_channels.email.bot
- Removed: email.mime.base, email.mime.multipart, email.mime.text, unittest.mock
...
#### `tests/unit/test_error_categorization.py`
- **Purpose**: Unit tests for error categorization
- **Dependencies**: 
  - **Local**:
    - `core.error_handling (AIError, CommunicationError, ConfigurationError, DataError, FileOperationError, MHMError, SchedulerError, ValidationError)` (NEW)
  - **Third-party**:
    - `pytest`
- **Used by**: None (not imported by other modules)
...
#### `tests/unit/test_file_locking.py`
- **Purpose**: Unit tests for file locking
- **Dependencies**: 
  - **Local**:
    - `core.file_locking (file_lock, safe_json_read, safe_json_write)` (NEW)
  - **Standard Library**:
    - `json`
    - `os`
    - `pathlib (Path)`
...
#### `tests/unit/test_interaction_handlers_helpers.py`
- **Purpose**: Unit tests for interaction handlers helpers
- **Dependencies**: 
  - **Local**:
    - `communication.command_handlers.interaction_handlers (TaskManagementHandler)` (NEW)
  - **Standard Library**:
...
**Dependency Changes**:
- Added: communication.command_handlers.interaction_handlers
- Removed: unittest.mock
...
- **Dependencies**: 
  - **Local**:
    - `core.logger (BackupDirectoryRotatingFileHandler, ComponentLogger, ExcludeLoggerNamesFilter, HeartbeatWarningFilter, PytestContextLogFormatter, _is_testing_environment, apply_test_context_formatter_to_all_loggers, cleanup_old_archives, clear_log_file_locks, compress_old_logs, ensure_logs_directory, get_component_logger, setup_third_party_error_logging)` (NEW)
...
- **Dependencies**: 
  - **Local**:
    - `communication.communication_channels.base.message_formatter (EmailMessageFormatter, TextMessageFormatter, get_message_formatter)` (NEW)
    - `core.error_handling (DataError)` (NEW)
  - **Standard Library**:
    - `unittest.mock (MagicMock, patch)`
  - **Third-party**:
...
#### `tests/unit/test_prompt_manager.py`
- **Purpose**: Unit tests for prompt manager
- **Dependencies**: 
  - **Local**:
    - `ai.prompt_manager (PromptManager, PromptTemplate, ai.prompt_manager, get_prompt_manager)` (NEW)
  - **Standard Library**:
    - `os`
    - `pathlib (Path)`
    - `tempfile`
...
- **Dependencies**: 
  - **Local**:
    - `communication.communication_channels.base.rich_formatter (DiscordRichFormatter, EmailRichFormatter, get_rich_formatter)` (NEW)
  - **Standard Library**:
    - `builtins`
    - `datetime`
    - `unittest.mock (MagicMock, patch)`
...
#### `tests/unit/test_schema_validation_helpers.py`
- **Purpose**: Unit tests for schema validation helpers
- **Dependencies**: 
  - **Local**:
    - `core.schemas (validate_account_dict, validate_messages_file_dict, validate_preferences_dict, validate_schedules_dict)` (NEW)
  - **Standard Library**:
    - `copy`
  - **Third-party**:
    - `pytest`
...
#### `tests/unit/test_schemas_validation.py`
- **Purpose**: Unit tests for schemas validation
- **Dependencies**: 
  - **Local**:
    - `core.schemas (validate_account_dict, validate_messages_file_dict, validate_preferences_dict, validate_schedules_dict)` (NEW)
  - **Standard Library**:
...
- **Purpose**: Unit tests for scripts exclusion policy
- **Dependencies**: 
  - **Standard Library**:
    - `os`
    - `pathlib (Path)`
...
#### `tests/unit/test_ui_management.py`
- **Purpose**: Unit tests for ui management
- **Dependencies**: 
  - **Local**:
    - `core.ui_management (add_period_widget_to_layout, clear_period_widgets_from_layout, collect_period_data_from_widgets, load_period_widgets_for_category, period_name_for_display, period_name_for_storage)` (NEW)
  - **Standard Library**:
    - `unittest.mock (MagicMock, Mock, patch)`
  - **Third-party**:
    - `PySide6.QtWidgets (QVBoxLayout, QWidget)`
    - `pytest`
- **Used by**: None (not imported by other modules)

**Dependency Changes**:
- Added: core.ui_management
- Removed: PySide6.QtWidgets, unittest.mock
...
#### `tests/unit/test_user_data_handlers.py`
- **Purpose**: Unit tests for user data handlers
- **Dependencies**: 
  - **Local**:
    - `core.user_data_handlers (get_all_user_ids, get_user_data, register_data_loader, save_user_data_transaction, update_channel_preferences, update_user_account, update_user_context, update_user_preferences, update_user_schedules)` (NEW)
    - `tests.test_utilities (TestUserFactory)` (NEW)
  - **Standard Library**:
    - `unittest.mock (MagicMock, Mock, patch)`
  - **Third-party**:
...
**Dependency Changes**:
- Added: core.user_data_handlers, tests.test_utilities
- Removed: unittest.mock
...
- **Dependencies**: 
  - **Local**:
    - `core.user_data_handlers (get_user_data)` (NEW)
    - `core.user_data_manager (UserDataManager, backup_user_data, build_user_index, export_user_data, get_all_user_summaries, get_user_analytics_summary, get_user_data_summary, get_user_info_for_data_manager, get_user_summary, rebuild_user_index, update_message_references, update_user_index)` (NEW)
    - `core.user_management (get_user_id_by_identifier)` (NEW)
    - `tests.test_utilities (TestUserFactory)` (NEW)
  - **Standard Library**:
    - `datetime`
...
**Dependency Changes**:
- Added: core.user_data_handlers, core.user_data_manager, core.user_management, tests.test_utilities
- Removed: unittest.mock
...
#### `tests/unit/test_user_preferences.py`
- **Purpose**: Unit tests for user preferences
- **Dependencies**: 
  - **Local**:
    - `core.user_data_handlers (get_user_data)` (NEW)
...
**Dependency Changes**:
- Added: core.user_data_handlers, user.user_preferences
- Removed: unittest.mock
...
- **Dependencies**: 
  - **Local**:
    - `core` (NEW)
    - `core.user_data_validation (_shared__title_case, is_valid_discord_id, is_valid_email, is_valid_phone, validate_new_user_data, validate_personalization_data, validate_schedule_periods, validate_schedule_periods__validate_time_format, validate_user_update)` (NEW)
  - **Standard Library**:
    - `os`
    - `unittest.mock (patch)`
  - **Third-party**:
...
**Dependency Changes**:
- Added: core.error_handling, core.logger
- Removed: PySide6.QtCore, PySide6.QtWidgets, tests/unit/test_admin_panel.py
...
- Removed: PySide6.QtCore, PySide6.QtWidgets, tests/ui/test_category_management_dialog.py, tests/ui/test_dialog_behavior.py, ui/ui_app_qt.py
...
- Removed: PySide6.QtCore, PySide6.QtWidgets, tests/ui/test_dialog_behavior.py, tests/ui/test_ui_button_verification.py, tests/unit/test_checkin_management_dialog.py, ui/ui_app_qt.py
...
- Removed: PySide6.QtCore, PySide6.QtWidgets, tests/ui/test_dialog_behavior.py, tests/ui/test_task_management_dialog.py, ui/ui_app_qt.py
...
- Removed: PySide6.QtCore, PySide6.QtWidgets, core/ui_management.py, tests/ui/test_ui_widgets_coverage_expansion.py, tests/ui/test_widget_behavior.py, tests/unit/test_checkin_management_dialog.py, ui/dialogs/schedule_editor_dialog.py, ui/widgets/checkin_settings_widget.py, ui/widgets/task_settings_widget.py
...
- Removed: PySide6.QtWidgets, tests/ui/test_account_creation_ui.py, tests/ui/test_task_settings_widget.py, tests/ui/test_widget_behavior.py, tests/ui/test_widget_behavior_simple.py, ui/dialogs/account_creator_dialog.py, ui/dialogs/task_management_dialog.py
...
- Removed: core/schedule_management.py, core/scheduler.py, tests/integration/test_account_management.py, tests/unit/test_user_context.py, ui/ui_app_qt.py, user/context_manager.py
...
- Removed: tests/unit/test_user_preferences.py
