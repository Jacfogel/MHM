...
> **Last Generated**: 2025-11-17 02:16:02
...
- **Files Scanned**: 298
- **Total Imports Found**: 3450
- **Dependencies Documented**: 298 (100% coverage)
- **Standard Library Imports**: 1108 (32.1%)
- **Third-Party Imports**: 505 (14.6%)
- **Local Imports**: 1837 (53.2%)
...
- **Standard Library**: 1108 imports (32.1%)
- **Third-Party**: 505 imports (14.6%)
- **Local**: 1837 imports (53.2%)
...
- Removed: communication/communication_channels/discord/webhook_server.py, tests/behavior/test_webhook_handler_behavior.py
...
- Removed: communication/command_handlers/account_handler.py, core/file_operations.py, core/message_management.py, core/user_data_handlers.py, core/user_management.py, tests/behavior/test_backup_manager_behavior.py, tests/behavior/test_discord_bot_behavior.py, tests/behavior/test_user_management_coverage_expansion.py, tests/conftest.py, tests/integration/test_account_lifecycle.py, tests/integration/test_account_management.py, tests/integration/test_user_creation.py, tests/test_error_handling_improvements.py, tests/test_utilities.py, tests/ui/test_account_creation_ui.py, tests/ui/test_dialogs.py, tests/ui/test_widget_behavior.py, tests/unit/test_user_data_manager.py, ui/dialogs/account_creator_dialog.py, ui/ui_app_qt.py
...
**Dependency Changes**:
- Added: core.file_locking, core.file_operations, core.message_management, core.user_data_handlers, core.user_management, tasks.task_management, tests.conftest, tests.test_utilities
...
- **Dependencies**: 
  - **Local**:
    ...
    - `tests.test_utilities (TestUserFactory, retry_with_backoff)` (NEW)
  - **Standard Library**:
    - `datetime (datetime, timedelta)`
    - `json`
    - `os`
...
- **Dependencies**: 
  - **Local**:
    ...
    - `tests.test_utilities (retry_with_backoff)` (NEW)
  - **Standard Library**:
    - `json`
    - `os`
    - `pathlib (Path)`
...
**Dependency Changes**:
- Added: communication.core.welcome_manager, tests.test_utilities
- Removed: unittest.mock
...
- **Dependencies**: 
  - **Local**:
    ...
    - `core.user_data_handlers (get_all_user_ids, get_user_data, save_user_data, update_user_account, update_user_context, update_user_preferences)` (NEW)
    - `core.user_management (get_user_id_by_identifier)` (NEW)
    - `tests.test_utilities (TestUserDataFactory, TestUserFactory, retry_with_backoff)` (NEW)
  - **Standard Library**:
    - `json`
    - `os`
    - `time`
