...
> **Last Generated**: 2025-11-04 04:14:22
...
- **Files Scanned**: 236
- **Total Imports Found**: 2501
- **Dependencies Documented**: 236 (100% coverage)
- **Standard Library Imports**: 776 (31.0%)
- **Third-Party Imports**: 390 (15.6%)
- **Local Imports**: 1335 (53.4%)
...
- **Standard Library**: 776 imports (31.0%)
- **Third-Party**: 390 imports (15.6%)
- **Local**: 1335 imports (53.4%)
...
- **Dependencies**: 
  - **Third-party**:
    ...
    - `logger (BackupDirectoryRotatingFileHandler, ComponentLogger, ExcludeLoggerNamesFilter, TestContextFormatter, get_component_logger, get_logger, get_verbose_mode, set_console_log_level, set_verbose_mode, setup_logging, setup_third_party_error_logging, suppress_noisy_logging, toggle_verbose_logging)`
...
**Dependency Changes**:
- Added: ai.chatbot, communication.core.channel_orchestrator, communication.message_processing.conversation_flow_manager, core.config, core.logger, core.scheduler, core.service, core.user_data_handlers, core.user_data_manager, core.user_management, tests.test_utilities
