...
> **Last Generated**: 2026-09-24 15:38:13
...
- **Files Scanned**: 289
- **Total Imports Found**: 2562
- **Dependencies Documented**: 289 (100% coverage)
- **Standard Library Imports**: 743 (29.0%)
...
- **Standard Library**: 743 imports (29.0%)
- **Third-Party**: 223 imports (8.7%)
- **Local**: 1596 imports (62.3%)
...
- Removed: ai/__init__.py, ai/chat/action_planner.py, ai/context/service.py, ai/fallback/action_hints.py, ai/prompts/__init__.py, ai/prompts/command_interpreter.py, ai/prompts/manager.py, communication/message_processing/action_plan_executor.py, communication/message_processing/action_request_adapter.py
...
**Dependency Changes**:
- Added: ai.prompts.action_catalog, ai.prompts.command_registry, ai.prompts.flows, core.config, core.error_handling, core.logger
...
- **Dependencies**:
  - **Local**:
    ...
    - `notebook.notebook_data_manager (create_entry)` (NEW)
...
- Removed: checkins/checkin_analytics.py, checkins/checkin_data_manager.py, communication/message_processing/flows/checkin_flow.py, core/web_user_settings.py, ui/widgets/checkin_settings_widget.py
...
**Dependency Changes**:
- Added: core.error_handling
- Removed: core/headless_service.py, run_mhm.py
...
- **Dependencies**:
  - **Local**:
    ...
    - `communication.communication_channels.website.inbox (append_website_chat_exchange, list_website_chat_turns, list_website_messages)` (NEW)
    - `communication.message_processing.conversation_flow_manager (conversation_manager)` (NEW)
...
- Removed: communication/communication_channels/discord/events/message_reactions.py, communication/communication_channels/discord/ui/message_feedback_view.py, communication/core/channel_orchestrator.py, communication/delivery/message_dispatcher.py
...
**Dependency Changes**:
- Added: core.error_handling, core.launch_env, core.logger
