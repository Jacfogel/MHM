...
> **Last Generated**: 2025-11-15 20:36:04
...
- **Files Scanned**: 298
- **Total Imports Found**: 3500
- **Dependencies Documented**: 298 (100% coverage)
- **Standard Library Imports**: 1119 (32.0%)
- **Third-Party Imports**: 507 (14.5%)
- **Local Imports**: 1874 (53.5%)
...
- **Standard Library**: 1119 imports (32.0%)
- **Third-Party**: 507 imports (14.5%)
- **Local**: 1874 imports (53.5%)
...
- Removed: communication/communication_channels/discord/webhook_server.py
...
- Removed: communication/command_handlers/checkin_handler.py, communication/command_handlers/interaction_handlers.py, communication/command_handlers/task_handler.py, communication/core/channel_orchestrator.py, communication/message_processing/interaction_manager.py, tests/behavior/test_ai_chatbot_behavior.py, tests/behavior/test_checkin_expiry_semantics.py, tests/behavior/test_conversation_behavior.py, tests/behavior/test_conversation_flow_manager_behavior.py, tests/behavior/test_discord_bot_behavior.py, tests/behavior/test_discord_task_reminder_followup.py, tests/behavior/test_dynamic_checkin_behavior.py, tests/behavior/test_task_reminder_followup_behavior.py, tests/conftest.py
...
- Removed: communication/command_handlers/account_handler.py, communication/command_handlers/interaction_handlers.py, communication/command_handlers/schedule_handler.py, communication/communication_channels/discord/bot.py, communication/communication_channels/discord/event_handler.py, communication/communication_channels/discord/webhook_handler.py, communication/core/channel_orchestrator.py, communication/message_processing/interaction_manager.py, core/user_data_handlers.py, core/user_data_manager.py, tests/ai/ai_test_base.py, tests/ai/test_ai_advanced.py, tests/ai/test_ai_core.py, tests/ai/test_ai_functionality_manual.py, tests/ai/test_ai_integration.py, tests/ai/test_ai_performance.py, tests/ai/test_ai_quality.py, tests/behavior/test_account_management_real_behavior.py, tests/behavior/test_ai_chatbot_behavior.py, tests/behavior/test_backup_manager_behavior.py, tests/behavior/test_comprehensive_quantitative_analytics.py, tests/behavior/test_conversation_behavior.py, tests/behavior/test_discord_bot_behavior.py, tests/behavior/test_interaction_handlers_behavior.py, tests/behavior/test_quantitative_analytics_expansion.py, tests/behavior/test_scheduler_behavior.py, tests/behavior/test_scheduler_coverage_expansion.py, tests/behavior/test_service_behavior.py, tests/behavior/test_task_suggestion_relevance.py, tests/behavior/test_user_context_behavior.py, tests/behavior/test_user_management_coverage_expansion.py, tests/behavior/test_utilities_demo.py, tests/conftest.py, tests/integration/test_account_lifecycle.py, tests/integration/test_account_management.py, tests/integration/test_user_creation.py, tests/test_utilities.py, tests/ui/test_account_creation_ui.py, tests/ui/test_dialogs.py, tests/ui/test_message_editor_dialog.py, tests/ui/test_user_analytics_dialog.py, tests/ui/test_widget_behavior.py, tests/unit/test_checkin_management_dialog.py, tests/unit/test_user_context.py, tests/unit/test_user_data_manager.py, tests/unit/test_user_management.py, ui/dialogs/account_creator_dialog.py, ui/dialogs/user_profile_dialog.py, ui/widgets/channel_selection_widget.py, ui/widgets/dynamic_list_container.py
...
**Dependency Changes**:
- Added: communication.command_handlers.account_handler, communication.command_handlers.shared_types, core.user_data_handlers, core.user_management, tests.test_utilities
