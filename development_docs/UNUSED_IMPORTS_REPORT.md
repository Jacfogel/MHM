...
### `development_tools/error_handling/error_handling_coverage.py`
...
### `development_tools/functions/audit_package_exports.py`
...
### `development_tools/imports/audit_module_dependencies.py`
...
### `development_tools/imports/unused_imports_checker.py`
...
### `development_tools/docs/documentation_sync_checker.py`

**Count**: 1 unused import(s)

- **Line 38**: Unused DEFAULT_DOCS imported from shared.constants
  - Symbol: `unused-import`

### `development_tools/functions/audit_function_registry.py`

**Count**: 2 unused import(s)

- **Line 23**: Unused summary_block imported from shared.common
  - Symbol: `unused-import`
- **Line 23**: Unused write_text imported from shared.common
  - Symbol: `unused-import`
...
- **Line 22**: Unused categorize_functions imported from functions.function_discovery
  - Symbol: `unused-import`
