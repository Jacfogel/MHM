...
> **Last Generated**: 2026-04-20 03:41:33
...
- **Total Statements**: 55,657
- **Covered Statements**: 39,252
- **Uncovered Statements**: 16,405
...
### **Coverage by Domain**
- **ai**: 78.6% (1382/1758 lines, 376 missing)
- **communication**: 76.5% (7258/9492 lines, 2234 missing)
- **core**: 78.5% (8353/10643 lines, 2290 missing)
- **development_tools**: 63.6% (16344/25685 lines, 9341 missing)
- **notebook**: 95.6% (580/607 lines, 27 missing)
- **tasks**: 89.0% (403/453 lines, 50 missing)
- **ui**: 69.1% (4648/6723 lines, 2075 missing)
- **user**: 95.9% (284/296 lines, 12 missing)

### **Coverage Summary by Category**
- **Excellent (92% avg)**: 140 modules
- **Good (70% avg)**: 59 modules
- **Moderate (53% avg)**: 22 modules
- **Needs_Work (25% avg)**: 1 modules
- **Critical (7% avg)**: 4 modules
...
- **X development_tools\shared\service\commands.py**: 41% (544/1333 lines)
- **X ui\widgets\checkin_settings_widget.py**: 45% (295/656 lines)
- **X development_tools\shared\service\audit_orchestration.py**: 46% (628/1365 lines)
...
- **X development_tools\shared\service\tool_wrappers.py**: 53% (603/1129 lines)
...
- **X development_tools\shared\service\data_loading.py**: 58% (443/769 lines)
- **X development_tools\docs\analyze_ascii_compliance.py**: 59% (64/108 lines)
- **X development_tools\shared\service\report_generation.py**: 59% (2549/4357 lines)
...
- **! ai\chatbot.py**: 66% (568/865 lines)
...
- *** development_tools\config\config.py**: 80% (476/597 lines)
...
- **Total discovered test nodes**: 5048
- **Marker usage counts**:
  - `unit`: 2678
  - `behavior`: 1807
  - `communication`: 1047
