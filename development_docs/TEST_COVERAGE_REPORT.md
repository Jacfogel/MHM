...
> **Last Generated**: 2026-03-14 21:05:16
...
- **Total Statements**: 30,184
- **Covered Statements**: 22,880
- **Uncovered Statements**: 7,304
...
- **core**: 76.7% (8405/10957 lines, 2552 missing)
- **notebook**: 95.6% (580/607 lines, 27 missing)
- **tasks**: 89.0% (403/453 lines, 50 missing)
- **ui**: 69.6% (4641/6668 lines, 2027 missing)
...
- **X ui\ui_app_qt.py**: 53% (752/1408 lines)
...
- **! core\user_data_manager.py**: 71% (618/869 lines)
...
- **Total discovered test nodes**: 4818
- **Marker usage counts**:
  - `unit`: 2426
  - `behavior`: 1806
  - `communication`: 1045
