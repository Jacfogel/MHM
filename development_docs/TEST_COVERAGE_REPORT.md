...
> **Last Generated**: 2026-05-13 00:17:51
...
- **Total Statements**: 58,131
- **Covered Statements**: 41,906
- **Uncovered Statements**: 16,225
...
- **core**: 79.9% (8855/11077 lines, 2222 missing)
- **development_tools**: 65.0% (17277/26592 lines, 9315 missing)
- **notebook**: 93.9% (806/858 lines, 52 missing)
- **tasks**: 87.2% (936/1073 lines, 137 missing)
- **ui**: 70.5% (4817/6836 lines, 2019 missing)
- **user**: 96.1% (369/384 lines, 15 missing)

### **Coverage Summary by Category**
- **Excellent (92% avg)**: 169 modules
...
- **! core\scheduler.py**: 73% (471/647 lines)
...
- *** core\service_utilities.py**: 94% (126/134 lines)
