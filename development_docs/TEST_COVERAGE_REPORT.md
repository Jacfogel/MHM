...
> **Last Generated**: 2026-02-14 18:49:10
...
- **Total Statements**: 29,953
- **Covered Statements**: 21,541
- **Uncovered Statements**: 8,412
...
- **Moderate (50% avg)**: 5 modules
- **Needs_Work (23% avg)**: 1 modules

### **Detailed Module Coverage**
- **X user\__init__.py**: 23% (3/13 lines)
- **X communication\communication_channels\discord\bot.py**: 45% (573/1276 lines)
- **X ui\widgets\checkin_settings_widget.py**: 45% (287/643 lines)
- **X ui\ui_app_qt.py**: 51% (724/1412 lines)
- **X communication\command_handlers\notebook_handler.py**: 52% (272/521 lines)
- **X communication\message_processing\conversation_flow_manager.py**: 59% (601/1012 lines)
- **! communication\core\channel_orchestrator.py**: 61% (634/1039 lines)
- **! core\checkin_analytics.py**: 61% (429/698 lines)
- **! core\service.py**: 61% (431/710 lines)
- **! communication\command_handlers\analytics_handler.py**: 62% (378/605 lines)
- **! communication\message_processing\interaction_manager.py**: 63% (371/587 lines)
- **! core\auto_cleanup.py**: 63% (271/428 lines)
- **! notebook\notebook_data_manager.py**: 63% (219/347 lines)
- **! ai\chatbot.py**: 64% (524/824 lines)
- **! communication\command_handlers\interaction_handlers.py**: 65% (169/260 lines)
- **! core\logger.py**: 66% (496/752 lines)
- **! core\scheduler.py**: 66% (670/1016 lines)
...
- *** communication\command_handlers\account_handler.py**: 91% (165/182 lines)
