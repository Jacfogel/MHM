...
> **Last Generated**: 2026-01-24 05:22:05
...
- **Total Statements**: 28,630
- **Covered Statements**: 20,636
- **Uncovered Statements**: 7,994
- **Goal**: Expand to **80%+ coverage** for comprehensive reliability

### **Coverage Summary by Category**
- **Excellent (92% avg)**: 61 modules
...
- **X ui\ui_app_qt.py**: 53% (738/1403 lines)
- **! communication\core\channel_orchestrator.py**: 61% (631/1038 lines)
- **! core\service.py**: 62% (432/699 lines)
- **! ui\dialogs\schedule_editor_dialog.py**: 63% (151/238 lines)
- **! ai\chatbot.py**: 64% (534/835 lines)
- **! communication\message_processing\conversation_flow_manager.py**: 64% (624/975 lines)
- **! communication\message_processing\interaction_manager.py**: 64% (360/565 lines)
- **! core\scheduler.py**: 64% (650/1013 lines)
...
- **! core\tags.py**: 70% (149/214 lines)
- **! ui\widgets\user_profile_settings_widget.py**: 70% (201/286 lines)
- **! communication\command_handlers\analytics_handler.py**: 72% (332/459 lines)
...
- **! core\auto_cleanup.py**: 73% (311/427 lines)
- **! core\checkin_analytics.py**: 73% (354/484 lines)
- **! core\message_management.py**: 73% (308/420 lines)
- **! core\user_data_handlers.py**: 73% (1053/1446 lines)
...
- **! core\config.py**: 77% (325/423 lines)
