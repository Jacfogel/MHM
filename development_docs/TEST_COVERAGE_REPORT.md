...
> **Last Generated**: 2026-01-18 01:55:43
...
- **Total Statements**: 28,451
- **Covered Statements**: 20,499
- **Uncovered Statements**: 7,952
...
- **Needs_Work (32% avg)**: 1 modules

### **Detailed Module Coverage**
- **X core\time_utilities.py**: 32% (26/81 lines)
...
- **X ui\ui_app_qt.py**: 53% (738/1388 lines)
- **! communication\core\channel_orchestrator.py**: 61% (632/1038 lines)
- **! core\service.py**: 62% (430/696 lines)
- **! ai\chatbot.py**: 64% (532/837 lines)
- **! communication\command_handlers\interaction_handlers.py**: 64% (166/258 lines)
- **! communication\message_processing\conversation_flow_manager.py**: 64% (635/991 lines)
- **! ui\dialogs\schedule_editor_dialog.py**: 64% (152/239 lines)
- **! core\file_locking.py**: 65% (68/105 lines)
- **! core\scheduler.py**: 65% (642/995 lines)
- **! core\tags.py**: 65% (139/214 lines)
- **! communication\message_processing\interaction_manager.py**: 66% (373/569 lines)
- **! core\logger.py**: 66% (467/711 lines)
...
- **! core\user_data_manager.py**: 71% (618/868 lines)
...
- *** tasks\task_management.py**: 82% (438/537 lines)
...
- *** core\service_utilities.py**: 87% (136/157 lines)
...
- *** communication\command_handlers\base_handler.py**: 95% (54/57 lines)
