...
> **Last Generated**: 2026-03-25 17:45:48
...
- **Covered Statements**: 22,818
- **Uncovered Statements**: 7,138
...
### **Coverage by Domain**
- **ai**: 79.0% (1389/1758 lines, 369 missing)
- **communication**: 76.3% (7240/9485 lines, 2245 missing)
- **core**: 77.5% (8275/10673 lines, 2398 missing)
...
- **! ai\chatbot.py**: 66% (575/865 lines)
- **! core\logger.py**: 66% (490/743 lines)
...
- **Total discovered test nodes**: 4834
- **Marker usage counts**:
  - `unit`: 2475
  - `behavior`: 1806
  - `communication`: 1045
