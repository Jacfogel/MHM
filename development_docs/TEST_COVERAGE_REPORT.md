...
> **Last Generated**: 2026-03-03 03:18:18
...
- **Total Statements**: 30,225
- **Covered Statements**: 22,748
- **Uncovered Statements**: 7,477
...
- **X ui\ui_app_qt.py**: 51% (710/1405 lines)
- **X core\backup_manager.py**: 54% (409/760 lines)
- **X ui\widgets\checkin_settings_widget.py**: 54% (346/640 lines)
- **! core\checkin_analytics.py**: 62% (444/719 lines)
- **! communication\core\channel_orchestrator.py**: 63% (659/1038 lines)
- **! communication\message_processing\conversation_flow_manager.py**: 63% (631/1008 lines)
- **! ai\chatbot.py**: 65% (537/822 lines)
- **! core\logger.py**: 65% (488/755 lines)
- **! core\scheduler.py**: 65% (670/1033 lines)
...
- **! core\message_management.py**: 73% (307/418 lines)
...
- **! core\error_handling.py**: 77% (305/395 lines)
...
- **! ui\dialogs\user_profile_dialog.py**: 79% (208/262 lines)
- *** communication\core\channel_monitor.py**: 80% (112/140 lines)
- *** ui\dialogs\checkin_management_dialog.py**: 80% (127/159 lines)
...
- *** tasks\task_data_manager.py**: 89% (313/353 lines)
...
- *** ui\generate_ui_files.py**: 92% (60/65 lines)
- *** user\context_manager.py**: 92% (141/153 lines)
- *** core\auto_cleanup.py**: 93% (426/456 lines)
- *** core\user_data_validation.py**: 93% (287/310 lines)
- *** ui\dialogs\channel_management_dialog.py**: 93% (105/113 lines)
...
- *** core\file_auditor.py**: 100% (94/94 lines)
