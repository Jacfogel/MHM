...
> **Last Generated**: 2026-03-03 19:53:18
...
- **Total Statements**: 30,127
- **Covered Statements**: 22,745
- **Uncovered Statements**: 7,382
...
- **X communication\communication_channels\discord\bot.py**: 51% (644/1269 lines)
- **X ui\ui_app_qt.py**: 52% (726/1401 lines)
- **X core\backup_manager.py**: 54% (409/760 lines)
- **X ui\widgets\checkin_settings_widget.py**: 54% (344/636 lines)
- **! core\checkin_analytics.py**: 62% (443/718 lines)
- **! communication\message_processing\conversation_flow_manager.py**: 63% (631/1006 lines)
- **! communication\core\channel_orchestrator.py**: 64% (660/1035 lines)
- **! core\scheduler.py**: 65% (670/1028 lines)
- **! ui\dialogs\schedule_editor_dialog.py**: 65% (142/217 lines)
- **! ai\chatbot.py**: 66% (542/822 lines)
- **! core\logger.py**: 66% (485/730 lines)
...
- **! core\service.py**: 76% (534/706 lines)
- **! core\user_item_storage.py**: 76% (42/55 lines)
- **! ui\dialogs\task_edit_dialog.py**: 76% (300/394 lines)
- **! core\error_handling.py**: 77% (303/391 lines)
- **! core\file_operations.py**: 78% (307/395 lines)
...
- *** ui\generate_ui_files.py**: 98% (63/64 lines)
