...
> **Last Generated**: 2026-02-14 11:47:47
> **Source**: `python development_tools/tests/generate_test_coverage.py --update-plan` - Coverage Metrics Regenerator

## Current Status

### **Overall Coverage: 71.7%**
- **Total Statements**: 29,641
- **Covered Statements**: 21,242
- **Uncovered Statements**: 8,399
...
- **X ui\ui_app_qt.py**: 50% (704/1408 lines)
...
- **! core\logger.py**: 65% (480/743 lines)
...
- **! core\backup_manager.py**: 76% (335/438 lines)
