...
> **Last Generated**: 2026-01-13 21:02:56
...
- **Total Statements**: 28,366
- **Covered Statements**: 20,397
- **Uncovered Statements**: 7,969
...
- **X communication\communication_channels\discord\bot.py**: 45% (561/1241 lines)
- **X communication\command_handlers\notebook_handler.py**: 52% (270/521 lines)
- **X ui\ui_app_qt.py**: 52% (714/1386 lines)
...
- **! ai\chatbot.py**: 64% (535/839 lines)
- **! communication\message_processing\conversation_flow_manager.py**: 64% (636/991 lines)
- **! communication\message_processing\interaction_manager.py**: 64% (362/567 lines)
- **! communication\command_handlers\interaction_handlers.py**: 65% (167/258 lines)
- **! core\logger.py**: 65% (464/711 lines)
- **! core\scheduler.py**: 65% (621/951 lines)
...
- **! core\user_data_manager.py**: 71% (614/865 lines)
...
- **! core\auto_cleanup.py**: 75% (298/396 lines)
