...
> **Last Generated**: 2026-03-30 18:08:59
...
- **Covered Statements**: 22,824
- **Uncovered Statements**: 7,132
...
- **core**: 77.7% (8288/10673 lines, 2385 missing)
- **notebook**: 95.6% (580/607 lines, 27 missing)
- **tasks**: 89.0% (403/453 lines, 50 missing)
- **ui**: 69.6% (4651/6684 lines, 2033 missing)
...
- **! core\logger.py**: 68% (505/743 lines)
...
- **Total discovered test nodes**: 4901
- **Marker usage counts**:
  - `unit`: 2540
  - `behavior`: 1806
  - `communication`: 1045
