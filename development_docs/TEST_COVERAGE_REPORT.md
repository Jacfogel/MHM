...
> **Last Generated**: 2026-03-05 00:22:47
...
- **Total Statements**: 30,262
- **Covered Statements**: 23,128
- **Uncovered Statements**: 7,134
...
- **communication**: 76.3% (7289/9559 lines, 2270 missing)
- **core**: 76.7% (8371/10920 lines, 2549 missing)
- **notebook**: 95.6% (580/607 lines, 27 missing)
- **tasks**: 89.0% (403/453 lines, 50 missing)
- **ui**: 72.1% (4807/6669 lines, 1862 missing)
- **user**: 95.9% (284/296 lines, 12 missing)

### **Coverage Summary by Category**
- **Excellent (93% avg)**: 86 modules
- **Good (71% avg)**: 25 modules
- **Moderate (53% avg)**: 3 modules

### **Detailed Module Coverage**
- **X communication\communication_channels\discord\bot.py**: 51% (650/1274 lines)
- **X ui\ui_app_qt.py**: 54% (757/1410 lines)
...
- **! core\user_data_handlers.py**: 74% (996/1337 lines)
...
- **! core\service.py**: 76% (549/721 lines)
...
- *** communication\command_handlers\account_handler.py**: 87% (161/186 lines)
...
- **Total discovered test nodes**: 4777
- **Marker usage counts**:
  - `unit`: 2407
  - `behavior`: 1806
  - `communication`: 1045
