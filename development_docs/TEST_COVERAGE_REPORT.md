...
> **Last Generated**: 2026-04-29 19:48:47
...
- **Total Statements**: 56,556
- **Covered Statements**: 40,586
- **Uncovered Statements**: 15,970
...
- **communication**: 76.4% (7283/9533 lines, 2250 missing)
- **core**: 78.6% (8743/11117 lines, 2374 missing)
- **development_tools**: 66.0% (17038/25816 lines, 8778 missing)
- **notebook**: 95.2% (619/650 lines, 31 missing)
- **tasks**: 88.4% (577/653 lines, 76 missing)
...
- **X development_tools\shared\service\report_generation.py**: 56% (2485/4415 lines)
...
- **! core\checkin_analytics.py**: 63% (460/732 lines)
...
- **! communication\message_processing\conversation_flow_manager.py**: 65% (688/1060 lines)
...
- **! core\message_management.py**: 78% (358/460 lines)
...
- *** core\schemas.py**: 86% (264/308 lines)
...
- *** tasks\task_data_handlers.py**: 90% (167/185 lines)
...
- **Total discovered test nodes**: 5191
- **Marker usage counts**:
  - `unit`: 2821
  - `behavior`: 1807
  - `communication`: 1365
