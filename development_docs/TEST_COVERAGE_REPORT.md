...
> **Last Generated**: 2026-03-03 02:55:10
...
- **Total Statements**: 30,427
- **Covered Statements**: 22,963
- **Uncovered Statements**: 7,464
...
- **X ui\ui_app_qt.py**: 51% (718/1407 lines)
- **X core\backup_manager.py**: 54% (411/762 lines)
- **X ui\widgets\checkin_settings_widget.py**: 54% (348/642 lines)
...
- **! communication\core\channel_orchestrator.py**: 64% (662/1041 lines)
- **! ai\chatbot.py**: 65% (539/824 lines)
- **! core\scheduler.py**: 65% (669/1033 lines)
- **! core\logger.py**: 66% (503/760 lines)
...
- **! core\user_data_manager.py**: 70% (611/869 lines)
...
- **! core\message_management.py**: 74% (308/419 lines)
...
- **! core\user_item_storage.py**: 77% (43/56 lines)
- **! core\error_handling.py**: 78% (323/412 lines)
- **! core\file_operations.py**: 78% (308/396 lines)
...
- *** ui\dialogs\checkin_management_dialog.py**: 80% (129/161 lines)
...
- *** core\time_utilities.py**: 82% (89/108 lines)
...
- *** core\headless_service.py**: 84% (181/215 lines)
...
- *** tasks\task_data_manager.py**: 89% (314/354 lines)
...
- *** ui\generate_ui_files.py**: 92% (61/66 lines)
- *** user\context_manager.py**: 92% (143/155 lines)
- *** core\auto_cleanup.py**: 93% (427/457 lines)
...
- *** communication\communication_channels\discord\webhook_handler.py**: 95% (142/150 lines)
...
- *** core\file_auditor.py**: 100% (96/96 lines)
- *** core\schedule_utilities.py**: 100% (64/64 lines)
- *** core\tags.py**: 100% (215/215 lines)
