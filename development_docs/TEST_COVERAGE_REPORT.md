...
> **Last Generated**: 2026-01-17 06:08:29
...
- **Total Statements**: 28,645
- **Covered Statements**: 20,733
- **Uncovered Statements**: 7,912
- **Goal**: Expand to **80%+ coverage** for comprehensive reliability

### **Coverage Summary by Category**
- **Excellent (93% avg)**: 62 modules
...
- **X ui\ui_app_qt.py**: 53% (739/1390 lines)
- **! communication\core\channel_orchestrator.py**: 61% (634/1041 lines)
- **! core\service.py**: 62% (430/697 lines)
- **! ai\chatbot.py**: 64% (538/838 lines)
- **! communication\message_processing\conversation_flow_manager.py**: 64% (636/992 lines)
- **! core\scheduler.py**: 64% (631/981 lines)
- **! ui\dialogs\schedule_editor_dialog.py**: 64% (153/240 lines)
- **! communication\command_handlers\interaction_handlers.py**: 65% (168/260 lines)
- **! core\file_locking.py**: 65% (69/106 lines)
- **! core\logger.py**: 65% (465/716 lines)
- **! core\tags.py**: 65% (140/215 lines)
- **! communication\message_processing\interaction_manager.py**: 66% (376/572 lines)
...
- **! communication\message_processing\command_parser.py**: 68% (391/573 lines)
- **! ui\dialogs\account_creator_dialog.py**: 68% (444/649 lines)
- **! core\user_data_handlers.py**: 70% (1008/1448 lines)
- **! ui\widgets\user_profile_settings_widget.py**: 70% (202/287 lines)
- **! core\user_data_manager.py**: 71% (617/870 lines)
...
- **! ui\generate_ui_files.py**: 73% (49/67 lines)
- **! core\auto_cleanup.py**: 74% (311/423 lines)
...
- *** tasks\task_management.py**: 82% (442/537 lines)
...
- *** core\service_utilities.py**: 87% (143/164 lines)
- *** ui\widgets\period_row_widget.py**: 87% (213/245 lines)
- *** core\response_tracking.py**: 88% (105/119 lines)
...
- *** core\message_management.py**: 93% (387/418 lines)
