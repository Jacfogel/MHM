...
> **Last Generated**: 2026-03-24 00:22:30
...
- **Covered Statements**: 8,264
- **Uncovered Statements**: 2,409
...
### **Coverage by Domain**
- **core**: 77.4% (8264/10673 lines, 2409 missing)
...
- **Total discovered test nodes**: 4793
- **Marker usage counts**:
  - `unit`: 2434
  - `behavior`: 1806
  - `communication`: 1045
