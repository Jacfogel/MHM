...
> **Last Generated**: 2026-04-16 05:20:37
...
- **Total Statements**: 55,017
- **Covered Statements**: 38,474
- **Uncovered Statements**: 16,543
...
- **core**: 78.4% (8345/10643 lines, 2298 missing)
- **development_tools**: 62.1% (15553/25045 lines, 9492 missing)
...
- **X development_tools\shared\service\commands.py**: 39% (515/1333 lines)
- **X ui\widgets\checkin_settings_widget.py**: 45% (295/656 lines)
- **X development_tools\shared\service\audit_orchestration.py**: 46% (621/1349 lines)
...
- **X development_tools\shared\service\report_generation.py**: 54% (2354/4337 lines)
- **X development_tools\static_checks\analyze_ruff.py**: 54% (64/119 lines)
- **X development_tools\shared\service\data_loading.py**: 55% (423/769 lines)
...
- **! core\scheduler.py**: 64% (661/1025 lines)
...
- **! core\message_management.py**: 78% (313/403 lines)
...
- *** development_tools\config\config.py**: 80% (476/596 lines)
...
- *** development_tools\docs\example_marker_validation.py**: 90% (62/69 lines)
...
- **Total discovered test nodes**: 5006
- **Marker usage counts**:
  - `unit`: 2636
  - `behavior`: 1807
  - `communication`: 1047
