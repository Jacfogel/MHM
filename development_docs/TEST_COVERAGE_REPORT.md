...
> **Last Generated**: 2026-04-23 00:09:58
...
- **Covered Statements**: 39,622
- **Uncovered Statements**: 16,112
...
- **core**: 78.3% (8333/10643 lines, 2310 missing)
- **development_tools**: 64.9% (16731/25762 lines, 9031 missing)
- **notebook**: 95.6% (580/607 lines, 27 missing)
- **tasks**: 89.0% (403/453 lines, 50 missing)
- **ui**: 69.2% (4650/6723 lines, 2073 missing)
...
- **X development_tools\shared\service\commands.py**: 41% (552/1348 lines)
...
- **X development_tools\shared\service\report_generation.py**: 56% (2486/4408 lines)
...
- **! core\logger.py**: 68% (502/743 lines)
...
- **Total discovered test nodes**: 5133
- **Marker usage counts**:
  - `unit`: 2763
  - `behavior`: 1807
  - `communication`: 1365
