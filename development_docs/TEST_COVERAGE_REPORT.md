...
> **Last Generated**: 2026-05-11 22:56:11
...
- **Total Statements**: 58,112
- **Covered Statements**: 41,913
- **Uncovered Statements**: 16,199
...
### **Coverage by Domain**
- **ai**: 78.8% (1377/1748 lines, 371 missing)
- **communication**: 78.2% (7480/9564 lines, 2084 missing)
- **core**: 80.1% (8935/11161 lines, 2226 missing)
- **development_tools**: 65.0% (17289/26592 lines, 9303 missing)
- **notebook**: 93.9% (806/858 lines, 52 missing)
- **tasks**: 87.2% (936/1073 lines, 137 missing)
- **ui**: 70.1% (4721/6732 lines, 2011 missing)
...
- **X development_tools\shared\service\report_generation.py**: 44% (1992/4479 lines)
...
- **! ai\chatbot.py**: 66% (571/863 lines)
- **! communication\message_processing\conversation_flow_manager.py**: 66% (745/1124 lines)
...
- *** core\response_tracking.py**: 87% (160/183 lines)
