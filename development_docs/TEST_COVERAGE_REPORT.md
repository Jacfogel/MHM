...
> **Last Generated**: 2026-03-28 20:10:48
...
- **Covered Statements**: 22,804
- **Uncovered Statements**: 7,152
...
- **core**: 77.6% (8281/10673 lines, 2392 missing)
...
- **Total discovered test nodes**: 4888
- **Marker usage counts**:
  - `unit`: 2528
  - `behavior`: 1806
  - `communication`: 1045
