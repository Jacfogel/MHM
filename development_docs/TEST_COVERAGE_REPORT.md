...
> **Last Generated**: 2026-02-16 01:56:12
...
- **Covered Statements**: 21,555
- **Uncovered Statements**: 8,398
...
- **X ui\ui_app_qt.py**: 51% (727/1412 lines)
...
- **! core\logger.py**: 65% (491/752 lines)
- **! core\scheduler.py**: 65% (665/1016 lines)
...
- *** core\schedule_management.py**: 82% (249/305 lines)
- *** core\time_utilities.py**: 82% (88/107 lines)
- *** ui\dialogs\admin_panel.py**: 82% (42/51 lines)
- *** communication\message_processing\command_parser.py**: 83% (548/664 lines)
...
- *** communication\command_handlers\account_handler.py**: 91% (166/182 lines)
