...
> **Last Generated**: 2026-03-02 01:00:52
...
- **Total Statements**: 30,449
- **Covered Statements**: 22,171
- **Uncovered Statements**: 8,278
...
- **Excellent (92% avg)**: 67 modules
- **Good (71% avg)**: 38 modules
- **Moderate (53% avg)**: 4 modules
- **Needs_Work (23% avg)**: 1 modules

### **Detailed Module Coverage**
- **X user\__init__.py**: 23% (3/13 lines)
- **X communication\communication_channels\discord\bot.py**: 51% (645/1275 lines)
- **X ui\ui_app_qt.py**: 52% (727/1407 lines)
- **X core\backup_manager.py**: 54% (411/762 lines)
- **X ui\widgets\checkin_settings_widget.py**: 54% (349/643 lines)
- **! communication\command_handlers\analytics_handler.py**: 61% (378/620 lines)
- **! core\checkin_analytics.py**: 62% (445/720 lines)
- **! communication\message_processing\conversation_flow_manager.py**: 63% (632/1009 lines)
- **! notebook\notebook_data_manager.py**: 63% (219/347 lines)
- **! communication\core\channel_orchestrator.py**: 64% (667/1047 lines)
- **! core\scheduler.py**: 64% (671/1041 lines)
- **! ai\chatbot.py**: 65% (539/824 lines)
- **! communication\command_handlers\interaction_handlers.py**: 65% (169/260 lines)
- **! core\auto_cleanup.py**: 66% (302/457 lines)
- **! core\logger.py**: 66% (505/762 lines)
- **! ui\dialogs\schedule_editor_dialog.py**: 66% (144/219 lines)
- **! ui\widgets\dynamic_list_container.py**: 66% (136/205 lines)
- **! communication\message_processing\interaction_manager.py**: 67% (400/594 lines)
- **! ui\widgets\channel_selection_widget.py**: 67% (56/83 lines)
- **! communication\command_handlers\notebook_handler.py**: 68% (356/521 lines)
- **! ui\dialogs\account_creator_dialog.py**: 68% (445/650 lines)
- **! communication\communication_channels\email\bot.py**: 69% (167/243 lines)
- **! core\file_locking.py**: 70% (74/106 lines)
- **! core\user_data_manager.py**: 70% (612/869 lines)
...
- **! core\user_data_handlers.py**: 74% (997/1345 lines)
- **! ui\dialogs\task_completion_dialog.py**: 74% (87/117 lines)
- **! communication\command_handlers\profile_handler.py**: 75% (221/293 lines)
- **! core\service.py**: 75% (534/710 lines)
- **! ui\widgets\dynamic_list_field.py**: 75% (92/122 lines)
- **! core\config.py**: 76% (312/408 lines)
- **! core\tags.py**: 76% (164/215 lines)
- **! ui\dialogs\task_edit_dialog.py**: 76% (302/396 lines)
- **! core\file_auditor.py**: 77% (71/92 lines)
- **! core\file_operations.py**: 78% (308/397 lines)
- **! ai\conversation_history.py**: 79% (171/216 lines)
- **! communication\command_handlers\task_handler.py**: 79% (492/622 lines)
...
- *** core\schedule_management.py**: 81% (248/305 lines)
...
- *** communication\message_processing\command_parser.py**: 82% (546/664 lines)
...
- *** ui\widgets\period_row_widget.py**: 87% (214/246 lines)
...
- *** notebook\schemas.py**: 89% (74/83 lines)
...
- *** core\service_utilities.py**: 91% (144/159 lines)
...
- *** ui\dialogs\channel_management_dialog.py**: 93% (107/115 lines)
