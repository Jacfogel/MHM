...
**Last updated**: 2026-03-29 (constants/exclusions alignment: `derived_prefix_excludes`, `test_markers`, `path_drift.ignored_path_patterns`, `get_path_drift_config()`, portable `standard_exclusions` defaults)
