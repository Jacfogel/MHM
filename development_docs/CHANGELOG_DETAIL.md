...
- **Feature**: Added canonical v2 user-data models and migration helpers in [`core/user_data_v2.py`](../core/user_data_v2.py), covering tasks, notebook entries, journal entries, check-ins, message templates, and delivery records. Added an intentionally untracked `scripts/migrate_user_data_v2.py` utility for dry-run/write migration with backup creation and migration report output.
