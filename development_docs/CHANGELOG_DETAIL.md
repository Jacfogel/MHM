...
- **Docs**: [`SYSTEM_AI_GUIDE.md`](../ai/SYSTEM_AI_GUIDE.md); removed completed shipped items from [[TODO.md](../TODO.md)](../TODO.md).
...
- **Pyright Section 7.6**: [development_tools/config/pyrightconfig.json](../development_tools/config/pyrightconfig.json) - `venvPath` `../..`, `venv` `.venv` so `pyright --project development_tools/config/pyrightconfig.json` resolves the repo venv from the config file location.
