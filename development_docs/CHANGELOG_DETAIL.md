...
- **Impact**: Adding a simple notebook intent is a map row; list-create and profile sections are independently testable. User-visible parsing, profile text, custom-question dialog, backup retention, reminder times, and command routing are unchanged.
