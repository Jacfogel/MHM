...
- **Investigation**: Refreshed dev-tools test-volume notes in [`AI_DEV_TOOLS_IMPROVEMENT_PLAN_V5.md`](../development_tools/AI_DEV_TOOLS_IMPROVEMENT_PLAN_V5.md): current `tests/development_tools/` collection is 1479 selected tests, up from the latest dev-tools coverage log's 1405 passed in 366.93s on 2026-05-02. The existing profiling path remains `python run_tests.py --mode development_tools --durations-all`.
...
- **Planning doc**: [`AI_DEV_TOOLS_IMPROVEMENT_PLAN_V5.md`](../development_tools/AI_DEV_TOOLS_IMPROVEMENT_PLAN_V5.md) Section 7.x (remove `core.logger`) marked **Done** with follow-up notes for implicit MHM assumptions.
...
- **Feature**: Continued [AI_DEV_TOOLS_IMPROVEMENT_PLAN_V5.md](../development_tools/AI_DEV_TOOLS_IMPROVEMENT_PLAN_V5.md) execution with a focused low-coverage dev-tools test slice. Added `_run_doc_subcheck_with_cache` branch tests in [`tests/development_tools/test_commands_coverage_helpers.py`](../tests/development_tools/test_commands_coverage_helpers.py) (standard-data, stdout-parse, fallback parse paths), helper classification coverage in [`tests/development_tools/test_fix_version_sync_todo_sync.py`](../tests/development_tools/test_fix_version_sync_todo_sync.py) (`_find_todo_scan_start`, `_classify_completed_todo_line` markers), and Tier-3 scope finalization coverage in [`tests/development_tools/test_audit_orchestration_helpers.py`](../tests/development_tools/test_audit_orchestration_helpers.py) (`cache_only_precheck` branch). Verified with targeted pytest runs for newly added cases.
...
- **Feature**: Updated [AI_DEV_TOOLS_IMPROVEMENT_PLAN_V5.md](../development_tools/AI_DEV_TOOLS_IMPROVEMENT_PLAN_V5.md) snapshot and priority map to record this execution slice and schedule next medium backlog order as: **Section 5.5 - 5.2 documentation-overlap tuning**, then **Section 5.3 - 3.0 example-marker revalidation**, then **Section 5.7 - 7.6 portability parity**.
...
- **Planning / operator docs**: [TEST_PLAN.md](TEST_PLAN.md) Section 4.4 (roll out domain markers across the suite); [AI_DEV_TOOLS_IMPROVEMENT_PLAN_V5.md](../development_tools/AI_DEV_TOOLS_IMPROVEMENT_PLAN_V5.md) Section 5.7 task for further domain-marker analysis; [HOW_TO_RUN.md](../HOW_TO_RUN.md) Section 5.1.5 punctuation/clarity in the static-check cache paragraph.
...
- **Plan**: [`AI_DEV_TOOLS_IMPROVEMENT_PLAN_V5.md`](../development_tools/AI_DEV_TOOLS_IMPROVEMENT_PLAN_V5.md) Section 2 rolling snapshot (2026-04-14); Section 1.5 methodology cross-ref to HOW_TO_RUN.
...
- **V5 plan**: [`AI_DEV_TOOLS_IMPROVEMENT_PLAN_V5.md`](../development_tools/AI_DEV_TOOLS_IMPROVEMENT_PLAN_V5.md) **Section 5.3 - 3.20** - audit `add_priority` guidance/details defaults; retarget dev-tools priorities to [`DEVELOPMENT_TOOLS_GUIDE.md`](../development_tools/DEVELOPMENT_TOOLS_GUIDE.md) / [`AI_DEVELOPMENT_TOOLS_GUIDE.md`](../development_tools/AI_DEVELOPMENT_TOOLS_GUIDE.md) and extend those guides with any missing procedural content.
...
- **Documentation**: [AI_DEV_TOOLS_IMPROVEMENT_PLAN_V5.md](../development_tools/AI_DEV_TOOLS_IMPROVEMENT_PLAN_V5.md) - Section 4 priority table and Section 4.1 Phase 2 step (3) updated so Bandit/pip-audit Tier 3 completion is not duplicated as open work; Section 5.4 subsection 4.1 open tasks rephrased (optional Tier 1 promotion; remaining tools: Radon, pydeps, pre-commit, vulture, deeper ruff); Section 4.2 residual points to `MHM_PIP_AUDIT_SKIP`. Section 2 snapshot documents this slice.
...
- **Docs**: [`AI_DEV_TOOLS_IMPROVEMENT_PLAN_V5.md`](../development_tools/AI_DEV_TOOLS_IMPROVEMENT_PLAN_V5.md) Section 7.19 complete; Section 7.18 bullet points to Section 7.19 implementation.
...
- **Scripts backlog execution (V5 Section 3.12-Section 3.15)**: migrated local script utilities into tracked dev-tools ownership: [flaky_detector.py](../development_tools/tests/flaky_detector.py) and [verify_process_cleanup.py](../development_tools/tests/verify_process_cleanup.py). CLI wiring added in [cli_interface.py](../development_tools/shared/cli_interface.py) as `flaky-detector` / `verify-process-cleanup`; metadata registered in [tool_metadata.py](../development_tools/shared/tool_metadata.py); docs and backlog snapshots updated in [scripts/SCRIPTS_GUIDE.md](../scripts/SCRIPTS_GUIDE.md), [AI_DEV_TOOLS_IMPROVEMENT_PLAN_V5.md](../development_tools/AI_DEV_TOOLS_IMPROVEMENT_PLAN_V5.md), [DEVELOPMENT_TOOLS_GUIDE.md](../development_tools/DEVELOPMENT_TOOLS_GUIDE.md), [AI_DEVELOPMENT_TOOLS_GUIDE.md](../development_tools/AI_DEVELOPMENT_TOOLS_GUIDE.md), and [TODO.md](../TODO.md). `scripts/cleanup_project.py` remains a historical path; canonical cleanup owner is [fix_project_cleanup.py](../development_tools/shared/fix_project_cleanup.py). [DEPRECATION_INVENTORY.json](../development_tools/config/jsons/DEPRECATION_INVENTORY.json) records historical path retirement.
...
- **Documentation**: [AI_DEV_TOOLS_IMPROVEMENT_PLAN_V5.md](../development_tools/AI_DEV_TOOLS_IMPROVEMENT_PLAN_V5.md) Section 7.18 documents scoped `DEV_TOOLS_*` content and `--clear-cache` semantics; Section 1.3 scope-aware bullet updated.
...
- **Audit artifact fallbacks (doc home)**: Table and removal criteria for flat `jsons/` and unscoped report aggregates moved from [AI_LEGACY_COMPATIBILITY_GUIDE.md](../ai_development_docs/AI_LEGACY_COMPATIBILITY_GUIDE.md) to [AI_DEV_TOOLS_IMPROVEMENT_PLAN_V5.md](../development_tools/AI_DEV_TOOLS_IMPROVEMENT_PLAN_V5.md) Section 7.16; legacy guide `## 4. Tools` retains a short pointer. Code comments and [LEGACY_REFERENCE_REPORT.md](LEGACY_REFERENCE_REPORT.md) cite V5 Section 7.16.
...
- **Unused imports analyzer/report (plan 5.1)**: [development_tools/imports/analyze_unused_imports.py](../development_tools/imports/analyze_unused_imports.py) batches Ruff/Pylint with `Path.resolve()` keys so CLI JSON paths align with discovery paths. [development_tools/imports/generate_unused_imports_report.py](../development_tools/imports/generate_unused_imports_report.py) summary adds detection backend, cache mode, files re-linted, cache hits, and a note on interpreting zero findings vs `cache_only` / `--clear-cache`. [tests/development_tools/test_analyze_unused_imports.py](../tests/development_tools/test_analyze_unused_imports.py) adds `test_scan_minimal_project_finds_ruff_f401`; mock backends use resolved path keys. [development_tools/AI_DEV_TOOLS_IMPROVEMENT_PLAN_V5.md](../development_tools/AI_DEV_TOOLS_IMPROVEMENT_PLAN_V5.md) Section 5.1 updated (investigation outcome: repo clean under Ruff `F401`). `pytest tests/development_tools/test_analyze_unused_imports.py tests/development_tools/test_generate_unused_imports_report.py`: PASS.
