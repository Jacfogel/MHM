...
- **Feature**: Discord [`task_list_ui.py`](../communication/communication_channels/discord/task_list_ui.py) - task picker select + detail view (due date / priority / reminders / complete / more flows).
...
- **Discord refactor hardening**: Kept Phase 1-2 extractions ([`command_parser.py`](../communication/message_processing/command_parser.py) entity helpers; [`bot.py`](../communication/communication_channels/discord/bot.py) thin `initialize__register_events` delegating to [`discord_interaction_router.py`](../communication/communication_channels/discord/discord_interaction_router.py), [`discord_message_handler.py`](../communication/communication_channels/discord/discord_message_handler.py), [`discord_ready_handlers.py`](../communication/communication_channels/discord/discord_ready_handlers.py), [`discord_guild_handlers.py`](../communication/communication_channels/discord/discord_guild_handlers.py)). Added `@handle_errors` on nested bot event handlers and handler-module helpers (addresses AI_PRIORITIES error-handling items). Moved [`DiscordConnectionStatus`](../communication/communication_channels/discord/discord_connection_status.py) out of `bot.py`; updated [`communication/__init__.py`](../communication/__init__.py) lazy export.
...
- **Circular imports**: [`discord_handler_protocol.py`](../communication/communication_channels/discord/discord_handler_protocol.py) defines `DiscordHandlerHost` with full method docstrings; handler modules type against the protocol instead of importing [`bot.py`](../communication/communication_channels/discord/bot.py). [`analyze_error_handling.py`](../development_tools/error_handling/analyze_error_handling.py) excludes Protocol stubs with docstring+ellipsis bodies from missing-decorator reports. `get_discord_event_handler` reviewed and marked `# devtools: ignore[facade-shims]` while retained in deprecation inventory.
