...
- **Doc-sync**: [development_docs/LIST_OF_LISTS.md](development_docs/LIST_OF_LISTS.md) - qualified bare `config.py` / `generate_function_registry.py` references for path-drift checks. [ai_development_docs/AI_CHANGELOG.md](ai_development_docs/AI_CHANGELOG.md) / [development_docs/CHANGELOG_DETAIL.md](development_docs/CHANGELOG_DETAIL.md) - ASCII (section sign, hyphen for dash). `python development_tools/run_development_tools.py doc-sync`: PASS.
