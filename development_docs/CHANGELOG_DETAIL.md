...
- **Docs**: Retargeted [AI_DEV_TOOLS_IMPROVEMENT_PLAN_V6.md](../development_tools/AI_DEV_TOOLS_IMPROVEMENT_PLAN_V6.md) Section 1 / Section 2.1 / Section 2.5-2.7 / backlog B-001-B-008 and [TODO.md](../TODO.md) so coverage is tracked outside V6 active execution.
...
- **Docs (V6 plan refresh)**: Retargeted [AI_DEV_TOOLS_IMPROVEMENT_PLAN_V6.md](../development_tools/AI_DEV_TOOLS_IMPROVEMENT_PLAN_V6.md) Section 1.1, Section 1.2, Section 2.1-2.4, Section 4.3, backlog B-001-B-005 / B-018, and related completed-history notes to match the 2026-07-18 Tier 3 audit + codebase (module-scoped fixture list, ~65.2% dev-tools coverage hotspots, portability residual, domain-marker maintenance, `CVE-2026-3219` closed). Synced the active-follow-ups blurb in [TODO.md](../TODO.md).
...
- **Planning doc**: [`archive/AI_DEV_TOOLS_IMPROVEMENT_PLAN_V5.md`](../development_tools/AI_DEV_TOOLS_IMPROVEMENT_PLAN_V6.md) Section 7.x (remove `core.logger`) marked **Done** with follow-up notes for implicit MHM assumptions.
...
- **Feature**: Continued [archive/AI_DEV_TOOLS_IMPROVEMENT_PLAN_V5.md](../development_tools/AI_DEV_TOOLS_IMPROVEMENT_PLAN_V6.md) execution with a focused low-coverage dev-tools test slice. Added `_run_doc_subcheck_with_cache` branch tests in [`tests/development_tools/test_commands_coverage_helpers.py`](../tests/development_tools/test_commands_coverage_helpers.py) (standard-data, stdout-parse, fallback parse paths), helper classification coverage in [`tests/development_tools/test_fix_version_sync_todo_sync.py`](../tests/development_tools/test_fix_version_sync_todo_sync.py) (`_find_todo_scan_start`, `_classify_completed_todo_line` markers), and Tier-3 scope finalization coverage in [`tests/development_tools/test_audit_orchestration_helpers.py`](../tests/development_tools/test_audit_orchestration_helpers.py) (`cache_only_precheck` branch). Verified with targeted pytest runs for newly added cases.
...
- **Feature**: Updated [archive/AI_DEV_TOOLS_IMPROVEMENT_PLAN_V5.md](../development_tools/AI_DEV_TOOLS_IMPROVEMENT_PLAN_V6.md) snapshot and priority map to record this execution slice and schedule next medium backlog order as: **Section 5.5 - 5.2 documentation-overlap tuning**, then **Section 5.3 - 3.0 example-marker revalidation**, then **Section 5.7 - 7.6 portability parity**.
...
- **Planning / operator docs**: [TEST_PLAN.md](TEST_PLAN.md) Section 4.4 (roll out domain markers across the suite); [archive/AI_DEV_TOOLS_IMPROVEMENT_PLAN_V5.md](../development_tools/AI_DEV_TOOLS_IMPROVEMENT_PLAN_V6.md) Section 5.7 task for further domain-marker analysis; [HOW_TO_RUN.md](../HOW_TO_RUN.md) Section 5.1.5 punctuation/clarity in the static-check cache paragraph.
...
- **Plan**: [`archive/AI_DEV_TOOLS_IMPROVEMENT_PLAN_V5.md`](../development_tools/AI_DEV_TOOLS_IMPROVEMENT_PLAN_V6.md) Section 2 rolling snapshot (2026-04-14); Section 1.5 methodology cross-ref to HOW_TO_RUN.
...
- **V5 plan**: [`archive/AI_DEV_TOOLS_IMPROVEMENT_PLAN_V5.md`](../development_tools/AI_DEV_TOOLS_IMPROVEMENT_PLAN_V6.md) **Section 5.3 - 3.20** - audit `add_priority` guidance/details defaults; retarget dev-tools priorities to [`DEVELOPMENT_TOOLS_GUIDE.md`](../development_tools/DEVELOPMENT_TOOLS_GUIDE.md) / [`AI_DEVELOPMENT_TOOLS_GUIDE.md`](../development_tools/AI_DEVELOPMENT_TOOLS_GUIDE.md) and extend those guides with any missing procedural content.
...
- **Docs**: [`archive/AI_DEV_TOOLS_IMPROVEMENT_PLAN_V5.md`](../development_tools/AI_DEV_TOOLS_IMPROVEMENT_PLAN_V6.md) Section 7.19 complete; Section 7.18 bullet points to Section 7.19 implementation.
...
- **Documentation**: [archive/AI_DEV_TOOLS_IMPROVEMENT_PLAN_V5.md](../development_tools/AI_DEV_TOOLS_IMPROVEMENT_PLAN_V6.md) Section 7.18 documents scoped `DEV_TOOLS_*` content and `--clear-cache` semantics; Section 1.3 scope-aware bullet updated.
...
- **Unused imports analyzer/report (plan 5.1)**: [development_tools/imports/analyze_unused_imports.py](../development_tools/imports/analyze_unused_imports.py) batches Ruff/Pylint with `Path.resolve()` keys so CLI JSON paths align with discovery paths. [development_tools/imports/generate_unused_imports_report.py](../development_tools/imports/generate_unused_imports_report.py) summary adds detection backend, cache mode, files re-linted, cache hits, and a note on interpreting zero findings vs `cache_only` / `--clear-cache`. [tests/development_tools/test_analyze_unused_imports.py](../tests/development_tools/test_analyze_unused_imports.py) adds `test_scan_minimal_project_finds_ruff_f401`; mock backends use resolved path keys. [AI_DEV_TOOLS_IMPROVEMENT_PLAN_V6.md](../development_tools/AI_DEV_TOOLS_IMPROVEMENT_PLAN_V6.md) Section 5.1 updated (investigation outcome: repo clean under Ruff `F401`). `pytest tests/development_tools/test_analyze_unused_imports.py tests/development_tools/test_generate_unused_imports_report.py`: PASS.
...
- **V5 roadmap / pointers**: [TODO.md](../TODO.md), [development_docs/PLANS.md](PLANS.md), [development_docs/LIST_OF_LISTS.md](LIST_OF_LISTS.md), paired [development_tools/DEVELOPMENT_TOOLS_GUIDE.md](../development_tools/DEVELOPMENT_TOOLS_GUIDE.md) / [development_tools/AI_DEVELOPMENT_TOOLS_GUIDE.md](../development_tools/AI_DEVELOPMENT_TOOLS_GUIDE.md) now reference [AI_DEV_TOOLS_IMPROVEMENT_PLAN_V6.md](../development_tools/AI_DEV_TOOLS_IMPROVEMENT_PLAN_V6.md) for the forward backlog; V4 history retained. [AI_DEV_TOOLS_IMPROVEMENT_PLAN_V6.md](../development_tools/AI_DEV_TOOLS_IMPROVEMENT_PLAN_V6.md): Section 1.2 consolidated-report casing resolved; Section 4.1 Phase 2 scheduling; Section 7.6 optional Pyright delta env; Section 7.7 Phase 2-3 evaluation note; Section 5.8 lower-backlog pointers.
...
- **Technical Changes**:
  - **Roadmap Reconciliation (V5)**: Updated [archive/AI_DEV_TOOLS_IMPROVEMENT_PLAN_V5.md](../development_tools/AI_DEV_TOOLS_IMPROVEMENT_PLAN_V6.md) to align with fresh full-audit outputs, including current dev-tools coverage posture, Tier 3 scope status, and updated next-slice guidance.
...
- **Files**:
  - [archive/AI_DEV_TOOLS_IMPROVEMENT_PLAN_V5.md](../development_tools/AI_DEV_TOOLS_IMPROVEMENT_PLAN_V6.md)
  - `development_tools/shared/service/report_generation.py`
  - `development_tools/run_development_tools.py`
  - `development_tools/shared/cli_interface.py`
  - `tests/development_tools/test_audit_orchestration_helpers.py`
