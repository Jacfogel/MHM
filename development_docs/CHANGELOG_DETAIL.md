...
- **Impact**: Restores reminder scheduling on v2 task data and avoids noisy Discord startup errors when environment configuration is incomplete or mismatched.
