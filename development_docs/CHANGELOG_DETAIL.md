...
- **Impact**: Fixes all 11+1 CI failures from round 4 (12 failed node IDs including xdist crash). Root cause pattern: gitignored config/fixtures, platform-specific filesystem behavior, and Windows-only test logic running on Linux CI.
