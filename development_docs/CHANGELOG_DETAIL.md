...
### 2026-07-03 - Fix nightly CI: test cleanup, pytest compat, and 10 CI-only test failures
...
- **Impact**: Fixes round 4–6 CI failures. Root cause: gitignored config/fixtures and tests assuming local-only resources on Linux CI.
