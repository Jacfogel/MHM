...
- **Documentation**: [`HOW_TO_RUN.md`](../HOW_TO_RUN.md) Section 5.1.6 and [`development_tools/DEVELOPMENT_TOOLS_GUIDE.md`](../development_tools/DEVELOPMENT_TOOLS_GUIDE.md) document audit completion lines (`Completed <tool>: PASS issues=N`): `PASS`/`FAIL` vs metric `total_issues`, pointer to V5 Section 3.21. [`development_tools/AI_DEV_TOOLS_IMPROVEMENT_PLAN_V5.md`](../development_tools/AI_DEV_TOOLS_IMPROVEMENT_PLAN_V5.md) updated for that semantics workstream (see repo diff).
- **Validation**: `pytest tests/development_tools/test_data_loading_helpers.py` (pass); `python -m pyright` clean for touched test modules.
