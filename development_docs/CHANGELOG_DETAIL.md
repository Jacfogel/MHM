...
### 2026-03-27 - V4 dev tools continuation (plan implementation)
...
- **Deprecation inventory**: [development_tools/config/jsons/DEPRECATION_INVENTORY.json](development_tools/config/jsons/DEPRECATION_INVENTORY.json) - `root_ruff_compat_mirror` notes expanded with 2026-03-27 verification and removal gating (bridge remains until V4 Section 7.6 portability exit criteria).
