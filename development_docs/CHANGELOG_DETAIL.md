...
- **Docs/planning**: Updated [`development_docs/BACKUP_GUIDE.md`](BACKUP_GUIDE.md), [`ai_development_docs/AI_BACKUP_GUIDE.md`](../ai_development_docs/AI_BACKUP_GUIDE.md), [`development_docs/PLANS.md`](PLANS.md), and [`TODO.md`](../TODO.md) so active guidance no longer points at ignored project scripts. The Backup Reliability and Restore Confidence Plan is complete and removed from active planning.
