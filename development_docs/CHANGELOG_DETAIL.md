...
- **Impact**: Fixes round 4–7 CI failures. Root cause: gitignored config/fixtures, portability-test config pollution, and tests assuming local-only resources on Linux CI.
