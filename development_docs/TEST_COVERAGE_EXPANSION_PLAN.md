...
> **Last Generated**: 2025-11-15 20:41:27
...
- **Total Statements**: 26,711
- **Covered Statements**: 19,049
- **Uncovered Statements**: 7,662
- **Goal**: Expand to **80%+ coverage** for comprehensive reliability

### **Coverage Summary by Category**
- **Excellent (93% avg)**: 57 modules
...
- **! core\user_data_handlers.py**: 63% (485/766 lines)
...
- **! core\user_management.py**: 76% (531/701 lines)
...
- **! communication\communication_channels\discord\webhook_handler.py**: 79% (86/109 lines)
