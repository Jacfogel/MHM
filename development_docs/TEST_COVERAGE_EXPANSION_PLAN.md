...
> **Last Generated**: 2025-11-21 05:22:54
...
- **Total Statements**: 26,798
- **Covered Statements**: 19,075
- **Uncovered Statements**: 7,723
- **Goal**: Expand to **80%+ coverage** for comprehensive reliability

### **Coverage Summary by Category**
- **Excellent (93% avg)**: 59 modules
- **Good (71% avg)**: 36 modules
...
- **X ui\ui_app_qt.py**: 50% (710/1414 lines)
- **X communication\communication_channels\email\bot.py**: 54% (121/223 lines)
- **X core\file_locking.py**: 54% (69/128 lines)
- **X ai\chatbot.py**: 57% (478/832 lines)
- **X communication\command_handlers\interaction_handlers.py**: 57% (887/1557 lines)
- **X communication\core\channel_orchestrator.py**: 58% (584/1015 lines)
- **! core\service.py**: 61% (424/696 lines)
...
- **! ui\dialogs\account_creator_dialog.py**: 64% (373/584 lines)
- **! ui\dialogs\task_crud_dialog.py**: 64% (154/241 lines)
- **! communication\message_processing\interaction_manager.py**: 65% (311/477 lines)
- **! core\logger.py**: 65% (448/694 lines)
...
- **! TOTAL**: 71% (19075/26798 lines)
- **! communication\command_handlers\analytics_handler.py**: 73% (335/462 lines)
- **! communication\message_processing\conversation_flow_manager.py**: 73% (393/541 lines)
...
- **! core\error_handling.py**: 78% (287/366 lines)
...
- *** core\backup_manager.py**: 80% (313/391 lines)
- *** core\schemas.py**: 80% (229/288 lines)
- *** core\schedule_management.py**: 81% (245/301 lines)
- *** tasks\task_management.py**: 81% (473/581 lines)
...
- *** ui\dialogs\user_analytics_dialog.py**: 96% (263/273 lines)
