...
2. **Raise development tools coverage**  -  Development tools coverage is 40.8% (target 60%+).
...
3. **Retire remaining legacy references**  -  38 files still depend on legacy compatibility markers.
