...
> **Last Generated**: 2026-01-06 02:35:47
...
1. **Raise coverage for domains below target**  -  3 key domains remain below the 80% target.
   - Target domains: tasks (45.5%, 319 lines missing), ai (47.2%, 909 lines missing), communication (49.1%, 4480 lines missing)
...
2. **Raise development tools coverage**  -  Development tools coverage is 39.6% (target 60%+).
...
4. **Refactor high-complexity functions**  -  135 critical-complexity functions (>199 nodes) need immediate attention.
   ...
   - Effort: Large (refactoring 135 critical functions requires careful analysis and testing)
...
## Watch List
- Overall test coverage is 51.0% (target 80%) (14223 / 27902 statements).
- Development tools coverage is 39.6% (target 60%+).
