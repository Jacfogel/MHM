...
1. **Raise coverage for domains below target**  -  3 key domains remain below the 80% target.
   - Target domains: communication (65.1%, 3091 lines missing), ui (70.3%, 1993 lines missing), core (73.4%, 2669 lines missing)
...
## Watch List
- Overall test coverage is 70.7% (target 80%) (19907 / 28153 statements).
