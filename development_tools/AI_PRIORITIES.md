...
> **Last Generated**: 2026-01-15 00:50:47
...
1. **Raise coverage for domains below target**  -  3 key domains remain below the 80% target.
   - Target domains: communication (68.7%, 2856 lines missing), ui (70.9%, 1953 lines missing), core (73.8%, 2619 lines missing)
...
3. **Retire remaining legacy references**  -  35 files still depend on legacy compatibility markers.
...
## Watch List
- Overall test coverage is 72.1% (target 80%) (20455 / 28364 statements).
