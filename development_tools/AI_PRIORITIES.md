...
1. **Remove unused imports**  -  499 unused imports across 171 files (CRITICAL status).
   - 172 obvious removals (safe to delete)
...
2. **Raise coverage for domains below target**  -  3 key domains remain below the 80% target.
   - Target domains: communication (69.8%, 2652 lines missing), ui (72.9%, 1674 lines missing), core (73.2%, 2582 lines missing)
...
## Watch List
- Overall test coverage is 72.8% (target 80%) (19776 / 27168 statements).
