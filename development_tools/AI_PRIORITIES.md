...
1. **Raise coverage for domains below target**  -  3 key domains remain below the 80% target.
   - Target domains: communication (69.4%, 2708 lines missing), ui (70.3%, 1993 lines missing), core (73.6%, 2658 lines missing)
...
4. **Refactor high-complexity functions**  -  144 critical-complexity functions (>199 nodes) need immediate attention.
...
## Watch List
- Overall test coverage is 72.2% (target 80%) (20343 / 28187 statements).
