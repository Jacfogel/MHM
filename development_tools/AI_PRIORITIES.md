...
1. **Raise coverage for domains below target**  -  3 key domains remain below the 80% target.
   - Target domains: communication (68.8%, 2796 lines missing), ui (70.3%, 1992 lines missing), core (73.6%, 2657 lines missing)
...
## Watch List
- Overall test coverage is 72.0% (target 80%) (20361 / 28298 statements).
