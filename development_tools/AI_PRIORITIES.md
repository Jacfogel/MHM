...
> **Last Generated**: 2026-01-04 17:48:44
...
1. **Raise coverage for domains below target**  -  3 key domains remain below the 80% target.
   - Target domains: communication (69.9%, 2632 lines missing), ui (72.9%, 1674 lines missing), core (73.4%, 2564 lines missing)
...
2. **Raise development tools coverage**  -  Development tools coverage is 42.9% (target 60%+).
...
4. **Refactor high-complexity functions**  -  132 critical-complexity functions (>199 nodes) need immediate attention.
...
## Watch List
- Overall test coverage is 72.9% (target 80%) (19814 / 27169 statements).
- Development tools coverage is 42.9% (target 60%+).
