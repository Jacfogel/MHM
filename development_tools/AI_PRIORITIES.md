...
> **Last Generated**: 2026-01-05 00:11:02
...
1. **Raise coverage for domains below target**  -  3 key domains remain below the 80% target.
   - Target domains: communication (69.9%, 2635 lines missing), ui (72.4%, 1725 lines missing), core (73.7%, 2577 lines missing)
...
2. **Raise development tools coverage**  -  Development tools coverage is 42.5% (target 60%+).
...
## Watch List
- Overall test coverage is 72.9% (target 80%) (19965 / 27388 statements).
- Development tools coverage is 42.5% (target 60%+).
