...
1. **Raise coverage for domains below target**  -  3 key domains remain below the 80% target.
   - Target domains: communication (68.9%, 2794 lines missing), ui (70.4%, 1989 lines missing), core (73.7%, 2644 lines missing)
...
## Watch List
- Overall test coverage is 72.0% (target 80%) (20385 / 28298 statements).
