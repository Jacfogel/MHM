...
1. **Raise coverage for domains below target**  -  3 key domains remain below the 80% target.
   - Target domains: communication (68.8%, 2795 lines missing), ui (70.4%, 1989 lines missing), core (73.4%, 2676 lines missing)
...
2. **Raise development tools coverage**  -  Development tools coverage is 42.3% (target 60%+).
...
## Watch List
- Overall test coverage is 71.9% (target 80%) (20346 / 28298 statements).
- Development tools coverage is 42.3% (target 60%+).
