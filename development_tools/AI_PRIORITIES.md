...
> **Last Generated**: 2026-01-14 05:26:54
...
1. **Raise coverage for domains below target**  -  3 key domains remain below the 80% target.
   - Target domains: communication (68.4%, 2876 lines missing), ui (70.4%, 1988 lines missing), core (73.5%, 2682 lines missing)
...
2. **Raise development tools coverage**  -  Development tools coverage is 40.9% (target 60%+).
...
3. **Retire remaining legacy references**  -  36 files still depend on legacy compatibility markers.
   - 67 legacy markers still surface during scans.
   ...
   - Effort: Medium (reviewing 36 files and updating references requires testing)
...
## Watch List
- Overall test coverage is 71.8% (target 80%) (20446 / 28485 statements).
