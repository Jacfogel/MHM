...
def main():
    ...
    parser.add_argument('--output', type=str, help='Output file path (default: development_tools/error_handling_details.json when --json is used)')
    ...
    if args.json:
        ...
        if args.output:
            ...
            # Default to development_tools directory
            tools_dir = project_root / 'development_tools'
