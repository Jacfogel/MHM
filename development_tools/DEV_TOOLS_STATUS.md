...
## Snapshot
- **Total Functions**: 1630 (Moderate: 209, High: 171, Critical: 151)
...
- **Static Analysis (ruff/pyright/bandit/pip-audit)**: 9 issue(s) (ruff=0, pyright=8, bandit=0, pip-audit=1)
...
- **Large/High-Complexity Modules**: 61 candidate(s) for refactoring (see DEV_TOOLS_PRIORITIES)
