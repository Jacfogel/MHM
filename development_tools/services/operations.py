...
class AIToolsService:
    ...
    def run_error_handling_coverage(self) -> Dict:
        ...
        if data is None:
            try:
                json_file = self.project_root / 'development_tools' / 'error_handling_details.json'
                if json_file.exists():
    ...
    def run_audit(self, fast: bool = True):
        ...
        if result:
            ...
            logger.info(f"* JSON Data: development_tools/ai_audit_detailed_results.json")

            logger.info("* Check development_tools/archive/ for previous runs")
    ...
    def run_coverage_regeneration(self):
        ...
        coverage_collected = (
            ...
            (self.project_root / "development_tools" / "coverage.json").exists()
        )
        ...
        if result['success']:
            ...
            if coverage_collected:
                ...
                if test_results.get('failed_count', 0) > 0:
                    ...
                    if test_results.get('failed_tests'):
                        ...
                        logger.warning("  See development_tools/logs/coverage_regeneration/ for detailed test failure information")
            else:
            ...
            logger.info("  Check development_tools/logs/coverage_regeneration/ for detailed logs")
    ...
    def _load_coverage_summary(self) -> Optional[Dict[str, Any]]:
        ...
        coverage_path = self.project_root / "development_tools" / "coverage.json"
    ...
    def _generate_consolidated_report(self) -> str:
        ...
        analyze_report = self.project_root / 'development_tools' / 'ai_audit_detailed_results.json'
