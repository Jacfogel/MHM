...
- Standalone (review only): `python development_tools/docs/analyze_documentation_sync.py --json --check-example-markers` - same advisory scan to stdout (V5 Section 3.0).
