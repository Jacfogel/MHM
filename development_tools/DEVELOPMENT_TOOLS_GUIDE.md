...
- **ruff.toml** – Generated by `sync_ruff_toml.py`. Fully generated from non–project-specific defaults when `development_tools_config.json` is absent; otherwise may include project-specific exclusions. Regenerate with: `python -m development_tools.config.sync_ruff_toml`
