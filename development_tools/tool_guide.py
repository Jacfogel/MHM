...
try:
    from .services.tool_metadata import get_tools_by_tier
except ImportError:
    from development_tools.services.tool_metadata import get_tools_by_tier
...
if __name__ == "__main__":
    if len(sys.argv) > 1:
        ...
        if command == "guide":
            ...
            print("Usage:")
            print("  python development_tools/tool_guide.py guide                    # Show all tools")
            print("  python development_tools/tool_guide.py guide ai_tools_runner.py     # Show specific tool")
            print("  python development_tools/tool_guide.py recommend 'documentation' # Get recommendations")
            print("  python development_tools/tool_guide.py run ai_tools_runner.py       # Run with guidance")
    else:
        # Default: show all tools
        show_tool_guide()
        print("NOTE: For specific guidance:")
        print("   python development_tools/tool_guide.py guide <tool_name>")
        print("   python development_tools/tool_guide.py recommend 'your scenario'") 
