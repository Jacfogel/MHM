...
class ModuleImportAnalyzer:
    ...
    def __init__(self, project_root: Optional[str] = None, local_prefixes: Optional[Tuple[str, ...]] = None):
    ...
    def find_usage_of_module(self, target_module: str, all_modules: Dict[str, Dict]) -> List[str]:
    ...
    def find_reverse_dependencies(self, target_module: str, all_modules: Dict[str, Dict]) -> List[str]:
    ...
    def analyze_dependency_changes(self, file_path: str, data: Dict, existing_content: str) -> Dict:
    ...
    def infer_module_purpose(self, file_path: str, data: Dict, all_modules: Dict[str, Dict]) -> str:
