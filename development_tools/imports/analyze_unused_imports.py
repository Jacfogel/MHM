...
class UnusedImportsChecker:
    ...
    def generate_report(self) -> str:
        ...
        lines.append("> **Generated**: This file is auto-generated by analyze_unused_imports.py. Do not edit manually.")
        lines.append("> **Generated by**: analyze_unused_imports.py - Unused Imports Detection Tool")
        lines.append(f"> **Last Generated**: {timestamp}")
        lines.append("> **Source**: `python development_tools/run_development_tools.py unused-imports`")
        lines.append("")
