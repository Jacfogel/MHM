...
"core/user_data_write.py": "User data save pipeline",
"core/user_data_schedule_defaults.py": "Schedule defaults and migration",
...
"core/user_data_updates.py": "High-level update helpers (update_user_account, etc.)",
