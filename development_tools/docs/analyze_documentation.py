...
try:
    from . import config
    from ..shared.common import ProjectPaths, ensure_ascii, load_text, run_cli, summary_block
    from ..shared.constants import CORRUPTED_ARTIFACT_PATTERNS, DEFAULT_DOCS, PAIRED_DOCS
except ImportError:
    import sys
    from pathlib import Path
    ...
    from development_tools.shared.common import ProjectPaths, ensure_ascii, load_text, run_cli, summary_block
    from development_tools.shared.constants import CORRUPTED_ARTIFACT_PATTERNS, DEFAULT_DOCS, PAIRED_DOCS
