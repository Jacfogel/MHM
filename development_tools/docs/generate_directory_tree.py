...
def main():
    """Main entry point."""
    parser = argparse.ArgumentParser(description="Generate directory tree for documentation")
    parser.add_argument('--output', default=None, help='Output file path (default: development_docs/DIRECTORY_TREE.md)')
