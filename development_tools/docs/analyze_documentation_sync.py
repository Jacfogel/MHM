...
Usage:
    python docs/analyze_documentation_sync.py [--check] [--fix] [--generate-trees]
"""
...
if __name__ != '__main__' and __package__ and '.' in __package__:
    ...
    # config is in development_tools.config, not development_tools.docs, so use .. to go up to development_tools
    from .. import config
...
class DocumentationSyncChecker:
    ...
    def generate_directory_tree(self, output_file: Optional[str] = None) -> str:
        ...
        footer = [
            ...
            "---",
            "",
            "*Generated by analyze_documentation_sync.py*"
        ]
...
def main():
    ...
    if args.generate_trees:
        ...
        # Don't print here - the generate_directory_tree method already logs it
        return
