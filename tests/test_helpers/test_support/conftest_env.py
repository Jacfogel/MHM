...
def verify_user_data_loader_registry():
    ...
    import storage.user_data_registry as udh
    ...
    if um.USER_DATA_LOADERS is not udh.USER_DATA_LOADERS:
        raise AssertionError(
            "USER_DATA_LOADERS mismatch: storage.user_data_registry reloads hold different dict objects."
        )
...
def initialize_loader_import_order(request):
    """Reload storage.user_data_registry and register loaders once.
