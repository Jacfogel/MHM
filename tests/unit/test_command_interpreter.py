...
class TestCommandInterpreter:
    ...
    @pytest.mark.parametrize(
        ...
        [
            ...
            ("don't let me forget to take meds", "command_with_clarification"),
            ("i still need to pay rent", "command_with_clarification"),
            ("i'm supposed to call the school", "command_with_clarification"),
            ("make sure i take meds", "command_with_clarification"),
            ("remember to buy milk", "command_with_clarification"),
            ("jot down that I talked to the doctor", "command"),
            ("keep in mind that the gate code is 1234", "command"),
            ("write this down: wifi is on the fridge", "command"),
