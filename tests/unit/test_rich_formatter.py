...
class TestDiscordRichFormatter:
    ...
    def test_initialization_without_discord(self):
        ...
        # Arrange & Act
        with patch(
            "builtins.__import__", side_effect=ImportError("No module named 'discord'")
        ):
            formatter = DiscordRichFormatter()
    ...
    def test_create_embed_with_description(self, formatter_with_discord, mock_discord):
        ...
        ), "Should set description on embed"

    @pytest.mark.communication
    @pytest.mark.unit
    def test_create_embed_with_message_as_description(
        self, formatter_with_discord, mock_discord
    ):
    ...
    @pytest.mark.communication
    @pytest.mark.unit
    def test_create_embed_extracts_title_from_message(
        self, formatter_with_discord, mock_discord
    ):
    ...
    @pytest.mark.communication
    @pytest.mark.unit
    def test_create_interactive_view_with_suggestions(
        self, formatter_with_discord, mock_discord
    ):
        ...
        assert (
            mock_view.add_item.call_count == 3
        ), "Should add buttons for all suggestions"

    @pytest.mark.communication
    @pytest.mark.unit
    def test_create_interactive_view_limits_to_five(
        self, formatter_with_discord, mock_discord
    ):
...
class TestEmailRichFormatter:
    ...
    def test_create_embed_with_description(self, formatter):
        ...
        # Assert
        assert (
            "<p>Test Description</p>" in result
        ), "Should include description paragraph"
...
class TestRichFormatterFactory:
    ...
    def test_get_rich_formatter_for_discord(self):
        ...
        assert isinstance(
            formatter, DiscordRichFormatter
        ), "Should return DiscordRichFormatter for discord"
    ...
    def test_get_rich_formatter_for_email(self):
        ...
        # Assert
        assert isinstance(
            formatter, EmailRichFormatter
        ), "Should return EmailRichFormatter for email"
    ...
    def test_get_rich_formatter_for_unknown_type(self):
        ...
        assert isinstance(
            formatter, EmailRichFormatter
        ), "Should return EmailRichFormatter as default"
    ...
    def test_get_rich_formatter_handles_exception(self):
        ...
        # Arrange
        with patch(
            "communication.communication_channels.base.rich_formatter.DiscordRichFormatter",
            ...
            assert isinstance(
                formatter, EmailRichFormatter
            ), "Should return default formatter on error"
