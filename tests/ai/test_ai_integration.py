    ...
    def test_conversation_history_in_context(self):
        ...
        try:
            ...
            try:
                ...
                context_info_before = self._build_context_info(
                    actual_user_id, include_history=True
                )
                ...
                context_info_after = self._build_context_info(
                    actual_user_id, include_history=True
                )
                context_info = {
                    **context_info_before,
                    "conversation_history_after_first": context_info_after.get(
