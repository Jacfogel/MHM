...
| Quick notes (qn, qnote, quickn, quicknote, q note, quick note) | `test_quick_note_aliases_save_without_a_group` |
...
| Saved entries do not store a group | same; `test_set_group_and_list_inbox` |
