...
class TestTaskListUiHelpers:
    ...
    def test_task_flow_response_due_date_starts_flow(self):
        ...
        with patch(
            ...
            "communication.communication_channels.discord.ui.task_list_ui.conversation_manager"
        ) as mock_cm:
    ...
    def test_task_flow_response_priority_asks_reminders_when_due_set(self):
        ...
        with patch(
            ...
            "communication.communication_channels.discord.ui.task_list_ui.runtime_task_due_date",
...
class TestTaskListViewFactory:
    ...
    def test_get_task_list_view_adds_select_for_items(self):
        ...
        with patch(
            "communication.communication_channels.discord.ui.task_list_ui.discord.ui.View",
            MockView,
        ), patch(
            "communication.communication_channels.discord.ui.task_list_ui.TaskListSelect",
            MockSelect,
        ):
    ...
    def test_get_task_list_view_adds_show_more_button(self):
        ...
        with patch(
            ...
            "communication.communication_channels.discord.ui.task_list_ui.discord.ui.Button",
            MockButton,
        ):
            view = get_task_list_view(
                "user-page",
...
class TestTaskListSelectCallback:
    ...
    async def test_select_callback_no_account(self):
        ...
        with patch(
            "communication.communication_channels.discord.ui.task_list_ui._internal_user_id",
            return_value=None,
        ):
    ...
    async def test_select_callback_shows_detail_view(self):
        ...
        with patch(
            ...
            "communication.communication_channels.discord.ui.task_list_ui._format_task_detail",
            return_value="**Task detail**",
        ), patch(
            "communication.communication_channels.discord.ui.task_list_ui.TaskDetailView",
    ...
    async def test_detail_start_flow_delivers_response(self):
        ...
        with patch(
            ...
            "communication.communication_channels.discord.ui.task_list_ui._task_flow_response",
            return_value=flow_response,
        ), patch(
            "communication.communication_channels.discord.ui.task_list_ui.deliver_handler_response",
    ...
    async def test_detail_complete_button_runs_handler(self):
        ...
        with patch(
            "communication.communication_channels.discord.ui.task_list_ui.discord.ui.View.__init__",
        ...
        with patch(
            ...
            "communication.communication_channels.discord.ui.task_list_ui._run_handler_intent",
