...
class TestChannelMonitor:
    ...
    def test_get_channel_health_status_with_channels(
        self, channel_monitor, mock_channels
    ):
    ...
    def test_get_channel_health_status_with_failures(
        self, channel_monitor, mock_channels
    ):
    ...
    def test_get_channel_health_status_with_restart_attempts(
        self, channel_monitor, mock_channels
    ):
        ...
        now = (
            now_datetime_full()
        )  # Canonical 'now' for prod-behavior-sensitive cooldown logic
    ...
    def test_attempt_channel_restart_with_cooldown(
        self, channel_monitor, mock_channels
    ):
    ...
    def test_attempt_channel_restart_without_cooldown(
        self, channel_monitor, mock_channels
    ):
    ...
    def test_attempt_channel_restart_insufficient_failures(
        self, channel_monitor, mock_channels
    ):
    ...
    def test_attempt_channel_restart_no_restart_method(
        self, channel_monitor, mock_channels
    ):
    ...
    def test_attempt_channel_restart_restart_fails(
        self, channel_monitor, mock_channels
    ):
    ...
    def test_check_and_restart_stuck_channels_failed_status(
        self, channel_monitor, mock_channels
    ):
    ...
    def test_check_and_restart_stuck_channels_unhealthy(
        self, channel_monitor, mock_channels
    ):
    ...
    def test_check_and_restart_stuck_channels_healthy(
        self, channel_monitor, mock_channels
    ):
    ...
    def test_check_and_restart_stuck_channels_exception(
        self, channel_monitor, mock_channels
    ):
        ...
        mock_channels["channel1"].is_healthy.side_effect = Exception(
            "Health check failed"
        )
    ...
    def test_restart_monitor_loop_runs(self, channel_monitor, mock_channels):
        ...
        with (
            ...
            patch(
                "communication.core.channel_monitor.time.sleep",
                side_effect=lambda _interval: None,
            ),
        ):
            channel_monitor.start_restart_monitor()
