...
class TestCommunicationFactoryCoverageExpansion:
    ...
    def test_initialize_registry_with_import_error(self, test_data_dir):
        ...
        with patch('communication.core.factory.get_available_channels') as mock_channels:
            with patch('communication.core.factory.get_channel_class_mapping') as mock_mapping:
    ...
    def test_factory_logging_behavior(self, test_data_dir):
        ...
        with patch('communication.core.factory.logger') as mock_logger:
            with patch('communication.core.factory.get_available_channels') as mock_channels:
                with patch('communication.core.factory.get_channel_class_mapping') as mock_mapping:
