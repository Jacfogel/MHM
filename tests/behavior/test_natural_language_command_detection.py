...
class TestNaturalLanguageCommandDetection:
    ...
    def test_i_should_call_mom_detects_clarification_mode(self):
        ...
        mode = get_command_interpreter().detect_mode("I should call mom")
    ...
    def test_i_want_to_schedule_dentist_detects_clarification_mode(self):
        ...
        mode = get_command_interpreter().detect_mode("I want to schedule dentist")
    ...
    def test_i_need_to_get_milk_detects_clarification_mode(self):
        ...
        mode = get_command_interpreter().detect_mode("I need to get milk")
    ...
    def test_explicit_commands_still_work(self):
        ...
        mode1 = get_command_interpreter().detect_mode("add task buy groceries")
        assert mode1 == "command", f"Expected 'command', got '{mode1}'"
        
        mode2 = get_command_interpreter().detect_mode("create task call mom")
    ...
    def test_chat_messages_still_detected_as_chat(self):
        ...
        mode1 = get_command_interpreter().detect_mode("How are you doing today?")
        assert mode1 == "chat", f"Expected 'chat', got '{mode1}'"
        
        mode2 = get_command_interpreter().detect_mode("I'm feeling good")
