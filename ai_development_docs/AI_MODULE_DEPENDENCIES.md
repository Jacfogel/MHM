...
- **Files Scanned**: 298
- **Total Imports**: 3524
- **Standard Library**: 1122 (31.8%)
- **Third-Party**: 533 (15.1%)
...
- `run_tests.py` -> standard library (argparse, ctypes, os, queue) (main application entry)
...
### Third-Party Risks
- `tests/conftest.py` -> pytest (154 modules use this)
