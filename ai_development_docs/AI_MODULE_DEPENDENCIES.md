...
- **Files Scanned**: 236
- **Total Imports**: 2501
- **Standard Library**: 776 (31.0%)
- **Third-Party**: 390 (15.6%)
...
- Error Handling
  - core/error_handling.py <- standard library (asyncio, datetime, json, os), service_utilities, logger
...
- `tests/conftest.py` -> 34 local dependencies (heavy coupling)

### Third-Party Risks
- `tests/conftest.py` -> pytest (74 modules use this)
- `ui/ui_app_qt.py` -> PySide6.QtWidgets (67 modules use this)
- `ui/ui_app_qt.py` -> PySide6.QtCore (52 modules use this)
- `ui/ui_app_qt.py` -> PySide6.QtGui (30 modules use this)
- `core/headless_service.py` -> psutil (7 modules use this)
