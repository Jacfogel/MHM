...
- **Files Scanned**: 265
- **Total Imports**: 2916
- **Standard Library**: 875 (30.0%)
- **Third-Party**: 473 (16.2%)
...
- Conversation Flow
  - communication/message_processing/conversation_flow_manager.py <- standard library (datetime, json, os, pathlib), chatbot, logger, user_data_handlers, response_tracking, error_handling (+8 more)

### Need UI Dependencies?
UI Dependencies:
- Main Application
  - ui/ui_app_qt.py <- standard library (datetime, json, os, pathlib), third-party (PySide6.QtCore, PySide6.QtGui, PySide6.QtWidgets), logger, config, error_handling, user_context, user_data_handlers (+17 more)
- Dialogs
...
- `tests/ui/test_ui_app_qt_main.py` -> standard library (pathlib, unittest.mock), third-party (pytest), conftest, ui_app_qt, test_utilities (application entry)
...
- `tests/conftest.py` -> 43 local dependencies (heavy coupling)
- `core/user_management.py` -> 40 local dependencies (heavy coupling)
- `tests/ui/test_ui_app_qt_main.py` -> 40 local dependencies (heavy coupling)

### Third-Party Risks
- `tests/conftest.py` -> pytest (106 modules use this)
- `ui/ui_app_qt.py` -> PySide6.QtWidgets (78 modules use this)
- `ui/ui_app_qt.py` -> PySide6.QtCore (62 modules use this)
- `ui/ui_app_qt.py` -> PySide6.QtGui (36 modules use this)
- `tests/ui/test_account_creation_ui.py` -> PySide6.QtTest (15 modules use this)
