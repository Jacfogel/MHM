...
> **Last Generated**: 2026-09-23 08:48:25
...
- Widgets
  ...
  - ui/widgets/checkin_settings_widget.py <- standard library (re, typing), third-party (PySide6.QtCore, PySide6.QtWidgets), checkin_settings_widget_pyqt, checkin_schemas, ui_management, period_row_management, core (+3 more)
...
### High Coupling
- `core/web_account_service.py` -> 26 unique local dependencies (high fan-out; review for inappropriate edges) (45 import statements; 19 duplicate)
