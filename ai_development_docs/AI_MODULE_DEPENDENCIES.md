...
- **Files Scanned**: 298
- **Total Imports**: 3450
- **Standard Library**: 1108 (32.1%)
- **Third-Party**: 505 (14.6%)
...
- `run_tests.py` -> standard library (argparse, ctypes, os, subprocess) (main application entry)
...
### Third-Party Risks
- `tests/conftest.py` -> pytest (126 modules use this)
