...
- **Files Scanned**: 325
- **Total Imports**: 3751
- **Standard Library**: 1264 (33.7%)
- **Third-Party**: 560 (14.9%)
...
- `run_tests.py` -> standard library (argparse, ctypes, logging, os) (main application entry)
...
- `core/user_management.py` -> 41 local dependencies (heavy coupling)

### Third-Party Risks
- `tests/conftest.py` -> pytest (177 modules use this)
