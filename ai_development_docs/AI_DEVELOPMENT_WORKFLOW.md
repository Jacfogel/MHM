...
- When you need more detail, jump to:
  ...
  - Testing:
    - [AI_TESTING_GUIDE.md](AI_TESTING_GUIDE.md) (routing for which tests to run and which commands to use).
  - Logging:
    - [AI_LOGGING_GUIDE.md](AI_LOGGING_GUIDE.md) (routing for logging patterns and component log usage).
  - Error handling:
    - [AI_ERROR_HANDLING_GUIDE.md](AI_ERROR_HANDLING_GUIDE.md) (routing for error categories and handling patterns).
  - Documentation:
    - [AI_DOCUMENTATION_GUIDE.md](AI_DOCUMENTATION_GUIDE.md) (routing for documentation categories and sync rules).
  - Legacy compatibility removal:
    - [AI_LEGACY_COMPATIBILITY_GUIDE.md](AI_LEGACY_COMPATIBILITY_GUIDE.md) (required sequencing for migration-first legacy cleanup).
    - `development_tools/config/jsons/DEPRECATION_INVENTORY.json` (required inventory for deprecated/removed/to-retire terms).
...
- For crashes, confusing errors, or suspected configuration issues, route to:
  ...
  - [AI_ERROR_HANDLING_GUIDE.md](AI_ERROR_HANDLING_GUIDE.md).
  - [AI_LOGGING_GUIDE.md](AI_LOGGING_GUIDE.md).
...
- Route yourself or the user to:
  - [AI_ARCHITECTURE.md](AI_ARCHITECTURE.md) for where new logic should live and how components interact.
  - [AI_TESTING_GUIDE.md](AI_TESTING_GUIDE.md) for where tests should go and which kinds of tests to add.
  - [AI_DOCUMENTATION_GUIDE.md](AI_DOCUMENTATION_GUIDE.md) for which docs must be updated and how to keep pairs in sync.
...
- Decide which docs to update using [AI_DOCUMENTATION_GUIDE.md](AI_DOCUMENTATION_GUIDE.md).
...
- When touching config or list-like structures, consult [LIST_OF_LISTS.md](../development_tools/LIST_OF_LISTS.md) for canonical sources and consolidation principles.
## 4. Testing Strategy

- Always propose tests when suggesting code changes.
- For where and how to write tests, route to:
  - [AI_TESTING_GUIDE.md](AI_TESTING_GUIDE.md) for routing and quick commands.
...
- For deeper AI-specific testing patterns, route the tool to [AI_TESTING_GUIDE.md](AI_TESTING_GUIDE.md) instead of re-explaining them here.
...
- Recommend tests to add or update, using [AI_TESTING_GUIDE.md](AI_TESTING_GUIDE.md) to choose scope and commands.
- Identify which docs should be updated (for example, `README.md`, `HOW_TO_RUN.md`, or a guide) using [AI_DOCUMENTATION_GUIDE.md](AI_DOCUMENTATION_GUIDE.md).

**Bug fix**

- Ask how the bug reproduces and whether there are relevant logs.
- Suggest checking component logs using patterns from [AI_LOGGING_GUIDE.md](AI_LOGGING_GUIDE.md).
- Recommend the smallest change that clearly fixes the issue.
- Ensure tests cover the bug going forward, guided by [AI_TESTING_GUIDE.md](AI_TESTING_GUIDE.md).

**Refactor**

- Keep behavior the same while improving structure or clarity.
- Use [AI_ARCHITECTURE.md](AI_ARCHITECTURE.md) to confirm that responsibilities are in the right modules.
- Encourage running the relevant tests (see [AI_TESTING_GUIDE.md](AI_TESTING_GUIDE.md)) after each significant step.
- Remind the user to update or confirm docs where behavior, naming, or public interfaces have changed.
- For legacy compatibility work, follow [AI_LEGACY_COMPATIBILITY_GUIDE.md](AI_LEGACY_COMPATIBILITY_GUIDE.md).
...
- Placement and responsibilities: [AI_ARCHITECTURE.md](AI_ARCHITECTURE.md).
- Logging: [AI_LOGGING_GUIDE.md](AI_LOGGING_GUIDE.md).
- Error handling: [AI_ERROR_HANDLING_GUIDE.md](AI_ERROR_HANDLING_GUIDE.md).
- Documentation: [AI_DOCUMENTATION_GUIDE.md](AI_DOCUMENTATION_GUIDE.md).
...
- For documentation that appears inconsistent with behavior:
  - [AI_DOCUMENTATION_GUIDE.md](AI_DOCUMENTATION_GUIDE.md).
...
- For deeper understanding of structure and data flow:
  ...
  - [AI_ARCHITECTURE.md](AI_ARCHITECTURE.md) for quick routing.
- For learning about testing, logging, and error handling:
  - [AI_TESTING_GUIDE.md](AI_TESTING_GUIDE.md), [AI_LOGGING_GUIDE.md](AI_LOGGING_GUIDE.md), and [AI_ERROR_HANDLING_GUIDE.md](AI_ERROR_HANDLING_GUIDE.md) for routing.
