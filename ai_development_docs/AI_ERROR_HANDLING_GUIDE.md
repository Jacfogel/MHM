...
- Logging: [AI_LOGGING_GUIDE.md](AI_LOGGING_GUIDE.md): section 2 & section 4.  
- Testing: [AI_TESTING_GUIDE.md](AI_TESTING_GUIDE.md): section 7 for debugging, section 3 for fixtures/safety.  
