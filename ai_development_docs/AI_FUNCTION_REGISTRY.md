...
### **Documentation Coverage: 91.1% [!] GOOD**
- **Total Functions**: 1470
- **Total Methods**: 1124
- **Documented**: 2364/2594
- **Files Scanned**: 105
...
+-- Channel Management
|   +-- `communication/core/channel_orchestrator.py` - Main communication (79 functions)
...
`-- Conversation Flow
    `-- `communication/message_processing/conversation_flow_manager.py` - Conversation management (48/56 functions)
```
...
+-- Main Application
|   `-- `ui/ui_app_qt.py` - Main admin interface (116/118 functions)
+-- Dialogs
...
- `core/schemas.py` - 26/30 functions undocumented (13% coverage)
...
2. [OK] `communication/communication_channels/discord/bot.py::initialize__register_events()` - Complexity: 2099
3. [OK] `core/user_data_handlers.py::get_user_data()` - Complexity: 2033
4. [OK] `communication/message_processing/interaction_manager.py::handle_message()` - Complexity: 1976
5. [OK] `ai/chatbot.py::_get_contextual_fallback()` - Complexity: 1084
...
### **File Organization**
- `core/` - System utilities and data management (26 files, 758 functions)
- `communication/` - Communication channels and message processing (35 files, 792 functions)
- `ai/` - AI chatbot functionality (7 files, 189 functions)
- `ui/` - User interface components (28 files, 763 functions)
...
> **Last Updated**: 2025-11-13 04:54:25
