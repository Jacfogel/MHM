...
- **Total Functions**: 1625
- **Total Methods**: 1179
- **Documented**: 2689/2804
- **Files Scanned**: 110
...
`-- Scheduling
    +-- `core/scheduler.py` - Task scheduling (81/83 functions)
...
### **File Organization**
- `core/` - System utilities and data management (27 files, 877 functions)
