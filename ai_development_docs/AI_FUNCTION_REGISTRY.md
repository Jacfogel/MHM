...
+-- Channel Management
|   +-- `communication/core/channel_orchestrator.py` - Main communication (79/81 functions)
...
### **File Organization**
- `core/` - System utilities and data management (26 files, 772 functions)
- `communication/` - Communication channels and message processing (37 files, 812 functions)
...
> **Last Updated**: 2025-11-15 20:36:01
