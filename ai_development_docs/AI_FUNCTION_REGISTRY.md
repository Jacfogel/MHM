...
- **Total Functions**: 2812
- **Total Methods**: 1430
- **Documented**: 3795/4242
- **Files Scanned**: 285
...
1. [OK] `core/web_account_service.py::create_web_app()` - Complexity: 14552
...
- `communication/` - Communication channels and message processing (94 files, 1291 functions)
- `core/` - System utilities and data management (37 files, 701 functions)
