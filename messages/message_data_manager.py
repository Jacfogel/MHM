...
# Scheduled categories whose content is AI-generated at send time (no message library file).
PERSONALIZED_MESSAGE_SOURCES = {
    "personalized_checkin": "checkin",
    "personalized_google_health": "google_health",
    "personalized_profile": "profile",
}
AI_GENERATED_MESSAGE_CATEGORIES = frozenset(PERSONALIZED_MESSAGE_SOURCES)


@handle_errors("checking if category is AI-generated", default_return=False)
def is_ai_generated_message_category(category: str) -> bool:
    """Return True when category content is generated by AI, not loaded from a library."""
    return category in AI_GENERATED_MESSAGE_CATEGORIES


@handle_errors("getting personalized message source", default_return=None)
def get_personalized_message_source(category: str) -> str | None:
    """Return the context source for an AI-generated message category."""
    return PERSONALIZED_MESSAGE_SOURCES.get(category)


@handle_errors("checking personalized message availability", default_return=False)
def is_personalized_message_category_available(user_id: str, category: str) -> bool:
    """Return whether the saved feature state still permits a personalized source."""
    if category == "personalized_profile":
        return True
    required_feature = {
    ...
    return account.get("features", {}).get(required_feature) == "enabled"
