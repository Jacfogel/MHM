...
class DynamicCheckinManager:
    ...
    def get_question_definition(self, question_key: str, user_id: Optional[str] = None) -> Optional[Dict[str, Any]]:
    ...
    def get_all_questions(self, user_id: Optional[str] = None) -> Dict[str, Dict[str, Any]]:
    ...
    def get_question_text(self, question_key: str, user_id: Optional[str] = None) -> str:
    ...
    def validate_answer(self, question_key: str, answer: str, user_id: Optional[str] = None) -> Tuple[bool, Any, Optional[str]]:
    ...
    def get_enabled_questions_for_ui(self, user_id: Optional[str] = None) -> Dict[str, Dict[str, Any]]:
    ...
    def save_custom_question(self, user_id: str, question_key: str, question_def: Dict[str, Any]) -> bool:
    ...
    def delete_custom_question(self, user_id: str, question_key: str) -> bool:
        ...
        try:
            ...
            if question_key in prefs['checkin_settings']['custom_questions']:
                ...
                # Save updated preferences
                update_user_preferences(user_id, prefs)
                logger.info(f"Deleted custom question '{question_key}' for user {user_id}")
                return True
            else:
                logger.warning(f"Custom question '{question_key}' not found for user {user_id}")
                return False
        except Exception as e:
    ...
    def get_question_templates(self) -> Dict[str, Dict[str, Any]]:
        ...
        try:
            templates_file = Path(__file__).parent.parent / "resources" / "default_checkin" / "question_templates.json"
