...
_LAZY_EXPORTS: dict[str, tuple[str, str]] = {
    ...
    # Schemas / profile envelopes
    "schedule_categories": ("core.profile_v2_io", "schedule_categories"),
    "ensure_profile_envelope": ("core.profile_v2_io", "ensure_profile_envelope"),
    "account_extra": ("core.profile_v2_io", "account_extra"),
    # Service and runtime
