...
class ContextData:
    ...
    def __post_init__(self):
        ...
        if self.current_time is None:
            ...
            self.current_time = now_datetime_full()
...
class ContextBuilder:
    ...
    def analyze_context(self, context_data: ContextData) -> ContextAnalysis:
        ...
        try:
            ...
            teeth_brushing_rate = (
                (teeth_brushed_count / total_entries) * 100 if total_entries > 0 else 0
            )
            ...
            logger.debug(
                f"Context analysis completed: wellness_score={wellness_score:.1f}, mood_trend={mood_trend}, energy_trend={energy_trend}, insights_count={len(insights)}"
            )
