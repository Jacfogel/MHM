...
class Ui_ui_app_mainwindow(object):
    def setupUi(self, ui_app_mainwindow):
        ...
        ui_app_mainwindow.resize(950, 750)
        ...
        self.actionProcess_Watcher = QAction(ui_app_mainwindow)
        self.actionProcess_Watcher.setObjectName(u"actionProcess_Watcher")
        ...
        self.label_discord_status = QLabel(self.groupBox_server_management)
        self.label_discord_status.setObjectName(u"label_discord_status")

        self.gridLayout.addWidget(self.label_discord_status, 1, 0, 1, 4)

        self.label_email_status = QLabel(self.groupBox_server_management)
        self.label_email_status.setObjectName(u"label_email_status")

        self.gridLayout.addWidget(self.label_email_status, 2, 0, 1, 4)

        self.label_ngrok_status = QLabel(self.groupBox_server_management)
        self.label_ngrok_status.setObjectName(u"label_ngrok_status")

        self.gridLayout.addWidget(self.label_ngrok_status, 3, 0, 1, 4)
        ...
        self.gridLayout.addWidget(self.pushButton_start_service, 4, 0, 1, 1)
        ...
        self.gridLayout.addWidget(self.pushButton_stop_service, 4, 1, 1, 1)
        ...
        self.gridLayout.addWidget(self.pushButton_restart_service, 4, 2, 1, 1)
        ...
        self.gridLayout.addWidget(self.pushButton_run_scheduler, 4, 3, 1, 1)
        ...
        self.comboBox_users.setMinimumSize(QSize(250, 0))
        ...
        self.pushButton_phrase_settings = QPushButton(self.groupBox_user_management)
        self.pushButton_phrase_settings.setObjectName(u"pushButton_phrase_settings")

        self.gridLayout_2.addWidget(self.pushButton_phrase_settings, 0, 4, 1, 1)
        ...
        self.comboBox_user_categories.setMinimumSize(QSize(250, 0))
        ...
        self.menuDebug.addAction(self.actionProcess_Watcher)
    ...
    def retranslateUi(self, ui_app_mainwindow):
        ...
        self.actionProcess_Watcher.setText(QCoreApplication.translate("ui_app_mainwindow", u"Process Watcher", None))
        ...
        self.label_discord_status.setText(QCoreApplication.translate("ui_app_mainwindow", u"Discord Channel: Stopped", None))
        self.label_email_status.setText(QCoreApplication.translate("ui_app_mainwindow", u"Email Channel: Stopped", None))
        self.label_ngrok_status.setText(QCoreApplication.translate("ui_app_mainwindow", u"ngrok tunnel: Stopped", None))
        ...
        self.pushButton_phrase_settings.setText(QCoreApplication.translate("ui_app_mainwindow", u"Phrase Settings", None))
