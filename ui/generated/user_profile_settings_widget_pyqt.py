...
class Ui_Form_user_profile_settings(object):
    def setupUi(self, Form_user_profile_settings):
        ...
        self.tab_health_medical = QWidget()
        self.tab_health_medical.setObjectName(u"tab_health_medical")
        self.verticalLayout_health_medical = QVBoxLayout(self.tab_health_medical)
        self.verticalLayout_health_medical.setObjectName(u"verticalLayout_health_medical")
        self.groupBox_medical = QGroupBox(self.tab_health_medical)
        ...
        self.scrollArea_medical = QScrollArea(self.groupBox_medical)
        self.scrollArea_medical.setObjectName(u"scrollArea_medical")
        sizePolicy = QSizePolicy(QSizePolicy.Policy.Preferred, QSizePolicy.Policy.Expanding)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.scrollArea_medical.sizePolicy().hasHeightForWidth())
        self.scrollArea_medical.setSizePolicy(sizePolicy)
        self.scrollArea_medical.setWidgetResizable(True)
        self.scrollAreaWidgetContents_medical = QWidget()
        self.scrollAreaWidgetContents_medical.setObjectName(u"scrollAreaWidgetContents_medical")
        self.scrollAreaWidgetContents_medical.setGeometry(QRect(0, 0, 534, 271))
        self.gridLayout_4 = QGridLayout(self.scrollAreaWidgetContents_medical)
        self.gridLayout_4.setObjectName(u"gridLayout_4")
        self.checkBox_substance_abuse = QCheckBox(self.scrollAreaWidgetContents_medical)
        self.checkBox_substance_abuse.setObjectName(u"checkBox_substance_abuse")

        self.gridLayout_4.addWidget(self.checkBox_substance_abuse, 2, 1, 1, 1)

        self.checkBox_ocd = QCheckBox(self.scrollAreaWidgetContents_medical)
        self.checkBox_ocd.setObjectName(u"checkBox_ocd")

        self.gridLayout_4.addWidget(self.checkBox_ocd, 1, 2, 1, 1)

        self.checkBox_autism = QCheckBox(self.scrollAreaWidgetContents_medical)
        self.checkBox_autism.setObjectName(u"checkBox_autism")

        self.gridLayout_4.addWidget(self.checkBox_autism, 3, 1, 1, 1)

        self.checkBox_depression = QCheckBox(self.scrollAreaWidgetContents_medical)
        self.checkBox_depression.setObjectName(u"checkBox_depression")

        self.gridLayout_4.addWidget(self.checkBox_depression, 0, 0, 1, 1)

        self.checkBox_eating_disorder = QCheckBox(self.scrollAreaWidgetContents_medical)
        self.checkBox_eating_disorder.setObjectName(u"checkBox_eating_disorder")

        self.gridLayout_4.addWidget(self.checkBox_eating_disorder, 2, 0, 1, 1)

        self.checkBox_other_mental_health = QCheckBox(self.scrollAreaWidgetContents_medical)
        self.checkBox_other_mental_health.setObjectName(u"checkBox_other_mental_health")

        self.gridLayout_4.addWidget(self.checkBox_other_mental_health, 3, 2, 1, 1)

        self.checkBox_chronic_pain = QCheckBox(self.scrollAreaWidgetContents_medical)
        self.checkBox_chronic_pain.setObjectName(u"checkBox_chronic_pain")

        self.gridLayout_4.addWidget(self.checkBox_chronic_pain, 3, 0, 1, 1)

        self.checkBox_anxiety = QCheckBox(self.scrollAreaWidgetContents_medical)
        self.checkBox_anxiety.setObjectName(u"checkBox_anxiety")

        self.gridLayout_4.addWidget(self.checkBox_anxiety, 0, 1, 1, 1)

        self.checkBox_sleep_disorder = QCheckBox(self.scrollAreaWidgetContents_medical)
        self.checkBox_sleep_disorder.setObjectName(u"checkBox_sleep_disorder")

        self.gridLayout_4.addWidget(self.checkBox_sleep_disorder, 2, 2, 1, 1)

        self.checkBox_adhd = QCheckBox(self.scrollAreaWidgetContents_medical)
        self.checkBox_adhd.setObjectName(u"checkBox_adhd")

        self.gridLayout_4.addWidget(self.checkBox_adhd, 0, 2, 1, 1)

        self.checkBox_bipolar = QCheckBox(self.scrollAreaWidgetContents_medical)
        self.checkBox_bipolar.setObjectName(u"checkBox_bipolar")

        self.gridLayout_4.addWidget(self.checkBox_bipolar, 1, 0, 1, 1)

        self.checkBox_ptsd = QCheckBox(self.scrollAreaWidgetContents_medical)
        self.checkBox_ptsd.setObjectName(u"checkBox_ptsd")

        self.gridLayout_4.addWidget(self.checkBox_ptsd, 1, 1, 1, 1)

        self.lineEdit_custom_medical = QLineEdit(self.scrollAreaWidgetContents_medical)
        self.lineEdit_custom_medical.setObjectName(u"lineEdit_custom_medical")

        self.gridLayout_4.addWidget(self.lineEdit_custom_medical, 4, 0, 1, 3)

        self.scrollArea_medical.setWidget(self.scrollAreaWidgetContents_medical)

        self.gridLayout_medical.addWidget(self.scrollArea_medical, 1, 0, 1, 1)


        self.verticalLayout_health_medical.addWidget(self.groupBox_medical)

        self.groupBox_allergies = QGroupBox(self.tab_health_medical)
        ...
        self.scrollArea_allergies = QScrollArea(self.groupBox_allergies)
        self.scrollArea_allergies.setObjectName(u"scrollArea_allergies")
        sizePolicy.setHeightForWidth(self.scrollArea_allergies.sizePolicy().hasHeightForWidth())
        self.scrollArea_allergies.setSizePolicy(sizePolicy)
        self.scrollArea_allergies.setWidgetResizable(True)
        self.scrollAreaWidgetContents_allergies = QWidget()
        self.scrollAreaWidgetContents_allergies.setObjectName(u"scrollAreaWidgetContents_allergies")
        self.scrollAreaWidgetContents_allergies.setGeometry(QRect(0, 0, 534, 271))
        self.gridLayout_5 = QGridLayout(self.scrollAreaWidgetContents_allergies)
        self.gridLayout_5.setObjectName(u"gridLayout_5")
        self.checkBox_food_allergies = QCheckBox(self.scrollAreaWidgetContents_allergies)
        self.checkBox_food_allergies.setObjectName(u"checkBox_food_allergies")

        self.gridLayout_5.addWidget(self.checkBox_food_allergies, 0, 0, 1, 1)

        self.checkBox_medication_allergies = QCheckBox(self.scrollAreaWidgetContents_allergies)
        self.checkBox_medication_allergies.setObjectName(u"checkBox_medication_allergies")

        self.gridLayout_5.addWidget(self.checkBox_medication_allergies, 0, 1, 1, 1)

        self.checkBox_environmental_allergies = QCheckBox(self.scrollAreaWidgetContents_allergies)
        self.checkBox_environmental_allergies.setObjectName(u"checkBox_environmental_allergies")

        self.gridLayout_5.addWidget(self.checkBox_environmental_allergies, 0, 2, 1, 1)

        self.checkBox_latex_allergy = QCheckBox(self.scrollAreaWidgetContents_allergies)
        self.checkBox_latex_allergy.setObjectName(u"checkBox_latex_allergy")

        self.gridLayout_5.addWidget(self.checkBox_latex_allergy, 1, 0, 1, 1)

        self.checkBox_gluten_sensitivity = QCheckBox(self.scrollAreaWidgetContents_allergies)
        self.checkBox_gluten_sensitivity.setObjectName(u"checkBox_gluten_sensitivity")

        self.gridLayout_5.addWidget(self.checkBox_gluten_sensitivity, 1, 1, 1, 1)

        self.checkBox_lactose_intolerance = QCheckBox(self.scrollAreaWidgetContents_allergies)
        self.checkBox_lactose_intolerance.setObjectName(u"checkBox_lactose_intolerance")

        self.gridLayout_5.addWidget(self.checkBox_lactose_intolerance, 1, 2, 1, 1)

        self.lineEdit_custom_allergies = QLineEdit(self.scrollAreaWidgetContents_allergies)
        self.lineEdit_custom_allergies.setObjectName(u"lineEdit_custom_allergies")

        self.gridLayout_5.addWidget(self.lineEdit_custom_allergies, 2, 0, 1, 3)

        self.scrollArea_allergies.setWidget(self.scrollAreaWidgetContents_allergies)

        self.gridLayout_allergies.addWidget(self.scrollArea_allergies, 0, 1, 1, 1)


        self.verticalLayout_health_medical.addWidget(self.groupBox_allergies)

        self.tabWidget.addTab(self.tab_health_medical, "")
        self.tab_medications_reminders = QWidget()
        self.tab_medications_reminders.setObjectName(u"tab_medications_reminders")
        self.verticalLayout_medications_reminders = QVBoxLayout(self.tab_medications_reminders)
        self.verticalLayout_medications_reminders.setObjectName(u"verticalLayout_medications_reminders")
        self.groupBox_medications = QGroupBox(self.tab_medications_reminders)
        ...
        self.scrollArea_medications = QScrollArea(self.groupBox_medications)
        self.scrollArea_medications.setObjectName(u"scrollArea_medications")
        sizePolicy.setHeightForWidth(self.scrollArea_medications.sizePolicy().hasHeightForWidth())
        self.scrollArea_medications.setSizePolicy(sizePolicy)
        self.scrollArea_medications.setWidgetResizable(True)
        self.scrollAreaWidgetContents_medications = QWidget()
        self.scrollAreaWidgetContents_medications.setObjectName(u"scrollAreaWidgetContents_medications")
        self.scrollAreaWidgetContents_medications.setGeometry(QRect(0, 0, 534, 271))
        self.gridLayout_6 = QGridLayout(self.scrollAreaWidgetContents_medications)
        self.gridLayout_6.setObjectName(u"gridLayout_6")
        self.checkBox_antidepressants = QCheckBox(self.scrollAreaWidgetContents_medications)
        self.checkBox_antidepressants.setObjectName(u"checkBox_antidepressants")

        self.gridLayout_6.addWidget(self.checkBox_antidepressants, 0, 0, 1, 1)

        self.checkBox_anxiety_meds = QCheckBox(self.scrollAreaWidgetContents_medications)
        self.checkBox_anxiety_meds.setObjectName(u"checkBox_anxiety_meds")

        self.gridLayout_6.addWidget(self.checkBox_anxiety_meds, 0, 1, 1, 1)

        self.checkBox_adhd_meds = QCheckBox(self.scrollAreaWidgetContents_medications)
        self.checkBox_adhd_meds.setObjectName(u"checkBox_adhd_meds")

        self.gridLayout_6.addWidget(self.checkBox_adhd_meds, 0, 2, 1, 1)

        self.checkBox_mood_stabilizers = QCheckBox(self.scrollAreaWidgetContents_medications)
        self.checkBox_mood_stabilizers.setObjectName(u"checkBox_mood_stabilizers")

        self.gridLayout_6.addWidget(self.checkBox_mood_stabilizers, 1, 0, 1, 1)

        self.checkBox_sleep_meds = QCheckBox(self.scrollAreaWidgetContents_medications)
        self.checkBox_sleep_meds.setObjectName(u"checkBox_sleep_meds")

        self.gridLayout_6.addWidget(self.checkBox_sleep_meds, 1, 1, 1, 1)

        self.checkBox_pain_meds = QCheckBox(self.scrollAreaWidgetContents_medications)
        self.checkBox_pain_meds.setObjectName(u"checkBox_pain_meds")

        self.gridLayout_6.addWidget(self.checkBox_pain_meds, 1, 2, 1, 1)

        self.lineEdit_custom_medications = QLineEdit(self.scrollAreaWidgetContents_medications)
        self.lineEdit_custom_medications.setObjectName(u"lineEdit_custom_medications")

        self.gridLayout_6.addWidget(self.lineEdit_custom_medications, 2, 0, 1, 3)

        self.scrollArea_medications.setWidget(self.scrollAreaWidgetContents_medications)

        self.gridLayout_medications.addWidget(self.scrollArea_medications, 0, 0, 1, 1)


        self.verticalLayout_medications_reminders.addWidget(self.groupBox_medications)

        self.groupBox_reminders_needed = QGroupBox(self.tab_medications_reminders)
        ...
        self.scrollArea_reminders = QScrollArea(self.groupBox_reminders_needed)
        self.scrollArea_reminders.setObjectName(u"scrollArea_reminders")
        sizePolicy.setHeightForWidth(self.scrollArea_reminders.sizePolicy().hasHeightForWidth())
        self.scrollArea_reminders.setSizePolicy(sizePolicy)
        self.scrollArea_reminders.setWidgetResizable(True)
        self.scrollAreaWidgetContents_reminders = QWidget()
        self.scrollAreaWidgetContents_reminders.setObjectName(u"scrollAreaWidgetContents_reminders")
        self.scrollAreaWidgetContents_reminders.setGeometry(QRect(0, 0, 534, 271))
        self.gridLayout_7 = QGridLayout(self.scrollAreaWidgetContents_reminders)
        self.gridLayout_7.setObjectName(u"gridLayout_7")
        self.label_reminders_placeholder = QLabel(self.scrollAreaWidgetContents_reminders)
        self.label_reminders_placeholder.setObjectName(u"label_reminders_placeholder")

        self.gridLayout_7.addWidget(self.label_reminders_placeholder, 0, 0, 1, 1)

        self.scrollArea_reminders.setWidget(self.scrollAreaWidgetContents_reminders)

        self.verticalLayout_reminders_needed.addWidget(self.scrollArea_reminders)


        self.verticalLayout_medications_reminders.addWidget(self.groupBox_reminders_needed)

        self.tabWidget.addTab(self.tab_medications_reminders, "")
        ...
        self.scrollArea_interests = QScrollArea(self.groupBox_interests)
        self.scrollArea_interests.setObjectName(u"scrollArea_interests")
        sizePolicy.setHeightForWidth(self.scrollArea_interests.sizePolicy().hasHeightForWidth())
        self.scrollArea_interests.setSizePolicy(sizePolicy)
        self.scrollArea_interests.setWidgetResizable(True)
        self.scrollAreaWidgetContents_interests = QWidget()
        self.scrollAreaWidgetContents_interests.setObjectName(u"scrollAreaWidgetContents_interests")
        self.scrollAreaWidgetContents_interests.setGeometry(QRect(0, 0, 534, 593))
        self.gridLayout_8 = QGridLayout(self.scrollAreaWidgetContents_interests)
        self.gridLayout_8.setObjectName(u"gridLayout_8")
        self.checkBox_reading = QCheckBox(self.scrollAreaWidgetContents_interests)
        self.checkBox_reading.setObjectName(u"checkBox_reading")

        self.gridLayout_8.addWidget(self.checkBox_reading, 0, 0, 1, 1)

        self.checkBox_writing = QCheckBox(self.scrollAreaWidgetContents_interests)
        self.checkBox_writing.setObjectName(u"checkBox_writing")

        self.gridLayout_8.addWidget(self.checkBox_writing, 0, 1, 1, 1)

        self.checkBox_music = QCheckBox(self.scrollAreaWidgetContents_interests)
        self.checkBox_music.setObjectName(u"checkBox_music")

        self.gridLayout_8.addWidget(self.checkBox_music, 0, 2, 1, 1)

        self.checkBox_art = QCheckBox(self.scrollAreaWidgetContents_interests)
        self.checkBox_art.setObjectName(u"checkBox_art")

        self.gridLayout_8.addWidget(self.checkBox_art, 1, 0, 1, 1)

        self.checkBox_gaming = QCheckBox(self.scrollAreaWidgetContents_interests)
        self.checkBox_gaming.setObjectName(u"checkBox_gaming")

        self.gridLayout_8.addWidget(self.checkBox_gaming, 1, 1, 1, 1)

        self.checkBox_cooking = QCheckBox(self.scrollAreaWidgetContents_interests)
        self.checkBox_cooking.setObjectName(u"checkBox_cooking")

        self.gridLayout_8.addWidget(self.checkBox_cooking, 1, 2, 1, 1)

        self.checkBox_exercise = QCheckBox(self.scrollAreaWidgetContents_interests)
        self.checkBox_exercise.setObjectName(u"checkBox_exercise")

        self.gridLayout_8.addWidget(self.checkBox_exercise, 2, 0, 1, 1)

        self.checkBox_nature = QCheckBox(self.scrollAreaWidgetContents_interests)
        self.checkBox_nature.setObjectName(u"checkBox_nature")

        self.gridLayout_8.addWidget(self.checkBox_nature, 2, 1, 1, 1)

        self.checkBox_technology = QCheckBox(self.scrollAreaWidgetContents_interests)
        self.checkBox_technology.setObjectName(u"checkBox_technology")

        self.gridLayout_8.addWidget(self.checkBox_technology, 2, 2, 1, 1)

        self.checkBox_photography = QCheckBox(self.scrollAreaWidgetContents_interests)
        self.checkBox_photography.setObjectName(u"checkBox_photography")

        self.gridLayout_8.addWidget(self.checkBox_photography, 3, 0, 1, 1)

        self.checkBox_travel = QCheckBox(self.scrollAreaWidgetContents_interests)
        self.checkBox_travel.setObjectName(u"checkBox_travel")

        self.gridLayout_8.addWidget(self.checkBox_travel, 3, 1, 1, 1)

        self.checkBox_volunteering = QCheckBox(self.scrollAreaWidgetContents_interests)
        self.checkBox_volunteering.setObjectName(u"checkBox_volunteering")

        self.gridLayout_8.addWidget(self.checkBox_volunteering, 3, 2, 1, 1)

        self.lineEdit_custom_interest = QLineEdit(self.scrollAreaWidgetContents_interests)
        self.lineEdit_custom_interest.setObjectName(u"lineEdit_custom_interest")

        self.gridLayout_8.addWidget(self.lineEdit_custom_interest, 4, 0, 1, 3)

        self.scrollArea_interests.setWidget(self.scrollAreaWidgetContents_interests)

        self.gridLayout_interests.addWidget(self.scrollArea_interests, 0, 0, 1, 1)
        ...
        self.scrollArea_goals = QScrollArea(self.groupBox_goals)
        self.scrollArea_goals.setObjectName(u"scrollArea_goals")
        sizePolicy.setHeightForWidth(self.scrollArea_goals.sizePolicy().hasHeightForWidth())
        self.scrollArea_goals.setSizePolicy(sizePolicy)
        self.scrollArea_goals.setWidgetResizable(True)
        self.scrollAreaWidgetContents_goals = QWidget()
        self.scrollAreaWidgetContents_goals.setObjectName(u"scrollAreaWidgetContents_goals")
        self.scrollAreaWidgetContents_goals.setGeometry(QRect(0, 0, 534, 271))
        self.gridLayout_2 = QGridLayout(self.scrollAreaWidgetContents_goals)
        self.gridLayout_2.setObjectName(u"gridLayout_2")
        self.checkBox_relationship_goals = QCheckBox(self.scrollAreaWidgetContents_goals)
        self.checkBox_relationship_goals.setObjectName(u"checkBox_relationship_goals")

        self.gridLayout_2.addWidget(self.checkBox_relationship_goals, 1, 1, 1, 1)

        self.checkBox_career_goals = QCheckBox(self.scrollAreaWidgetContents_goals)
        self.checkBox_career_goals.setObjectName(u"checkBox_career_goals")

        self.gridLayout_2.addWidget(self.checkBox_career_goals, 0, 2, 1, 1)

        self.checkBox_social_goals = QCheckBox(self.scrollAreaWidgetContents_goals)
        self.checkBox_social_goals.setObjectName(u"checkBox_social_goals")

        self.gridLayout_2.addWidget(self.checkBox_social_goals, 2, 1, 1, 1)

        self.checkBox_creative_goals = QCheckBox(self.scrollAreaWidgetContents_goals)
        self.checkBox_creative_goals.setObjectName(u"checkBox_creative_goals")

        self.gridLayout_2.addWidget(self.checkBox_creative_goals, 2, 0, 1, 1)

        self.checkBox_education_goals = QCheckBox(self.scrollAreaWidgetContents_goals)
        self.checkBox_education_goals.setObjectName(u"checkBox_education_goals")

        self.gridLayout_2.addWidget(self.checkBox_education_goals, 1, 0, 1, 1)

        self.checkBox_mental_health_goals = QCheckBox(self.scrollAreaWidgetContents_goals)
        self.checkBox_mental_health_goals.setObjectName(u"checkBox_mental_health_goals")

        self.gridLayout_2.addWidget(self.checkBox_mental_health_goals, 0, 0, 1, 1)

        self.checkBox_spiritual_goals = QCheckBox(self.scrollAreaWidgetContents_goals)
        self.checkBox_spiritual_goals.setObjectName(u"checkBox_spiritual_goals")

        self.gridLayout_2.addWidget(self.checkBox_spiritual_goals, 2, 2, 1, 1)

        self.checkBox_physical_health_goals = QCheckBox(self.scrollAreaWidgetContents_goals)
        self.checkBox_physical_health_goals.setObjectName(u"checkBox_physical_health_goals")

        self.gridLayout_2.addWidget(self.checkBox_physical_health_goals, 0, 1, 1, 1)

        self.lineEdit_custom_goal = QLineEdit(self.scrollAreaWidgetContents_goals)
        self.lineEdit_custom_goal.setObjectName(u"lineEdit_custom_goal")

        self.gridLayout_2.addWidget(self.lineEdit_custom_goal, 3, 0, 1, 3)

        self.checkBox_financial_goals = QCheckBox(self.scrollAreaWidgetContents_goals)
        self.checkBox_financial_goals.setObjectName(u"checkBox_financial_goals")

        self.gridLayout_2.addWidget(self.checkBox_financial_goals, 1, 2, 1, 1)

        self.scrollArea_goals.setWidget(self.scrollAreaWidgetContents_goals)

        self.gridLayout_goals.addWidget(self.scrollArea_goals, 0, 0, 1, 1)


        self.verticalLayout_goals.addWidget(self.groupBox_goals)

        self.groupBox_activities_for_encouragement = QGroupBox(self.tab_goals)
        ...
        self.scrollArea_activities_for_encouragement = QScrollArea(self.groupBox_activities_for_encouragement)
        self.scrollArea_activities_for_encouragement.setObjectName(u"scrollArea_activities_for_encouragement")
        sizePolicy.setHeightForWidth(self.scrollArea_activities_for_encouragement.sizePolicy().hasHeightForWidth())
        self.scrollArea_activities_for_encouragement.setSizePolicy(sizePolicy)
        self.scrollArea_activities_for_encouragement.setWidgetResizable(True)
        self.scrollAreaWidgetContents_activities_for_encouragement = QWidget()
        self.scrollAreaWidgetContents_activities_for_encouragement.setObjectName(u"scrollAreaWidgetContents_activities_for_encouragement")
        self.scrollAreaWidgetContents_activities_for_encouragement.setGeometry(QRect(0, 0, 534, 271))
        self.gridLayout_3 = QGridLayout(self.scrollAreaWidgetContents_activities_for_encouragement)
        self.gridLayout_3.setObjectName(u"gridLayout_3")
        self.label_activities_placeholder = QLabel(self.scrollAreaWidgetContents_activities_for_encouragement)
        self.label_activities_placeholder.setObjectName(u"label_activities_placeholder")

        self.gridLayout_3.addWidget(self.label_activities_placeholder, 0, 0, 1, 1)

        self.scrollArea_activities_for_encouragement.setWidget(self.scrollAreaWidgetContents_activities_for_encouragement)

        self.verticalLayout_activities_for_encouragement.addWidget(self.scrollArea_activities_for_encouragement)


        self.verticalLayout_goals.addWidget(self.groupBox_activities_for_encouragement)
        ...
        self.scrollArea_loved_ones = QScrollArea(self.groupBox_loved_ones)
        self.scrollArea_loved_ones.setObjectName(u"scrollArea_loved_ones")
        sizePolicy.setHeightForWidth(self.scrollArea_loved_ones.sizePolicy().hasHeightForWidth())
        self.scrollArea_loved_ones.setSizePolicy(sizePolicy)
        self.scrollArea_loved_ones.setWidgetResizable(True)
        self.scrollAreaWidgetContents_loved_ones = QWidget()
        self.scrollAreaWidgetContents_loved_ones.setObjectName(u"scrollAreaWidgetContents_loved_ones")
        self.scrollAreaWidgetContents_loved_ones.setGeometry(QRect(0, 0, 534, 271))
        self.verticalLayout = QVBoxLayout(self.scrollAreaWidgetContents_loved_ones)
        self.verticalLayout.setObjectName(u"verticalLayout")
        self.textEdit_loved_ones = QTextEdit(self.scrollAreaWidgetContents_loved_ones)
        self.textEdit_loved_ones.setObjectName(u"textEdit_loved_ones")

        self.verticalLayout.addWidget(self.textEdit_loved_ones)

        self.scrollArea_loved_ones.setWidget(self.scrollAreaWidgetContents_loved_ones)

        self.verticalLayout_loved_ones.addWidget(self.scrollArea_loved_ones)
        ...
        self.scrollArea_notes = QScrollArea(self.groupBox_notes)
        self.scrollArea_notes.setObjectName(u"scrollArea_notes")
        sizePolicy.setHeightForWidth(self.scrollArea_notes.sizePolicy().hasHeightForWidth())
        self.scrollArea_notes.setSizePolicy(sizePolicy)
        self.scrollArea_notes.setWidgetResizable(True)
        self.scrollAreaWidgetContents_notes = QWidget()
        self.scrollAreaWidgetContents_notes.setObjectName(u"scrollAreaWidgetContents_notes")
        self.scrollAreaWidgetContents_notes.setGeometry(QRect(0, 0, 534, 271))
        self.verticalLayout_2 = QVBoxLayout(self.scrollAreaWidgetContents_notes)
        self.verticalLayout_2.setObjectName(u"verticalLayout_2")
        self.textEdit_notes = QTextEdit(self.scrollAreaWidgetContents_notes)
        self.textEdit_notes.setObjectName(u"textEdit_notes")

        self.verticalLayout_2.addWidget(self.textEdit_notes)

        self.scrollArea_notes.setWidget(self.scrollAreaWidgetContents_notes)

        self.verticalLayout_notes.addWidget(self.scrollArea_notes)
    ...
    def retranslateUi(self, Form_user_profile_settings):
        ...
        self.lineEdit_custom_medical.setPlaceholderText(QCoreApplication.translate("Form_user_profile_settings", u"Add custom health/medical condition", None))
        ...
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tab_health_medical), QCoreApplication.translate("Form_user_profile_settings", u"Health & Medical", None))
        ...
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tab_medications_reminders), QCoreApplication.translate("Form_user_profile_settings", u"Medications & Reminders", None))
