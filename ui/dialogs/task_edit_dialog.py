...
class TaskEditDialog(QDialog):
    ...
    def setup_due_time_components(self):
        ...
        self.ui.comboBox_due_time_minute.currentTextChanged.connect(
            self.on_minute_changed
        )
    ...
    def setup_recurring_task_components(self):
        ...
        self.ui.comboBox_recurring_pattern.currentTextChanged.connect(
            self.on_recurring_pattern_changed
        )
    ...
    def setup_connections(self):
        ...
        self.ui.checkBox_enable_reminders.toggled.connect(
            self.ui.widget_reminder_periods.setEnabled
        )
    ...
    def render_reminder_period_row(self, index, period):
        ...
        self.ui.verticalLayout_scrollAreaWidgetContents_reminder_periods.addWidget(
            row_widget
        )
            ...
            if self.is_edit:
                ...
                if success:
                    QMessageBox.information(
                        self, "Success", "Task updated successfully!"
                    )
                    self.accept()
                else:
