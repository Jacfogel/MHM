...
class MessageEditDialog(QDialog):
    ...
    def __init__(self, parent=None, user_id=None, category=None, message_data=None):
        ...
        self.setWindowTitle(
            f"{'Edit' if self.is_edit else 'Add'} Message - {category.title()}"
        )
        self.setModal(True)
        self.resize(500, 400)
...
class MessageEditorDialog(QDialog):
    ...
    def setup_connections(self):
        ...
        self.ui.tableWidget_messages.itemDoubleClicked.connect(
    ...
    def load_messages(self):
        ...
        sort_column = (
            self.ui.tableWidget_messages.horizontalHeader().sortIndicatorSection()
        )
        sort_order = (
            self.ui.tableWidget_messages.horizontalHeader().sortIndicatorOrder()
        )
        ...
        if sort_column >= 0:
            self.ui.tableWidget_messages.horizontalHeader().setSortIndicator(
    ...
    def show_no_messages_state(self):
        ...
        self.ui.tableWidget_messages.setItem(
            0, 0, QTableWidgetItem("No messages found for this category")
        )
    ...
    def populate_table(self):
        ...
        for row, message in enumerate(self.messages):
            ...
            delete_btn.clicked.connect(
                lambda checked, r=row: self.delete_message_by_row(r)
            )
