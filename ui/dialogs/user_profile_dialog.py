...
class UserProfileDialog(QDialog):
    ...
    def setup_ui(self):
        ...
        self.profile_widget = UserProfileSettingsWidget(
            self, self.user_id, self.personalization_data
        )
    ...
    def create_custom_field_list(
        self, parent_layout, predefined_values, existing_values, label_text
    ):
        ...
        add_button.clicked.connect(
            lambda: self.add_custom_field(custom_layout, label_text)
        )
    ...
    def collect_loved_ones_data(self):
        ...
        for child in self.children():
            if (
                ...
                and child.title() == "Loved Ones & Relationships"
            ):
