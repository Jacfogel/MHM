...
class DynamicListContainer(QWidget):
    ...
    @handle_errors("handling row edit in dynamic list container")
    ...
    @handle_errors("handling row deletion in dynamic list container")
    ...
    # ------------------------------------------------------------------
    @handle_errors("ensuring single blank row in dynamic list container")
    ...
    @handle_errors("finding first blank index in dynamic list container")
