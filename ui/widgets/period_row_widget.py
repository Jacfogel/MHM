...
class PeriodRowWidget(QWidget):
    ...
    def __init__(
        ...
        self.ui.checkBox_select_all_days.style().unpolish(
            self.ui.checkBox_select_all_days
        )
        self.ui.checkBox_select_all_days.style().polish(
            self.ui.checkBox_select_all_days
        )
    ...
    def setup_functionality(self):
        ...
        self.ui.checkBox_select_all_days.toggled.connect(
            self.on_select_all_days_toggled
        )
    ...
    def load_period_data(self):
        ...
        start_hour_12, start_min_val, start_is_pm = (
            get_period_data__time_24h_to_12h_display(start_time)
        )
        ...
        end_hour_12, end_min_val, end_is_pm = get_period_data__time_24h_to_12h_display(
            end_time
        )
    ...
    def get_period_data(self) -> dict[str, Any]:
        ...
        start_time = get_period_data__time_12h_display_to_24h(
            start_hour, start_min, start_is_pm
        )
        ...
        end_time = get_period_data__time_12h_display_to_24h(
            end_hour, end_min, end_is_pm
        )
    ...
    def _set_read_only__apply_read_only_styling(self):
        ...
        self.ui.lineEdit_time_period_name.setStyleSheet(
            "QLineEdit { background-color: #e0e0e0; color: #666666; }"
        )
