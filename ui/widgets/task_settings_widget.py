...
class TaskSettingsWidget(QWidget):
    ...
    def setup_connections(self):
        ...
        self.ui.pushButton_task_reminder_add_new_period.clicked.connect(
            lambda: self.add_new_period()
        )
        self.ui.pushButton_undo_last__task_reminder_time_period_delete.clicked.connect(
    ...
    def load_existing_data(self):
        if not self.user_id:
            logger.info(
                "TaskSettingsWidget: No user_id provided - creating new user mode"
            )
    ...
    def get_task_settings(self):
        ...
        tags = (
            self.tag_widget.get_available_tags() if hasattr(self, "tag_widget") else []
        )
    ...
    def save_recurring_task_settings(self):
        ...
        try:
            ...
            logger.error(
                f"Error saving recurring task settings for user {self.user_id}: {e}"
            )
